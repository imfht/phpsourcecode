...
<link rel="stylesheet" href="../assets/simpla/css/theme_blue.css" type="text/css" />
...
<div id="body-wrapper">
  ...
  <div id="main-content">
            ...
            <form action="?" method="post" id="js-form">
              <fieldset class="clearfix">
                <p>
                  ...
                  <span><select name="sql"><option value="upgradesmpss1.1">从1.0Release到1.1Release</option></select></span> </p>
                <p>
    ...
    <div class="clear"></div>
<div id="footer"> <small> © Copyright 2012-2013 <a href="mailto:ljt365fir@gmail.com">铂金小猪</a> <a href="http://www.bojinxiaozhu.com" target="_blank">Version:ZhaoCaiMao v1.0</a> | <a href="#">Top</a> </small> </div>  </div>
</div>
</body>
</html>
<?php 
