...
class base_c extends SGui {
	...
	public function __construct() {
		...
		if($_GET){$_POST = base_Utils::shtmlspecialchars($_GET);}
		$_COOKIE = base_Utils::shtmlspecialchars($_COOKIE); 
		$_SESSION = base_Utils::shtmlspecialchars($_SESSION);
		
		$this->params ['_time'] = time ();
		$this->params ['theme'] =base_Constant::THEME;
		$this->params ['head_title'] = base_Constant::DEFAULT_TITLE;
		$this->params ['version'] = "ZhaoCaiZhu " . base_Constant::VERSION;
