...
<div class="menu-index">
    <div class="row">
        <div class="col-sm-12">
            ...
            <?= Html::a('拉取', ['/mp/mp-menu/pull'], ['class' => 'btn btn-sm btn-default']) ?>
            <?= Html::a('推送', ['/mp/mp-menu/push'], ['class' => 'btn btn-sm btn-info']) ?>
            <!--
            <//?= Html::a('测试', ['/mp/mp-menu/test'], ['class' => 'btn btn-sm btn-warning']) ?>
            -->
        </div>
    </div>
