...
return [
    ...
    'Carousel Widgets' => '轮播图组件',
    'Carousel slide was successfully saved' => '轮播图已成功保存',
    'Category' => '分类',
    'Clear' => '清除',
    'Content' => '内容',
    'Count' => '总数',
    ...
    'View user' => '查看用户',
    'Web Server' => 'Web 服务',
    'Widget Carousel Items' => '轮播图条目部件',
    'Create Widget Carousel Item' => '创建轮播图条目',
    'Widget Carousels' => '轮播图部件',
    'Widget Menus' => '菜单部件',
