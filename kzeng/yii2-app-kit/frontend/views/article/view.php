        ...
        <?php if ($model->thumbnail_path): ?>
            <!--
                ...
                Yii::$app->glide->createSignedUrl([
                    'glide/index',
                    'path' => $model->thumbnail_base_url .'/'.$model->thumbnail_path,
                    'w' => 200
                ], true),
            ...
            <img style="with:64px;height:64px" src="<?= $model->thumbnail_base_url ?>/<?= $model->thumbnail_path ?>" class="article-thumb img-rounded pull-left">
