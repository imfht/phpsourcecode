...
//10601 $path =urlencode('d:\inetpub\adodb\sqlite.db');
//10601 $dsn = "sqlite://$path/";
//10601 $dsn = "sqlite:" . $_SERVER['DOCUMENT_ROOT'] . "reportico/adodb/tests/sqlite-2.db" ;
//10601 $db = ADONewConnection($dsn);

	//echo $dsn;
	
	//$db = ADONewConnection('sqlite');

//10601 if ($db && $db->PConnect("d:\\inetpub\\adodb\\sqlite.db", "", "", "")) {
//10601	print "<h1>Connecting $db->databaseType...</h1>";
//10601 testdb($db,"create table ADOXYZ (id int, firstname char(24), lastname char(24),created datetime)");

//10601b
	$db = ADONewConnection('sqlite');
	if ($db && $db->PConnect($_SERVER['DOCUMENT_ROOT'] . "reportico/adodb/tests/sqlite-2.db", "", "", "")) {
		print "<h1>Connecting SQLite-2...</h1>";
...
//10601 print "ERROR: SQLite";
//10601b
		print "ERROR: CONNECT TO SQLite-2 FAILED";
//10601e
...
//10601 $connstr = "sqlite:d:/inetpub/adodb/sqlite-pdo.db3";
//10601b
	$connstr = "sqlite:" . $_SERVER['DOCUMENT_ROOT'] . "reportico/adodb/tests/sqlite-3.db" ;
//10601e
...
//10601 print "<h1>Connecting $db->databaseType...</h1>";
//10601 $db->Connect($connstr,$u,$p) || die("CONNECT FAILED");
//10601 testdb($db,
//10601 "create table ADOXYZ (id int, firstname char(24), lastname char(24), created date)");

//10601b
	print "<h1>Connecting PDO SQLite-3...</h1>";
	$db->Connect($connstr,$u,$p) || die("CONNECT TO PDO SQLite-3 FAILED");
