	...
	if (!Array.prototype.forEach)
		...
		markersData = {
			'Single_hotel': [
			{
				...
				map_image_url: (typeof ASIACATION !== "object") ? 'img/thumb_map_1.jpg' : ASIACATION.files_hosts+'/citytours/img/thumb_map_1.jpg',
			...
			for (var key in markersData){
				markersData[key].forEach(function (item) {
					marker = new google.maps.Marker({
						...
						map: mapObject,
						//icon: (typeof ASIACATION !== "object") ? 'img/pins/' + key + '.png' : ASIACATION.files_hosts+'/citytours/img/pins/' + key + '.png',
					});
		...
		function getInfoBox(item) {
			return new InfoBox({
				...
				closeBoxURL: (typeof ASIACATION !== "object") ? "img/close.gif" : ASIACATION.files_hosts+"/citytours/img/close.gif",
				isHidden: false,
				pane: 'floatPane',
