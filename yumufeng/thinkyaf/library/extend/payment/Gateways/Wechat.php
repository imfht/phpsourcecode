...
namespace extend\payment\Gateways;

use extend\payment\Contracts\Config;
use extend\payment\Contracts\GatewayInterface;
use extend\payment\Contracts\HttpService;
use extend\payment\Exceptions\Exception;
use extend\payment\Exceptions\GatewayException;
use extend\payment\Exceptions\InvalidArgumentException;

/**
 * 微信支付基础类
 * Class Wechat
 * @package extend\payment\Gateways\Wechat
 */
