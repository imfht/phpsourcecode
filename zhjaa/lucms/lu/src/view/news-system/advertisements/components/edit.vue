  ...
  <Modal v-model="modalShow" :closable='false' :mask-closable=false fullscreen>
    ...
    <Row>
      ...
      <Form ref="formData" :model="formData" :rules="rules" label-position="left" :label-width="100">
        ...
        <FormItem label="广告内容：">
          <editor v-if="formdataFinished" :cache="false" v-model="formData.content" :value="formData.content" @on-change="editContentChange" :upload-config='wangUploadConfig'></editor>
        </FormItem>
      </Form>
      </Col>
