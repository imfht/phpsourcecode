...
// +----------------------------------------------------------------------
// 精灵后台系统常量定义 
define('JINGLING_VERSION','1.0' );
define('JINGLING_ADDON_PATH', ROOT_PATH. '/addons/' ); 
...
function get_category($id = null, $field = null){
    ...
    /* 获取分类名称 */
    if(empty($list)){
    	$data = \think\Db::name('Category')->select();
 ...
 * @author wapai 邮箱:wapai@foxmail.com
 */
function get_document_model($id = null, $field = null,$extend = null){
    static $list;
