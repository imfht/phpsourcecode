...
var nativeShare = function (elementNode, config) {
    ...
    var qApiSrc = {
        lower: window.conf.HTTP+"3gimg.qq.com/html5/js/qb.js",
        higher: window.conf.HTTP+"jsapi.qq.com/get?api=app.share"
    };
    var bLevel = {
    ...
    this.init = function () {
        ...
        if (isqqBrowser || isucBrowser) {
            ...
            var purl = window.conf.ROOT+'/static/plugins/baiduShare/api/js/share.js?cdnversion='+~(-new Date()/36e5);    
			document.write('<script type="text/javascript" charset="utf-8" src="'+purl+'"></script>');
            //document.write('<script type="text/javascript" charset="utf-8" src="http://static.bshare.cn/b/bshareC0.js"></script>');
        }
    };
