...
class AddressStructure
{
    ...
    /**
     * parse the email address of the email.
     * 
     * @param boolean $full
     *            return full address (true) or only personal if it exists, otherwise email (false)
     * @param boolean $encoded
     *            (since 1.4.0) return rfc2047 encoded address (true) or plain text (false).
     * @param boolean $unconditionally_quote
     *            (since 1.4.21/1.5.2) when TRUE, always quote the personal part, whether or not it is encoded, otherwise quoting is only added if the personal part is not encoded
     * @return string
     */
     ...
     * 
     * @param boolean $unconditionally_quote
     *            (since 1.4.21) when TRUE, always quote the personal part, whether or not it is encoded, otherwise quoting is only added if the personal part is not encoded
     * @return string
     * @since 1.4.0
     */
