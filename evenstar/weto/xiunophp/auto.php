...
// 搜索框架的路径
function find_xiunophp_path() {
	if(is_file('./xiunophp/core.php')) {
		return './xiunophp/';
	} elseif(is_file('../core.php')) {
		return '../';
	} elseif(is_file('../xiunophp/core.php')) {
		return '../xiunophp/';
	} elseif(is_file('../../xiunophp/core.php')) {
		return '../../xiunophp/';
	} else {
		echo '没有找到 xiunophp 文件夹，请将 xiunophp 文件夹放置于应用目录下。';
		exit;
	}
}
...
define('XIUNOPHP_PATH', find_xiunophp_path());
...
// 框架的物理路径
define('FRAMEWORK_PATH', '".XIUNOPHP_PATH."');
