...
function toggle_bar_visibility($item, $ih)
{
...
function item_toolbar_action_cb($item_toolbar)
{
    global $dialogs;
    $config = $dialogs["CONFIG"];
    $multitext = IupGetDialogChild($item_toolbar, "MULTITEXT");
    $toolbar = IupGetChild(IupGetParent($multitext), 0);
...
function item_statusbar_action_cb($item_statusbar)
{
    global $dialogs;
    $config = $dialogs["CONFIG"];
    $multitext = IupGetDialogChild($item_statusbar, "MULTITEXT");
    $statusbar = IupGetBrother($multitext);
...
function item_help_action_cb($ih)
{
...
function main()
{
    ...
    IupSetCallback($item_toolbar, "ACTION", "item_toolbar_action_cb");
    IupSetAttribute($item_toolbar, "VALUE", "ON");
    $item_statusbar = IupItem("&Statusbar", NULL);
    IupSetCallback($item_statusbar, "ACTION", "item_statusbar_action_cb");
    ...
    IupSetCallback($item_help, "ACTION", "item_help_action_cb");
