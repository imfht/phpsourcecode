Ext.define('HDCWS.view.Article.Edit', {
	...
	items : {
		...
		items : [
...

			{
				...
				html : '如果没有文章类型,<span class="span-add-cat" style="color:#3892D3;cursor:pointer;font-weight:700">点击此处添加</span>'
	...
	initComponent : function(){
		...
		var artCat = this.down('combobox[name=cid]');

		artCat.getStore().load({

			callback : function(records, operation, success) {

				artCat.select(this.findRecord('id', artData.cid));
