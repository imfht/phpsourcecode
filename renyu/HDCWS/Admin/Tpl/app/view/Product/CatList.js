Ext.define('HDCWS.view.Product.CatList', {
	...
	tbar : [
		...
		{xtype : 'button', text: '添加产品类型', iconCls : 'list-add', action : 'catAdd'}
	...
	items : {
		...
		store : Ext.create('HDCWS.store.ProductCatList'),
...

				{
					...
					tpl : new Ext.XTemplate(
						...
						'<tpl>',
							...
							'<input type="text" value="Product/lists?cid={id}" style="width:120px;" />&nbsp;<a href="' + ROOT + '/Product/lists?cid={id}" target="_blank" style="color:#45BA6C;">前台访问</a>',
