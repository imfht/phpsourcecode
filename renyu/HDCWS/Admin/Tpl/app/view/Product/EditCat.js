Ext.define('HDCWS.view.Product.EditCat', {
	...
	bbar : [
		...
		{xtype : 'button', width : 120, height : 30, text : '取消', action : 'proCatEditCancel', handler : function(){this.up('window').close()}},

		{xtype : 'button', width : 120, height : 30, text : '提交', action : 'proCatEditSure', cls : 'edit-sure', overCls : 'edit-sure-hover'}
