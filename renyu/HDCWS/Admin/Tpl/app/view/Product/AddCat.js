Ext.define('HDCWS.view.Product.AddCat', {
	...
	bbar : [
		...
		{xtype : 'button', width : 120, height : 30, text : '取消', action : 'proCatAddCancel', handler : function(){this.up('window').close()}},

		{xtype : 'button', width : 120, height : 30, text : '提交', action : 'proCatAddSure', cls : 'add-sure', overCls : 'add-sure-hover'}
