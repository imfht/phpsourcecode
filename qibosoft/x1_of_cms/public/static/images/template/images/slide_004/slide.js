(function($){
    $.fn.ckSlide = function(opts){
        ...
        this.each(function(){
			...
			//点击切换相应序号的图片
            $(this).find('.ck-slidebox004 li').each(function(cindex){
            ...
            // 修正box  标记居中
            var box = $(this).find('.ck-slidebox004');
            box.css({
    ...
    function change(show, hide){
       ...
       //切换对应标记的颜色
        $(this).find('.ck-slidebox004 li').removeClass('current');
        $(this).find('.ck-slidebox004 li').eq(show).addClass('current');
    }
    $.fn.ckSlide.opts = {
