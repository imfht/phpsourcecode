...
(function(){
    ...
    function convert_url(url){
		...
		.replace(/v\.qq\.com\/[\w]+\/[\w]+\/([\w]+)\.html/i, "https://v.qq.com/txp/iframe/player.html?vid=$1")
            .replace(/v\.qq\.com\/.+[\?\&]vid=([^&]+).*$/i, "https://v.qq.com/txp/iframe/player.html?vid=$1")
            .replace(/my\.tv\.sohu\.com\/[\w]+\/[\d]+\/([\d]+)\.shtml.*$/i, "share.vrs.sohu.com/my/v.swf&id=$1");
//https://v.qq.com/x/page/j0919dff8us.html
*/
        return url;
    }
