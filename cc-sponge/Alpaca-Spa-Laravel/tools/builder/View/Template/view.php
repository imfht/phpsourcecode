    ...
    <div class="page page-current">
        ...
        <div class="content">
            <form action="/builder/create/builder" id="sub-form">
                        ...
                        <li>
                            <div class="item-content">
                                ...
                                <div class="item-inner">
                                    ...
                                    <div class="item-input">
                                        <input type="text" placeholder="中文名称(选填)" value="" name="table_name_cn">
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="item-content">
                                ...
                                <div class="item-inner">
                                    ...
                                    <div class="item-input">
                                        <input type="text" placeholder="二级模块(选填)" value="" name="sub_module_name">
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="item-content">
                                ...
                                <div class="item-inner">
                                    ...
                                    <div class="item-input">
                                        <input type="text" placeholder="后端模块" value="main" name="b_module_name">
                                    </div>
                                </div>
                            </div>
                        </li>
                ...
                <div class="content-block-title">生成字段说明文档(md)</div>
                <div class="list-block">
                    <ul>
                        <li>
                            <div class="item-content">
                                <div class="item-media"><i class="icon icon-form-toggle"></i></div>
                                <div class="item-inner">
                                    <div class="item-title label">列表</div>
                                    <div class="item-input line-right">
                                        <label class="label-switch">
                                            <input type="checkbox" checked name="is_md_list">
                                            <div class="checkbox"></div>
                                        </label>
                                    </div>
                                </div>
                        ...
                        <li>
                            <div class="item-content">
                                <div class="item-media"><i class="icon icon-form-toggle"></i></div>
                                <div class="item-inner">
                                    <div class="item-title label">编辑</div>
                                    <div class="item-input line-right">
                                        <label class="label-switch">
                                            <input type="checkbox" checked name="is_md_edit">
                                            <div class="checkbox"></div>
                                        </label>
                                    </div>
                                </div>
