...
require_once dirname(__FILE__).'/../attendance/include.php';
	...
	$instance = AttendReqService::get_instance();
	
	//定义输出字段
	$fieldNames = $instance->fieldNamesAfterRemovedSome(null);
