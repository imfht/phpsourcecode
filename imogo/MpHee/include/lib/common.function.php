...
//POST表单处理函数,$post_array:POST的数据,$delete_value:删除指定表单,$null_value:是否删除空表单
function postinput($post_array,$delete_value = array(),$null_value = null){
    //清除值为空或者为0的元素
    if($null_value){
    ...
    //清除不需要的元素
    $default_value = array('action','button','submit');
