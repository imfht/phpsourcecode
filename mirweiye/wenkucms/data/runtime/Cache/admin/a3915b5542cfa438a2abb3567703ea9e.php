...
<form class="layui-form layui-form-pane" action="">
    ...
    <table class="layui-table">
        ...
        <tbody id="navList">
        <?php if(is_array($template_list)): $i = 0; $__LIST__ = $template_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
              <td align="center"><span><a href="<?php echo ($val["preview"]); ?>" target="_blank"><img src="<?php echo ($val["preview"]); ?>" width="30" height="40" style="border:1px #E4E4E4 solid;" /></a></span></td>
              <td><span><?php echo ($val["name"]); ?></span></td>
              <td><span><?php echo ($val["dirname"]); ?></span></td>
              <td><span><?php echo ($val["author"]); ?></span></td>
              <td><span><?php echo ($val["version"]); ?></span></td>
              <td><?php if($def_tpl == $val['dirname']): ?><span class="green">当前模板</span><?php else: ?><a href="<?php echo U('view/tpl',array('dirname'=>$val['dirname'],'menuid'=>$menuid));?>" id="upbtn">设为默认</a><?php endif; ?></td>
   ...
   // 操作对象
    ...
    $(function(){
        $("#upbtn").click(function() {
            $.post("<?php echo U('view/tpl',array('dirname'=>$val['dirname'],'menuid'=>$menuid));?>",function(res){
