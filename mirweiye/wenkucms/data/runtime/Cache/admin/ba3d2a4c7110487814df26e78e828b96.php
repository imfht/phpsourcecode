...
<body class="body">
<?php if(is_array($message)): $i = 0; $__LIST__ = $message;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><!-- <li class="list_<?php echo ($val["type"]); ?>"><?php echo ($val["content"]); ?></li> -->
	<div class="layui-bg-red jinggao" id = "<?php echo ($val["divid"]); ?>"><span>警告：<?php echo ($val["content"]); ?></span><i class="layui-icon close">&#x1006;</i></div><?php endforeach; endif; else: echo "" ;endif; ?>
...
<div class="layui-col-xs12">
  <table class="layui-table">
    ...
    <tbody>
      <tr>
        <td><?php echo L('wkcms_version');?>：</td>
        <td>七只熊文库_3.4 共享版</td>
      </tr>
      <tr>
        <td><?php echo L('server_domain');?>：</td>
      ...
      <tr>
        <td>开发团队：</td>
        <td>Big.A 、 鱼小千、 枫虹一刀流 、 采姑娘的小蘑菇</td>
      </tr>
      <tr>
        <td>交流群：</td>
        <td><a target="_blank" href="//shang.qq.com/wpa/qunwpa?idkey=4ca374dc4da225a81f2af37c6bc607487bc907ae2ae6306159f10867fa10510d" style="color: #1E9FFF"> 633871890 </a></td>
      </tr>
      <tr>
        <td>七只熊官网：</td>
        <td><a target="_blank" href="http://www.qizhixiong.com" style="color: #1E9FFF"> http://www.qizhixiong.com </a></td>
      </tr>
    </tbody>
  </table>
</div>
