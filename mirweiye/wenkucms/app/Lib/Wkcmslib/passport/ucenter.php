...
class ucenter_passport
{
    ...
    public function edit($uid, $old_password, $data, $force = false) {
        ...
        $uc_uid = M('user')->where(array('uid'=>$uid))->getField('uc_id');
    ...
    public function get($flag, $is_name = false) {
        ...
        $uid = M('user')->where(array('uc_id'))->getField('uid');
        return array(
            'id' => $uid,
            'username' =>  $username,
            'email'     =>  $email
    ...
    public function auth($username, $password) {
        ...
        return array('uc_id'=>$result[0], 'username'=>$result[1], 'password'=>$result[2], 'email'=>$result[3]);
    }
