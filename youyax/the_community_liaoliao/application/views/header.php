	...
	<div class="container">
	  <div class="row">
		  ...
		  <div class="col-md-4 pull-right">
		  	<?php
		  	if(empty($_SESSION['liaoliao_user'])){	?>
		  	...
		  	<?php	}else{	?>
		  		...
		  		<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img src="<?php echo $avatar;?>" border="0" style="border-radius:50%;width:40px;"><span style="font-size:16px;position:relative;left:4px;top:4px;"><?php echo $_SESSION['liaoliao_user']; ?></span> </a>
