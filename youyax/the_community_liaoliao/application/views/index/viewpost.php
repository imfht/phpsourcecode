    ...
    <div class="col-md-9 form-padding form-padding-view">
		...
		if(!empty($post)){
			...
			<div class="row">
				...
				<div class="col-md-11 post-text">
					<?php echo $p['content'];?>
					<a href="javascript:;" onclick="showwho(this,<?php echo $p['userid'];?>)"><?php echo $this->general("getnamebyuid",$p['userid']);?></a> <small><?php echo $p['time'];?></small>
				</div>
			</div>
		...
		<?php	}	$num++;
			if(!empty($p['rcontent'])){	?>
				...
				<div class="col-md-11 post-text">
					<?php echo $p['rcontent'];?>
					<a href="javascript:;" onclick="showwho(this,<?php echo $p['ruserid'];?>)"><?php echo $this->general("getnamebyuid",$p['ruserid']);?></a> <small><?php echo $p['rtime'];?></small>
				</div>
			</div>
			<hr>
		<?php	}}}	?>	
