...
homeobject.showicons=function(a){
	...
	for(var i=0; i<a.length;i++){
		...
		s='';
		s+='<div onclick="opentabsshowshwo('+i+')" align="center" style="cursor:pointer;width:135px;float:left;margin:10px 15px;background:'+a[i].color+';border:none" onmouseover="this.style.opacity=0.8" onmouseout="this.style.opacity=1" class="thumbnail">';
