...
$user_infos = dt_query("SELECT id, name, intro FROM user_info WHERE id in (SELECT user_id FROM follow WHERE to_user_id = $user_id) ORDER BY c_at LIMIT ".$limit * ($page - 1).",$limit");
...
<div class="col-md-12 column">
	<?php pagination('follow', "WHERE to_user_id = $user_id", $page, $limit, 'javascript:get_fan_list(', ')') ?>
</div>
<script type="text/javascript">
$(document).ready(function(){
	$('li#my_fan').addClass('active');
});
</script>
