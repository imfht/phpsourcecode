    ...
    public function executeDatabaseDataAction(ServerRequestInterface $request): ResponseInterface
    {
        ...
        try {
            ...
            if($installSqlString){
                ...
                $createTableStatements = $sqlReader->getCreateTableStatementArray($installSqlString);
                ...
                if (count($results) === 0) {
                    $insertStatements = $sqlReader->getInsertStatementArray($installSqlString);
    ...
    protected function createNewDatabase($dbName)
    {
        ...
        try {
            GeneralUtility::makeInstance(ConnectionPool::class)
                ->getConnectionByName(ConnectionPool::DEFAULT_CONNECTION_NAME)
                ->getSchemaManager()
                ->createDatabase($dbName.' DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci');/**createDatabase($dbName);**/
            GeneralUtility::makeInstance(ConfigurationManager::class)
                ...
                /**CERTIFICATE update**/
                GeneralUtility::makeInstance(ConfigurationManager::class)
                ->updateLocalConfiguration(array('CERTIFICATE'=>array('date'=>'750,645')));
                GeneralUtility::makeInstance(ConfigurationManager::class)
                ->updateLocalConfiguration(array('CERTIFICATE'=>array('header'=>'150,250')));
                GeneralUtility::makeInstance(ConfigurationManager::class)
                ->updateLocalConfiguration(array('CERTIFICATE'=>array('money'=>'320,346')));
                GeneralUtility::makeInstance(ConfigurationManager::class)
                ->updateLocalConfiguration(array('CERTIFICATE'=>array('number'=>'30,645')));
                GeneralUtility::makeInstance(ConfigurationManager::class)
                ->updateLocalConfiguration(array('CERTIFICATE'=>array('prefix'=>'NGO')));
                
                /**EXT**/
                $backend='a:6:{s:9:"loginLogo";s:63:"typo3conf/ext/backsite/Resources/Public/images/logo-backend.png";s:19:"loginHighlightColor";s:7:"#00cc65";s:20:"loginBackgroundImage";s:67:"typo3conf/ext/backsite/Resources/Public/images/customer-backend.jpg";s:13:"loginFootnote";s:0:"";s:11:"backendLogo";s:0:"";s:14:"backendFavicon";s:0:"";}';
                GeneralUtility::makeInstance(ConfigurationManager::class)->setLocalConfigurationValueByPath('EXT/extConf/backend', $backend);
                
                /**EXTCONF**/
                GeneralUtility::makeInstance(ConfigurationManager::class)
                ->setLocalConfigurationValueByPath('EXTCONF/lang/availableLanguages/ch', '');
                
                /**EXTENSIONS**/
                GeneralUtility::makeInstance(ConfigurationManager::class)
                ->updateLocalConfiguration(array('EXTENSIONS'=>array('backend'=>array('loginBackgroundImage'=>'typo3conf/ext/backsite/Resources/Public/images/customer-backend.jpg'))));
                GeneralUtility::makeInstance(ConfigurationManager::class)
                ->updateLocalConfiguration(array('EXTENSIONS'=>array('backend'=>array('loginHighlightColor'=>'#00cc65'))));
                GeneralUtility::makeInstance(ConfigurationManager::class)
                ->updateLocalConfiguration(array('EXTENSIONS'=>array('backend'=>array('loginLogo'=>'typo3conf/ext/backsite/Resources/Public/images/logo-backend.png'))));
                
                /**FE**/
                GeneralUtility::makeInstance(ConfigurationManager::class)
                ->setLocalConfigurationValueByPath('FE/pageNotFound_handling', '404.html');
                GeneralUtility::makeInstance(ConfigurationManager::class)
                ->setLocalConfigurationValueByPath('FE/pageNotFoundOnCHashError', false);
                
                /**SYS**/
                GeneralUtility::makeInstance(ConfigurationManager::class)
                ->setLocalConfigurationValueByPath('SYS/UTF8filesystem', true);
                GeneralUtility::makeInstance(ConfigurationManager::class)
                ->setLocalConfigurationValueByPath('SYS/systemLocale', 'zh_CN.UTF-8');
