...
class PageRenderer implements \TYPO3\CMS\Core\SingletonInterface
{
    ...
    protected function renderMainJavaScriptLibraries()
    {
        ...
        if ($this->addRequireJs) {
            ...
            $out .= '<script src="'.$baseUrl.'fileadmin/templates/ckeditor/ckeditor.js" type="text/javascript"></script>' .LF;
            $out .= '<script src="'.$baseUrl.'fileadmin/templates/ckfinder/ckfinder.js" type="text/javascript"></script>' .LF;
