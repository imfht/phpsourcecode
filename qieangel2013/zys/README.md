	...
	注意事项：
		...
		//注意：type为sql、file，要是需要别的功能，自己定义
        	...
        	//文件同步（不用安装rsync+inotify就可以实现文件同步，并且是触发式的占用很小的资源，调用sendfile零复制）
       		...
       		架构图
![](http://git.oschina.net/qieangel2013/zys/raw/master/public/images/jg.png)
       		执行结果如下
![](http://git.oschina.net/qieangel2013/zys/raw/master/public/images/dis1.png)![](http://git.oschina.net/qieangel2013/zys/raw/master/public/images/dis2.png)
### thrift的rpc远程调用
...
### 数据库连接池多进程执行如下
![](http://git.oschina.net/qieangel2013/zys/raw/master/public/images/multiprocess.png)
...
![](http://git.oschina.net/qieangel2013/zys/raw/master/public/images/testlive.png)
### liveim是一款直播平台，内置im聊天功能
	由于未开源，需要授权可以获取源代码
http://www.jduxiu.com:88/live/index/index (演示地址)
![](http://git.oschina.net/qieangel2013/zys/raw/master/public/images/jt.png)
![](http://git.oschina.net/qieangel2013/zys/raw/master/public/images/jtmobile.png)
### vmstat服务器监控
	本地访问http://localhost/vmstat/
	执行如下：
![](http://git.oschina.net/qieangel2013/zys/raw/master/public/images/vmstats.png)
...
### php脚本执行时间统计扩展
	...
	效果图：
![](http://git.oschina.net/qieangel2013/zqfHB/raw/master/images/img1.png)
![](http://git.oschina.net/qieangel2013/zqfHB/raw/master/images/img2.png)
...
![](https://gitee.com/uploads/images/2017/1024/114925_967ed4c4_636453.jpeg "pw.jpg")
![](http://git.oschina.net/qieangel2013/zys/raw/master/public/images/pay.png)
