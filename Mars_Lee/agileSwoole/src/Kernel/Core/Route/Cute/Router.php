...
// composer error  filename need ucfirst route => Route in *inux system
// already notice author by github issue
namespace Kernel\Core\Route\Cute;
/**
 * Route类的管理容器
 */
class Router{
     ...
     * @return \Kernel\Core\Route\Cute\Route|false
     */
     ...
     * @return \Kernel\Core\Route\Cute\Route    添加的Route对象
     */
