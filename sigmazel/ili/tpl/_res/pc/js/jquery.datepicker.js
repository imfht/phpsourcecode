...
;(function($) {
    ...
    $.fn.datepicker = function(o) {
        ...
        if (cp.length == 0) {
            ...
            //end tbody
            cpHA.push("</td></tr>");
            cpHA.push("<tr><td class='bbit-dp-bottom' align='center'><button id='BBIT-DP-TODAY'>", def.btnToday, "</button>&nbsp;<button id='BBIT-DP-CLEAR'>", def.btnClear, "</button></td></tr>");
