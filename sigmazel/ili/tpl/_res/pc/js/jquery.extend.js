...
$.extend($, {
	dialog:function(options){
		...
		function _dialog_callback(){
            ...
            if(document_width < 950){
                var _cheight = $('.content', _dialog).height() + _title_height + _bottom_height;
                if(_cheight < 160) _cheight = 160;
		...
		var _margin_top = document.documentElement.clientHeight - params.height - _bottom_height - _title_height - 60;
        ...
        if(document_width < 950) _tempHTML += '<div class="window fadeIn fasted">';
        else _tempHTML += '<div class="window" style="' + params.style + ' width:' + params.width + 'px; height:' + (params.height + _title_height + _bottom_height) + 'px; margin-top:' + (_margin_top / 2) + 'px; margin-left:-' + (params.width / 2) + 'px;">';
		...
		if(params.shut){
			_tempHTML += '<p class="shut" rel="shut"></p>';
		}

        if(document_width < 950) _tempHTML += '<div class="content"></div>';
		else _tempHTML += '<div class="content" style="height:' + (params.height) + 'px; overflow:' + params.overflow + ';"></div>';
