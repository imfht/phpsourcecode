...
class UploaderWidget extends Controller {
    public function file($name='',$value='',$config=''){
		...
		$this->display(MODULE_PATH.'Widget/Tpl/Uploader/file.html');
    }
	...
	public function img($name='',$value='',$config=''){
		...
		$this->display(MODULE_PATH.'Widget/Tpl/Uploader/img.html');
	}
    ...
    public function images($name='',$value='',$config=''){
		...
		$this->display(MODULE_PATH.'Widget/Tpl/Uploader/images.html');
    }
