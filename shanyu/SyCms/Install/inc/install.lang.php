<?php
if(!defined('SHANYU_INSTALL')) exit('Access Denied');

$lang = array(
	'install_title' => 'ShanYuCms 1.6安装向导',
	'install_license' => '山雨内容管理系统-安装用户协议',
	'install_is_lock' => '您已成功安装山雨内容管理系统，如需需重新安装本系统,请手动删除网站目录下install/install.lock文件', 
	'install_db_error' => '数据库文件无法读取，请检查install/inc/ShanYuCms.sql是否存在。',	
	...
	'install_founder_name_empty' => '管理员帐号不能为空',
	'install_founder_password_length' => '管理员密码必须大于6位',
	'founder_invalid_password' => '管理员密码不能为空',
