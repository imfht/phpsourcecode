...
class CommonController extends Controller {
    ...
    static $noMenuModules = array('Public');
    /**
    * 全局初始化
    * @return
    */
    public function _initialize() {
       ...
       // $this->filterInstall();
        ...
        if (!in_array(CONTROLLER_NAME, self::$noMenuModules)) {
            // 分配菜单
            $this->assignMenu();
            // 面包屑位置
     ...
     * @return array
     */
    protected function getPagination($modelName, $where=null, $fields=null, $order=null) {
