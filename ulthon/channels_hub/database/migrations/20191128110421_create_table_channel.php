...
class CreateTableChannel extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('channel')->setComment('端口隧道');
        ...
        $table->addColumn(Column::integer('server_port')->setSigned(false)->setComment('服务端占用端口'));
