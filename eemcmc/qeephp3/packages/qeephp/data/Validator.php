...
abstract class Validator
{
     ...
     * @endcode
     *
     * 'between' 是验证规则的名字，对应于 Validator::between() 方法。
     * 因此要使用 Validator 的其他验证方法，将方法名中的“”去掉即为验证规则名。
     *
     * 如果要使用自定义的验证规则，有三种写法：
     *
     * @code php
    ...
    static function validateByArgs($validation, array $args)
    {
        ...
        if (is_null($internal_funcs))
        {
            $internal_funcs = array('between', 'equal', 'greater_or_equal',
                'greater_than', 'is_phone', 'is_alnum', 'is_alnumu', 'is_alpha', 'is_ascii',
        ...
        {
            $result = call_user_func_array(array(__CLASS__, $validation), $args);
        }
     ...
     * @return boolean
     */
    static function skip_by($value, $cond)
    {
     ...
     * @return boolean
     */
    static function skip_null($value)
    {
     ...
     * @return boolean
     */
    static function skip_on_failed()
    {
     ...
     * @return boolean
     */
    static function not_equal($value, $test)
    {
        return $value != $test || strlen($value) != strlen($test);
    }
     ...
     * @return boolean
     */
    static function not_same($value, $test)
    {
        return $value !== $test;
    }
     ...
     * @return boolean
     */
    static function less_or_equal($value, $test)
    {
        return $value <= $test;
    }
     ...
     * @return boolean
     */
    static function is_type($value, $type)
    {
     ...
     * @return boolean
     */
    static function is_cntrl($value)
    {
     ...
     * @return boolean
     */
    static function is_graph($value)
    {
     ...
     * @return boolean
     */
    static function is_lower($value)
    {
     ...
     * @return boolean
     */
    static function is_print($value)
    {
     ...
     * @return boolean
     */
    static function is_punct($value)
    {
     ...
     * @return boolean
     */
    static function is_whitespace($value)
    {
     ...
     * @return boolean
     */
    static function is_upper($value)
    {
     ...
     * @return boolean
     */
    static function is_xdigits($value)
    {
     ...
     * @return boolean
     */
    static function is_ascii($value)
    {
     ...
     * @return boolean
     */
    static function is_datetime($value)
    {
     ...
     * @return boolean
     */
    static function is_octal($value)
    {
     ...
     * @return boolean
     */
    static function is_binary($value)
    {
