                ...
                <div class="col-sm-10">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form method="POST" action="{{ route('admin.adspaces.update',$adspace->id) }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                {{ method_field('put') }}
                                ...
                                <div class="input-group checkbox">
                                    ...
                                    <input type="checkbox" name="is_open" value="1" data-on-text="开放" data-off-text="关闭" @if(old('is_open', $adspace->is_open)) checked @endif />
                                </div>
