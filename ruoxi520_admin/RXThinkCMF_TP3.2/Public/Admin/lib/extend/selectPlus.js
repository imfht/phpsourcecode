...
layui.define('form', function (exports) {
  ...
  Class.prototype.render = function () {
    ...
    options.reElem = $('<div class="layui-unselect layui-form-select">' +
      ...
      '<input type="text" placeholder="请选择' + options.placeHolder + '" value="" readonly="" class="layui-input layui-unselect">' +
      '<i class="layui-edge"></i>' +
      '</div>' +
      '<dl class="layui-anim layui-anim-upbit">' +
      '<dd lay-value="" class="layui-select-tips layui-hide">请选择' + options.placeHolder + '</dd>' +
      '</dl>' +
      '</div>');
    ...
    items = {
      ...
      checkbox: function (config, data, id) {
        ...
        allEle.nextAll().each(function (index) {
          ...
          var checkbox = $('<input type="checkbox" name="' + elemId + '[' + item[valueId] + ']"  yw-index="' + item[indexName] + '" lay-skin="primary" title="' + title + '" layui-value="' + layuiValue + '">');
          if (item[checkedName]) {
      ...
      radio: function (config, data, id) {
        ...
        el.find('dd').eq(0).nextAll().each(function (index) {
          ...
          var dd = $('<input type="radio" name="' + elemId + '[' + item[valueId] + ']"  yw-index="' + item[indexName] + '" lay-skin="primary" title="' + title + '" layui-value="' + layuiValue + '">');
