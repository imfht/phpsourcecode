...
layui.define(['jquery', 'layer'], function(exports){
	...
	var obj = function(config){
		...
		this.config = {
			//选择器id或class
			elem: '',
			//数据格式[{id:"1",name:"名称1",status:0},{id:"2",name:"名称2",status:1}]
			data: [],			
