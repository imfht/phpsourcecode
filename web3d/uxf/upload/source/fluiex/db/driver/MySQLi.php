...
namespace fluiex\db\driver;

use fluiex\db\DriverInterface;
...
class MySQLi implements DriverInterface
{
    ...
    function error()
    {
        return ($this->curlink) ? $this->curlink->error : '';
    }

    function errno()
    {
        return ($this->curlink) ? $this->curlink->errno : 0;
    }
    ...
    {
        throw new Exception($message, $code, $sql);
    }
