...
class DB
{
    ...
    public static function init($driver, $config)
    {
        ...
        if (!strpos($driver, '\\')) {
            $driver = '\\fluiex\\db\\driver\\' . $driver;
        }
        self::$db = new $driver;
    ...
    {
        return SafeChecker::checkquery($sql);
    }
    ...
    public static function field($field, $val, $glue = '=')
    {
        ...
        switch ($glue) {
            ...
            default:
                throw new Exception('Not allow this glue between field and value: "' . $glue . '"');
        }
    }
    ...
    public static function format($sql, $arg)
    {
        ...
        if (!$count) {
            ...
            throw new Exception('SQL string format error! This SQL need "' . $count . '" vars to replace into.', 0, $sql);
        }
