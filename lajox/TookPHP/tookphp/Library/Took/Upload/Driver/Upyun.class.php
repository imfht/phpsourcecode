...
class Upyun{
    ...
    public function __construct($config){
        ...
        $this->upyun = new \Took\Upload\Driver\Upyun\UpYun($this->config['bucketname'], $this->config['username'], $this->config['password']);
    }
    ...
    public function mkdir($savepath){
        //$result = $this->upyun->makeDir($this->rootPath . $savepath, true);
        return true;
    }
