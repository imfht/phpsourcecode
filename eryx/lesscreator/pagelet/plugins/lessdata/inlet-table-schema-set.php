...
<form id="bhw2j1" action="/lesscreator/plugins/lessdata/inlet-table-schema-set">
...
<thead>
    <tr>
        ...
        <th><?php echo $this->T('Length')?> (varchar、integer)</th>
        <th><?php echo $this->T('Index')?></th>
        <th><?php echo $this->T('Option')?></th>
    </tr>
</thead>
<tbody id="field_list">
    <?php
    foreach ($tableInfo['schema'] as $v) {
        ...
        <tr>
            ...
            <td>
                <a href="javascript:void(0)" onclick="_data_field_del(this)"><?php echo $this->T('Delete')?></a>
            </td>
        </tr>
        <?php
    }
...
<a href="javascript:_data_field_append()" ><?php echo $this->T('New Field')?></a>
...
function _data_field_append()
{
    ...
    entry = '<tr> \
      ...
      <td> \
        <select name="fstype['+sid+']" class="input-large"> \
        <?php
      ...
      <td> \
        <select name="fsidx['+sid+']" class="input-medium"> \
        <?php
        foreach ($fieldidxs as $k2 => $v2) {
      ...
      <td><a href="javascript:void(0)" onclick="_data_field_del(this)"><?php echo $this->T('Delete')?></a></td> \
    </tr>';
