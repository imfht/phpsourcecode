<?php
/**
 * http://172.16.12.153/thumb.php?src=http://172.16.12.153/Upload/Cmzupload/20160719175447.jpeg&h=50&w=50
 * 其它特殊效果，参照http://my.oschina.net/bibo/blog/727345
 * <img src="' . get_bloginfo("template_url") . '/timthumb.php?src='图片地址'&h='图片高度'&w='图片宽度 '&zc=1" class="thumb" />
* zc 代表是否裁剪，0为否，1为是，默认是从图片中央进行裁剪。
*如果在使用中没有指定 h 和 w ：
*<img src="http://outsiderla.me/.../timthumb.php?src=http://img.ioutsider.me/2012/04/14253UN4-4-300x187.jpg" class="thumb" />
*它默认会生成一个100X100的图片.
*timthumb.php 使用方法
*现在我们给图片指定一个h 和 w都为150:
*
*<img src="http://outsiderla.me/.../timthumb.php?src=http://img.ioutsider.me/2012/04/14253UN4-4-300x187.jpg&h=150&w=150" class="thumb" />
*
*
*下面是w等于400 H=200
*
*<img src="http://outsiderla.me/.../timthumb.php?src=http://img.ioutsider.me/2012/04/14253UN4-4-300x187.jpg&h=200&w=400" class="thumb" />
*
*
*可以看出不论图片的尺寸怎么变化，图片都不会变形，如果放得很大，只会变得模糊.
*更多参数
*
*下面我们再来看下别的参数，可以让图片生成不现的特效..
*
*<img src="http://outsiderla.me/.../timthumb.php?src=http://img.ioutsider.me/2012/04/14253UN4-4-300x187.jpg&h=200&w=200&f=1" class="thumb" />
*
*<img src="http://outsiderla.me/.../timthumb.php?src=http://img.ioutsider.me/2012/04/14253UN4-4-300x187.jpg&h=200&w=200&f=10" class="thumb" />
*
*<img src="http://outsiderla.me/.../timthumb.php?src=http://img.ioutsider.me/2012/04/14253UN4-4-300x187.jpg&h=200&w=200&f=3,80" class="thumb" />
*
*<img src="http://outsiderla.me/.../timthumb.php?src=http://img.ioutsider.me/2012/04/14253UN4-4-300x
...
if(! defined('FILE_CACHE_DIRECTORY') ) 		define ('FILE_CACHE_DIRECTORY', './Upload/timthumb/cache');				// Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
