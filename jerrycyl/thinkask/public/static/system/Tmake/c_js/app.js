...
var App = function() {
            ...
            if ($elBlock.length) {
                ...
                switch($mode) {
                    ...
                    case 'refresh_toggle':
                        ...
                        $elBlock.prepend('<div id="loading" class="refresh-self-area"><div class="loading-box"><i class="fa fa-2x fa-cog fa-spin"></i> <span class="loding-text">刷新中...</span></div></div>')
    ...
    var uiHandleTheme = function() {
        ...
        jQuery('[data-toggle="theme"]').on('click', function(){
            ...
            Tthinkask.loading();
            jQuery.get(thinkask.theme_url, {theme: $theme}, function (res) {
    ...
    var uiHelperCkeditor = function(){
        ...
        jQuery('.js-ckeditor').each(function () {
            ...
            var editor    = CKEDITOR.replace(editor_id, {
                filebrowserImageUploadUrl: thinkask.ckeditor_img_upload_url,
                image_previewText: ' ',
            ...
            $summernote.summernote({
                ...
                callbacks: {
                    onImageUpload: function(files) {
                        ...
                        $.ajax({
                            url : thinkask.image_upload_url,//后台文件上传接口
                            type : 'POST',
                            data : formData,
                            cache: false,
                            processData : false,
                            ...
                            success : function(res) {
                                if (res.status == 1) {
                                    ...
                                    Tthinkask.notify(res.info, 'danger');
                                }
                            }
                        });
                    }
