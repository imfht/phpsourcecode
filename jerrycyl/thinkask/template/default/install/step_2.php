	...
	<div class="main">
		...
		<table class="table1">
			...
			<tr>
				...
				<td>
				<?php 
					$dirvalue =rtrim(ROOT_PATH,"/").$dirvalue;
		...
		<div class="action"><a href="javascript:history.go(-1);" class="btn_blue"><?php echo lang('previous');?></a>&nbsp;&nbsp;&nbsp;<a href="/install/index/index?step=3" class="btn_blue"><?php echo lang('next');?></a></div>
	</div>
</body>
</html>