 ...
 */
require_once dirname(__FILE__) . '/../libs/simpletest/unit_tester.php';
require_once dirname(__FILE__) . '/../libs/simpletest/mock_objects.php';
require_once dirname(__FILE__) . '/../libs/simpletest/collector.php';
require_once dirname(__FILE__) . '/../libs/simpletest/default_reporter.php';
require_once dirname(__FILE__) . './PApiReporter.php';
/**#@-*/
...
function run_local_tests() {
    try {
        ...
        if (SimpleReporter::inCli()) {
        	...
        	return $suite->run(new PApiReporter());
        }
//         return $suite->run(new DefaultReporter());
