...
class handle extends hand
{
	...
	public function todo(){
		...
		if(!isset($config['property']['collection']))throw new \Exception($name. " collection error");
		$tableName = $config['property']['collection'];
		$_maxLimit = $maxLimit;
		$_where = [];
		$_whereIn = [];
		$_orderBy = [];
		...
		$dbtype='\\DataComposer\\Providers\\mongo\\'.$default_fwtype;
