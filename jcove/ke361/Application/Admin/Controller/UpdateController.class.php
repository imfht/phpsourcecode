...
class UpdateController extends AdminController{
	...
	private function checkVersion(){
		if(extension_loaded('curl')){
			$url = 'http://www.361dream.com/index.php?s=Home/Index/checkVersion.html';
			$params = array(
	...
	private function update($version){
		...
		/* 获取更新包 */
		//获取更新包地址
		$updatedUrl = 'http://www.361dream.com/index.php?s=Home/Index/getDownUrl.html';
		$params = array(
            'version' => ONETHINK_VERSION,
            'license'    =>C('LICENSE'),
            'domain'  => $_SERVER['HTTP_HOST'],
		...
		$downZip = file_get_contents($updatedUrl);
		if(empty($downZip)){
		...
		/* 更新数据库 */
		$updatesql = './Application/Install/Data/update.sql';
