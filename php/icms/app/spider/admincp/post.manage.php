        ...
        <table class="table table-bordered table-condensed table-hover">
          ...
          <tbody>
            ...
            <tr id="id<?php echo $rs[$i]['id'] ; ?>">
              ...
              <td>
                <a href="<?php echo APP_FURI; ?>&do=copy&poid=<?php echo $rs[$i]['id']; ?>" class="btn btn-small" target="iPHP_FRAME"><i class="fa fa-copy"></i> 复制</a>
                <a href="<?php echo APP_URI; ?>&do=add&poid=<?php echo $rs[$i]['id'] ; ?>" class="btn btn-small"><i class="fa fa-edit"></i> 编辑</a>
                <a href="<?php echo APP_FURI; ?>&do=del&poid=<?php echo $rs[$i]['id'] ; ?>" target="iPHP_FRAME" class="del btn btn-small" title='永久删除'  onclick="return confirm('确定要删除?');"/><i class="fa fa-trash-o"></i> 删除</a></td>
            </tr>
            <?php }  ?>
          </tbody>
          <tfoot>
