...
return patch::upgrade(function(){
  ...
  ALTER TABLE `#iCMS@__user_openid`
    ...
    ADD COLUMN `appid` VARCHAR(64) DEFAULT '' NOT NULL AFTER `platform`,
    CHANGE `uid` `uid` INT(10) UNSIGNED NOT NULL,
    CHANGE `openid` `openid` VARCHAR(128) DEFAULT '' NOT NULL,
    DROP PRIMARY KEY,
    ADD PRIMARY KEY (`id`),
    ADD INDEX `idx_upa` (`uid`, `platform`, `appid`);
      ...
      if($fields['appid']){
        iDB::query("
    ALTER TABLE `#iCMS@__user_openid`
    CHANGE `appid` `appid` VARCHAR(64) DEFAULT '' NOT NULL;
        ");
        $msg.= '更新user_openid表appid<iCMS>';
      }
