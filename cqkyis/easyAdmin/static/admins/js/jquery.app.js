    ...
    Sidemenu.prototype.menuItemClick = function(e) {
       if(!$("#wrapper").hasClass("enlarged")){
        ...
        if(!$(this).hasClass("subdrop")) {
          ...
          $("#sidebar-menu .pull-right i").removeClass(" md-keyboard-arrow-down").addClass(" md-keyboard-arrow-right");
          
          // open our new menu and add the open class
          $(this).next("ul").slideDown(350);
          $(this).addClass("subdrop");
          $(".pull-right i",$(this).parents(".has_sub:last")).removeClass(" md-keyboard-arrow-right").addClass("md-keyboard-arrow-down");
          $(".pull-right i",$(this).siblings("ul")).removeClass("md-keyboard-arrow-down").addClass(" md-keyboard-arrow-right");
        }else if($(this).hasClass("subdrop")) {
          $(this).removeClass("subdrop");
          $(this).next("ul").slideUp(350);
          $(".pull-right i",$(this).parent()).removeClass("md-keyboard-arrow-down").addClass("md-keyboard-arrow-right");
        }
      } 
    },
