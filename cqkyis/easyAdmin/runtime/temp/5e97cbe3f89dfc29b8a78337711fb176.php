<?php /*a:2:{s:55:"E:\kyweixin\EasyAdmin\cqkyicms\admin\view\sys\menu.html";i:1525795779;s:58:"E:\kyweixin\EasyAdmin\cqkyicms\admin\view\index\index.html";i:1525800716;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="left side-menu">
        <div class="sidebar-inner slimscrollleft">
            ...
            <div id="sidebar-menu">
                <ul>
                    <li>
                        <a href="<?php echo url('index/index'); ?>" class="waves-effect waves-light  <?php if(($p ==0)): ?> active  <?php endif; ?> "><i class="md md-home"></i><span> 欢迎页面 </span></a>
                    </li>
                    <?php if(is_array($menu) || $menu instanceof \think\Collection || $menu instanceof \think\Paginator): if( count($menu)==0 ) : echo "" ;else: foreach($menu as $key=>$vo): ?>
                    <li class="has_sub">
                        <a  class="waves-effect waves-light  <?php if(($p ==$vo['menu_id'])): ?> active  <?php endif; ?>  "><i class="<?php echo htmlentities($vo['menu_icon']); ?>"></i><span> <?php echo htmlentities($vo['menu_name']); ?> </span><span class="pull-right"><i class="md  md-keyboard-arrow-right"></i></span></a>
                        <ul class="list-unstyled"    >
                            ...
                            <li <?php if(($m ==$sub['menu_id'])): ?> class="active"  <?php endif; ?> ><a  href="<?php echo url($sub['menu_role'],array('p'=>$vo['menu_id'],'m'=>$sub['menu_id'])); ?>"  ><?php echo htmlentities($sub['menu_name']); ?></a></li>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <a class="btn btn-success btn-icon btn-sm" href="<?php echo url('sys/addmenu',array('id'=>0)); ?>" rel="add" >
            <i class="md  md-add"></i>
            <span>添加系统菜单</span>
        </a>
                ...
                .bootstrapTreeTable(
                        {
                            ...
                            url: "<?php echo url('sys/menulist'); ?>", // 请求数据的ajax的url
                            ...
                            columns: [
                                ...
                                },
                                {
                                    ...
                                    formatter: function (item, index) {
                                        ...
                                        var addother = "<?php echo url('sys/addmenu',array('id'=>'p_id')); ?>";
                                        var editother = "<?php echo url('sys/editmenu',array('id'=>'p_id')); ?>";
                                        var delother = "<?php echo url('sys/delmenu',array('id'=>'p_id')); ?>";
