<?php /*a:2:{s:63:"D:\php-work-2018\EasyAdmin\cqkyicms\admin\view\setting\sms.html";i:1526779561;s:63:"D:\php-work-2018\EasyAdmin\cqkyicms\admin\view\index\index.html";i:1525804571;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="col-lg-12">
                            <form action="<?php echo url('setting/sms'); ?>"  target="frame" method="post" id="Add" style="margin-top: 20px">


                                    <div class="form-group clearfix">
                                        <label class="col-lg-1 control-label" for="KeyId">KeyId *</label>
                                        <div class="col-lg-7">
                                           <input type="hidden" name="id" value="<?php echo htmlentities($wx['id']); ?>">
                                            <input class="form-control required" id="KeyId" value="<?php echo htmlentities($wx['KeyId']); ?>" name="token" type="text" placeholder="KeyId">
                                        </div>
                                        <div class="col-lg-4">
                                           *阿里短信获得的KeyId
                                        </div>
                                    ...
                                    <div class="form-group clearfix">
                                        <label class="col-lg-1 control-label" for="KeySecret">KeySecret *</label>
                                        <div class="col-lg-7">
                                            <input class="form-control " id="KeySecret" name="KeySecret" value="<?php echo htmlentities($wx['KeySecret']); ?>" type="text" placeholder="KeySecret">
                                        </div>
                                        <div class="col-lg-4">
                                            *阿里短信获得的KeySecret
                                        </div>
                                    ...
                                    <div class="form-group clearfix">
                                        <label class="col-lg-1 control-label" for="SignName">SignName </label>
                                        <div class="col-lg-7">
                                            <input class="form-control " id="SignName" name="SignName" value="<?php echo htmlentities($wx['SignName']); ?>" type="text" placeholder="SignName">
                                        </div>
                                        <div class="col-lg-4">
                                            阿里短信签名
                                        </div>
