<?php /*a:2:{s:64:"D:\php-work-2018\EasyAdmin\cqkyicms\admin\view\weixin\index.html";i:1526718606;s:63:"D:\php-work-2018\EasyAdmin\cqkyicms\admin\view\index\index.html";i:1525804571;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="col-lg-12">
                            <form action="<?php echo url('weixin/index'); ?>"  target="frame" method="post" id="Add" style="margin-top: 20px">


                                    <div class="form-group clearfix">
                                        <label class="col-lg-1 control-label" for="token">token *</label>
                                        <div class="col-lg-7">

                                            <input class="form-control required" id="token" value="<?php echo htmlentities($wx['token']); ?>" name="token" type="text" placeholder="token">
                                        </div>
                                        <div class="col-lg-4">
                                           *填写你设定的key
                                        </div>
                                    ...
                                    <div class="form-group clearfix">
                                        <label class="col-lg-1 control-label" for="appid">appid *</label>
                                        <div class="col-lg-7">
                                            <input class="form-control " id="appid" name="appid" value="<?php echo htmlentities($wx['appid']); ?>" type="text" placeholder="appid">
                                        </div>
                                        <div class="col-lg-4">
                                    ...
                                    <div class="form-group clearfix">
                                        <label class="col-lg-1 control-label" for="appsecret">appsecret </label>
                                        <div class="col-lg-7">
                                            <input class="form-control " id="appsecret" name="appsecret" value="<?php echo htmlentities($wx['appsecret']); ?>" type="text" placeholder="appsecret">
                                        </div>
                                        <div class="col-lg-4">
                                            填写高级调用功能的密钥
                                        </div>
                                    ...
                                    <div class="form-group clearfix">
                                        <label class="col-lg-1 control-label" for="encodingaeskey">encodingaeskey </label>
                                        <div class="col-lg-7">

                                            <input type="text" class="form-control required" name="encodingaeskey" id="encodingaeskey"  value="<?php echo htmlentities($wx['encodingaeskey']); ?>"   placeholder="encodingaeskey">

                                        </div>
                                        <div class="col-lg-4">
                                            填写加密用的EncodingAESKey（可选，接口传输选择加密时必需）
                                        </div>
                                    </div>
                                    <div class="form-group clearfix">
                                        <label class="col-lg-1 control-label" for="mch_id">mch_id *</label>
                                        <div class="col-lg-7">

                                            <input type="text" id="mch_id" name="mch_id" class="form-control required" value="<?php echo htmlentities($wx['mch_id']); ?>" placeholder="mch_id">
                                    ...
                                    <div class="form-group clearfix">
                                        <label class="col-lg-1 control-label" for="mch_id">partnerkey *</label>
                                        <div class="col-lg-7">

                                            <input type="text" id="partnerkey" name="partnerkey" class="form-control required" value="<?php echo htmlentities($wx['partnerkey']); ?>" placeholder="partnerkey">
