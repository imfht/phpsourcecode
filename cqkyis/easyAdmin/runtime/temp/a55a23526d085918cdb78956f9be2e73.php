<?php /*a:2:{s:62:"D:\php-work-2018\EasyAdmin\cqkyicms\admin\view\weixin\app.html";i:1527847316;s:63:"D:\php-work-2018\EasyAdmin\cqkyicms\admin\view\index\index.html";i:1525804571;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="col-lg-12">
                            <form action="<?php echo url('weixin/app'); ?>"  target="frame" method="post" id="Add" style="margin-top: 20px">
                                ...
                                <div class="form-group clearfix">
                                    <label class="col-lg-1 control-label" for="mch_id">appsecret </label>
                                    <div class="col-lg-7">
                                        <input class="form-control " id="mch_id" name="mch_id" value="<?php echo htmlentities($wx['mch_id']); ?>" type="text" placeholder="mch_id">
                                    </div>
                                    <div class="col-lg-4">
                                        微信支付用户商户号
                                    </div>
                                ...
                                <div class="form-group clearfix">
                                    <label class="col-lg-1 control-label" for="partnerkey">partnerkey </label>
                                    <div class="col-lg-7">
                                        <input class="form-control " id="partnerkey" name="partnerkey" value="<?php echo htmlentities($wx['partnerkey']); ?>" type="text" placeholder="partnerkey">
                                    </div>
                                    <div class="col-lg-4">
                                        微信支付API的KEY
                                    </div>
