<?php /*a:2:{s:62:"D:\php-work-2018\EasyAdmin\cqkyicms\admin\view\menu\index.html";i:1525803947;s:63:"D:\php-work-2018\EasyAdmin\cqkyicms\admin\view\index\index.html";i:1525804571;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <a class="btn btn-success btn-icon btn-sm" href="<?php echo url('menu/add',array('id'=>0)); ?>" rel="add" >
            <i class="md  md-add"></i>
            <span>添加系统菜单</span>
        </a>
                ...
                .bootstrapTreeTable(
                        {
                            ...
                            url: "<?php echo url('menu/menulist'); ?>", // 请求数据的ajax的url
                            ...
                            columns: [
                                ...
                                },
                                {
                                    ...
                                    formatter: function (item, index) {
                                        ...
                                        var addother = "<?php echo url('menu/add',array('id'=>'p_id')); ?>";
                                        var editother = "<?php echo url('menu/edit',array('id'=>'p_id')); ?>";
                                        var delother = "<?php echo url('menu/del',array('id'=>'p_id')); ?>";
