<?php /*a:2:{s:66:"D:\php-work-2018\EasyAdmin\cqkyicms\admin\view\goodcate\index.html";i:1526176034;s:63:"D:\php-work-2018\EasyAdmin\cqkyicms\admin\view\index\index.html";i:1525804571;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <a class="btn btn-success btn-icon btn-sm" href="<?php echo url('goodcate/add',array('id'=>0)); ?>" rel="add" >
            <i class="md  md-add"></i>
                ...
                .bootstrapTreeTable(
                        {
                            ...
                            url: "<?php echo url('goodcate/catelist'); ?>", // 请求数据的ajax的url
                            ...
                            columns: [
                                ...
                                },
                                {
                                    ...
                                    formatter: function (item, index) {
                                        ...
                                        var addother = "<?php echo url('goodcate/add',array('id'=>'p_id')); ?>";
                                        var editother = "<?php echo url('goodcate/edit',array('id'=>'p_id')); ?>";
                                      //  var delother = "<?php echo url('goodcate/del',array('id'=>'p_id')); ?>";
