<?php /*a:2:{s:62:"D:\php-work-2018\EasyAdmin\cqkyicms\admin\view\good\index.html";i:1527218277;s:63:"D:\php-work-2018\EasyAdmin\cqkyicms\admin\view\index\index.html";i:1525804571;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="inbox-widget nicescroll mx-box" tabindex="5000" style="overflow: hidden; outline: none;">
                        ...
                        <a class="btn btn-success btn-icon btn-sm" href="<?php echo url('good/add'); ?>" >
                            <i class="md  md-add"></i>
                        ...
                        <div class="columns pull-right col-md-1 nopadding">
                            <select class="select2 form-control">
                                <option>请选择分类</option>
                                 <?php foreach($goodcate as $item): ?>
                                <option value="<?php echo htmlentities($item['cate_id']); ?>"><?php echo htmlentities($item['cate_name']); ?></option>
                                <?php endforeach; ?>
                            </select>
                ...
                .bootstrapTable(
                        {
                            ...
                            url: "<?php echo url('good/index'); ?>", //获取数据的地址
                            striped: true,  //表格显示条纹
