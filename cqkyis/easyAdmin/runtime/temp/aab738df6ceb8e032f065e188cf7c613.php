<?php /*a:1:{s:56:"E:\kyweixin\EasyAdmin\cqkyicms\admin\view\menu\icon.html";i:1525788890;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="panel-body">
                ...
                <section>
                    ...
                    <div class="clearfix icon-list">
                        ...
                        <i class="md md-satellite"></i>
                        <i class="md md-store-mall-directory"></i>
                        <i class="md md-terrain"></i>
                        <i class="md md-traffic"></i>
                    </div>
                </section>
                <section>
                    ...
                    <div class="clearfix icon-list">
                        ...
                        <i class="md md-arrow-drop-down-circle"></i>
                ...
                <section>
                    ...
                    <div class="clearfix icon-list">
                        <i class="md md-adb"></i>
                        <i class="md md-bluetooth-audio"></i>
                        <i class="md md-disc-full"></i>
                        <i class="md md-dnd-forwardslash"></i>
                        <i class="md md-do-not-disturb"></i>
                        <i class="md md-drive-eta"></i>
                        <i class="md md-event-available"></i>
                        <i class="md md-event-busy"></i>
                        <i class="md md-event-note"></i>
                        <i class="md md-folder-special"></i>
                        <i class="md md-mms"></i>
                        <i class="md md-more"></i>
                        <i class="md md-network-locked"></i>
                        <i class="md md-phone-bluetooth-speaker"></i>
                        <i class="md md-phone-forwarded"></i>
                        <i class="md md-phone-in-talk"></i>
                        <i class="md md-phone-locked"></i>
                        <i class="md md-phone-missed"></i>
                        <i class="md md-phone-paused"></i>
                        <i class="md md-play-download"></i>
                        <i class="md md-play-install"></i>
                        <i class="md md-sd-card"></i>
                        <i class="md md-sim-card-alert"></i>
                        <i class="md md-sms"></i>
                        <i class="md md-sms-failed"></i>
                        <i class="md md-sync"></i>
                        <i class="md md-sync-disabled"></i>
                        <i class="md md-sync-problem"></i>
                        <i class="md md-system-update"></i>
                        <i class="md md-tap-and-play"></i>
                        <i class="md md-time-to-leave"></i>
                        <i class="md md-vibration"></i>
                        <i class="md md-voice-chat"></i>
                        <i class="md md-vpn-lock"></i>
                    </div>
                </section>
                <section>

                    <div class="clearfix icon-list">
                        <i class="md md-cake"></i>
                        <i class="md md-domain"></i>
                        <i class="md md-location-city"></i>
                        <i class="md md-mood"></i>
                        <i class="md md-notifications-none"></i>
                        <i class="md md-notifications"></i>
                        <i class="md md-notifications-off"></i>
                        <i class="md md-notifications-on"></i>
                        <i class="md md-notifications-paused"></i>
                        <i class="md md-pages"></i>
                        <i class="md md-party-mode"></i>
                        ...
                        <i class="md md-plus-one"></i>
                        <i class="md md-poll"></i>
                        <i class="md md-public"></i>
                        <i class="md md-school"></i>
                        <i class="md md-share"></i>
                        <i class="md md-whatshot"></i>
                    </div>
                </section>
                <section>
                    ...
                    <div class="clearfix icon-list">
                        ...
                        <i class="md md-radio-button-off"></i>
...
<script>
    ...
    $(".icon-list").find("i").click(function () {
        var icon=$(this).attr('class');

        //parent.layer.msg('您选择了 [ ' +icon + ' ] 图标！');
        parent.$('#icons').val(icon);
        parent.$('#fas').removeClass();
        parent.$('#fas').addClass(icon);
        //parent.$('#iconimg').attr('class',icon);
