...
class zPage{
	...
	function __construct($sql = null,$count_field = "*",$db,$use_ado_recordcount = false,$page_num=null)
	{
		...
		$this->page_html_schema["body"] = '<style>#page_menu a:hover{color: #3cb878 !important;}</style><div class="btn-group" style="float:right;" id="page_menu">%s</div>';
		$this->page_html_schema["count_all"] = '<a class="btn btn-default btn-outline btn-xs" href="javascrip:voild()" style="border:0">%s</a>';
		$this->page_html_schema["page_button"] = '<a class="btn btn-default btn-outline btn-xs" style="border:0" href="%s">%s</a>';
		$this->page_html_schema["edge_button_on"] = '<a class="btn btn-default btn-outline btn-xs" style="border:0" href="%s">%s</a>';
		$this->page_html_schema["edge_button_off"] = '<a class="btn btn-default btn-outline btn-xs" style="border:0" href="%s">%s</a>';
		$this->page_html_schema["on_this_page"] = '<a class="btn btn-success btn-xs" style="border:0">%d</a>';
	...
	function getPageMenu()
	{
	   ...
	   if (!$this->GVar->fget['page']) $this->GVar->fget['page']=1;
		...
		$obj_element = str_replace('href=""','href="javascript:voild()"',$obj_element);
