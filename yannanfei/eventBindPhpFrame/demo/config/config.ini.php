<?php
$config=array();
$local_server='localhost:63342';
$config['app_site_url']='http://'.$local_server.'/demo';  //app模块url
$config['image_site_url']='http://'.$local_server.'/demo/resource/common/images'; //图片文件url
$config['resource_site_url']='http://'.$local_server.'/demo/resource'; //资源文件url
