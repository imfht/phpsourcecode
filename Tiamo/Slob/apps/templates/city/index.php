<form id='pagerForm' method='post' action='<?= URL('city/index'); ?>'>
...
<div class='pageContent'>
    <div class='panelBar'>
        <ul class='toolBar'>
            <li><a class='add' href='<?= URL('city/addcity'); ?>' target='navTab' rel='addcity'><span>添加</span></a></li>
            <li><a class='edit' href='<?= URL('city/updatecity'); ?>?id={list_id}' target='navTab'
                   rel='updatecity'><span>修改</span></a></li>
            <li><a class='delete' href='<?= URL('city/deletecity'); ?>?id={list_id}' target='ajaxTodo'
