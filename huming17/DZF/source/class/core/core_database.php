...
class core_database {
	...
	public static function query($sql, $arg = array(), $silent = false, $unbuffered = false, $multi_query='') {
		if (!empty($arg)) {
			if (is_array($arg)) {
		...
		$ret = self::$db->query($sql, $silent, $unbuffered, $multi_query);
		if (!$unbuffered && $ret) {
	...
	public static function checkquery($sql) {
		return core_database_safecheck::checkquery($sql);
	}
