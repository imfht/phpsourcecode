...
function show_footer($quit = true) {
	...
	echo <<<EOT
		<div class="footer">&copy;2001 - 2019</div>
	</div>
</div>
</body>
</html>
...
function install_uc_server() {
	...
	$db->query("INSERT INTO {$uctablepre}applications SET name='DZ! Framework UC', url='$appurl', ip='$ucip', authkey='$appauthkey', synlogin='1', charset='$charset', dbcharset='$dbcharset', type='DISCUZX', recvnote='1', tagtemplates='$apptagtemplates'", $link);
