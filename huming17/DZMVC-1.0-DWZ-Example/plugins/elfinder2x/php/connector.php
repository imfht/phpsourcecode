...
if(empty($_G['user_id']) && $_G['login_user_menu'][1]['submenu'][5]['submenu'][34]['submenu'][36]['submenu'][1009]['menu_id']==1009){
 //DEBUG 无操作权限
 die();
}
...
function logger($cmd, $result, $args, $elfinder) {
	...
	$logfile = '../../../data/upload/temp/log.txt';
	$dir = dirname($logfile);
...
$logger = new elFinderSimpleLogger('../../../data/upload/temp/log.txt');
...
$opts = array(
	...
	'roots' => array(
		array(
			...
			'path'       => '../../../data/upload/',
			'startPath'  => '../../../data/upload/',
			'URL'        => dirname($_SERVER['PHP_SELF']) . '/../../../data/upload/',
			// 'treeDeep'   => 3,
			// 'alias'      => 'File system',
			'mimeDetect' => 'internal',
			'tmbPath'    => '.tmb',
