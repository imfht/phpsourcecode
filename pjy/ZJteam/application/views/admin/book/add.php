...
<form name="content" action="<?php echo site_url('admin/addBook');?>" method="post" enctype="multipart/form-data">
<table cellpadding="0" cellspacing="1" class="table_form">
 ...
 <tr>
  ...
  <td>
   <input name="donator" type="text" size="40">
   <span class="blue"><span class="red">*</span>请输入捐赠者名字</span>
  </td>
 </tr> 
 <tr>
  <td align="right">捐赠数量：</td>
  <td>
   <input name="num" type="text" size="40">
   <span class="blue"><span class="red">*</span>请输入捐赠数量</span>
  </td>
 </tr> 
 <tr>
  <td align="right"><span>封面图片：</span></td>
  <td><input type="file" name="pic" id="file0" multiple="multiple" /><br><img src="" id="img0" width="208" height="118">&nbsp;请上传jpg格式的图片
  </td>
  <script>	
 ...
 <tr>
  <td align="right"><span class="fred">*</span> 书籍详情：</td>
