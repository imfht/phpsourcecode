...
<form name="content" action="<?php echo site_url('admin/updBook');?>" method="post" enctype="multipart/form-data">
...
<table cellpadding="0" cellspacing="1" class="table_form">
 ...
 <tr>
  ...
  <td>
   <input name="donator" value="<?php echo $detail->donator;?>" id="donator" type="text" size="30" maxlength="100"> </td>
 </tr> 
 <tr>
  <td align="right">捐赠数量</td>
  <td>
   <input name="num" value="<?php echo $detail->num;?>" id="num" type="text" size="30" maxlength="30"> 
</td>
 </tr>
 <tr>
  <td align="right"><span>修改封面图</span></td>
  <td><input type="file" name="pic" id="file0" multiple="multiple" /><br><img src="<?php echo base_url().$detail->pic;?>" id="img0" width="208" height="118">
  </td>
  <script>	
 ...
 <tr>
  <td align="right"><span class="fred">*</span> 书籍内容：</td>
<td>
