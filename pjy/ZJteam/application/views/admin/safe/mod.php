...
<form name="content" action="<?php echo site_url('admin/updsafe');?>" method="post" enctype="multipart/form-data">
<input type="hidden" name="id" value="<?php echo $safe->id;?>"/>
<table cellpadding="0" cellspacing="1" class="table_form">
 <caption>修改文章</caption>
 <tr>
  <td align="right"> 标 题</td>
  <td>
   <input name="title"  type="text" value="<?php echo $safe->title;?>" size="40" require="true" datatype="require"/>
  </td>
 </tr>
   <tr>
 <tr>
...
<td>
  <textarea id="editor" name="editor" style="width:100%;height:100%;"><?php echo $safe->content;?></textarea>
  </td></tr>
