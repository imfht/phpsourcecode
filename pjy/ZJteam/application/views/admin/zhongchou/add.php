...
<form name="content" action="<?php echo site_url('admin/addZc');?>" method="post" enctype="multipart/form-data">
<table cellpadding="0" cellspacing="1" class="table_form">
 <caption>添加众筹</caption>
 <tr>
 ...
 <tr>
  ...
  <td>
   <input name="money" type="text" size="40">
  </td>
 </tr> 
 <tr>
  <td align="right">众筹时间：</td>
  <td>
   <input name="zctime" id="author" type="text" size="30" maxlength="30"> 
  </td>
 </tr> 
 <tr>
