  ...
  <form method="post" action=""/> 
    ...
    <caption>文章管理</caption>
      ...
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><?php echo $yougan['title'];?></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><?php echo $yougan['addtime'];?></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center">
        <a class="blues" href="<?php echo site_url('admin/youganMod/'.$yougan['id']);?>">修改</a> |
        <a class="blues" onclick="return confirm('确定要删除该文章吗?')" href="<?php echo site_url('admin/delyougan/'.$yougan['id']);?>"> 删除</a></div></
        </div></td>
      </tr>
      <?php endforeach;?>
      <tr>
