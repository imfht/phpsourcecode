...
<div class="main_info clearfix">
  ...
  <div class="main_left"> 
   <div class="mod list clearfix" id="recommend_list_wrap"> 
    <h2 class="main_h2"><span class="bd"></span>支教有感</h2> 
    <ul class="recomment_ul clearfix"> 
	
	  <!--循环开始-->
	  <?php foreach($youganlist as $youganlist):?>
		<a target="_blank" href="<?php echo site_url("home/yougandetail/".$youganlist['id']);?>"><li class="lili"><?php echo $youganlist['title'];?><span style="float:right;"><?php echo $youganlist['addtime'];?></span></li></a>
	<?php endforeach;?>
      <!--循环结束-->
    </ul> 
   </div> 
   <?php echo $page;?>
	<div style="width:200px;height:50px;margin:10px auto;text-align:center;font-size:20px;">共&nbsp;&nbsp;<span style="color:#ef8376"><?php echo $count?></span>&nbsp;&nbsp;篇感想</div>
