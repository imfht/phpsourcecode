  ...
  <div class="main_left"> 
   <div class="mod list clearfix" id="recommend_list_wrap"> 
    ...
    <ul class="recomment_ul clearfix"> 
	  ...
	  <!--循环开始-->
	  <?php foreach($zhijiaolist as $zhijiaolist):?>
     <li class="recomment_li" style="margin-top:20px;"> <a href="<?php echo site_url("home/zjdetail/".$zhijiaolist['id']);?>"><img height="180px" src="<?php echo base_url().$zhijiaolist['pic'];?>" class="recommend-focus"/></a> 
		  <div class="recommend_wrap">
		   <span class="icon2">支教活动</span>
		   <h3><a href="<?php echo site_url("home/zjdetail/".$zhijiaolist['id']);?>"><?php echo $zhijiaolist['title'];?></a></h3>
		  </div> 
		  <div class="donate_infor clearfix"> 
		   <p class="donate_content"> 活动时间：<span class="m_num"><?php echo $zhijiaolist['duringtime'];?></span><br /> 
		   支教地址: <span><?php echo $zhijiaolist['address'];?></span> </p> 
		   <?php if($zhijiaolist['status']==0){echo '<a href="javascript:void(0)" class="donate_btn">报名中</a> ';}elseif($zhijiaolist['status']==1){echo '<a href="javascript:void(0)" class="donate_btn2">活动进行中</a> ';}elseif($zhijiaolist['status']==2){echo '<a href="javascript:void(0)" class="donate_btn3">已结束</a> ';}?>
		  </div> 
	  </li> 
		<?php endforeach;?>
      <!--循环结束-->
   ...
   <?php echo $page;?>
   <div style="width:200px;height:50px;margin:10px auto;text-align:center;font-size:20px;">共&nbsp;&nbsp;<span style="color:#ef8376"><?php echo $count?></span>&nbsp;&nbsp;个活动</div>
