...
<div class="main_info clearfix">
  ...
  <div class="main_left"> 
   <div class="mod list clearfix" id="recommend_list_wrap"> 
    <h2 class="main_h2"><span class="bd"></span>爱心众筹 > <?php echo $zhongchou->title;?></h2> 
	<div class="article">
	<?php if($zhongchou->status==0){?>
	<a target="_blank" href="<?php echo $zhongchou->url;?>"><div style="width:100px;height:30px;background-color:#ff6c00;color:#fff;border-radius:5px;text-align:center;line-height:30px;margin:0 auto;">我要捐款</div></a><br><hr>
    <?php }else{?>
	<div style="width:100px;height:30px;background-color:#999999;color:#fff;border-radius:5px;text-align:center;line-height:30px;margin:0 auto;">已结束</div>
	<?php }?>
