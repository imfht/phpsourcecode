...
<div class="main_info clearfix">
  ...
  <div class="main_left"> 
   <div class="mod list clearfix" id="recommend_list_wrap"> 
    <h2 class="main_h2"><span class="bd"></span>保险基金</h2> 
    <ul class="recomment_ul clearfix"> 
	
	  <!--循环开始-->
	  <?php foreach($safelist as $safelist):?>
		<a target="_blank" href="<?php echo site_url("home/safedetail/".$safelist['id']);?>"><li class="lili"><?php echo $safelist['title'];?><span style="float:right;"><?php echo $safelist['addtime'];?></span></li></a>
		<?php endforeach;?>
      <!--循环结束-->
    </ul> 
   </div> 
   <?php echo $page;?>
	<div style="width:200px;height:50px;margin:10px auto;text-align:center;font-size:20px;">共&nbsp;&nbsp;<span style="color:#ef8376"><?php echo $count?></span>&nbsp;&nbsp;篇文章</div>
