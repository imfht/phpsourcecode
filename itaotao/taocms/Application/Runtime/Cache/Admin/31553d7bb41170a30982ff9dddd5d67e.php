    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form  id="add_menu" method="post" class="form-horizontal" action="#">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">上级菜单
										<span class="required">
											 *
										</span>
                            </label>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">规则表达式
                            </label>
                            <div class="col-md-4">
...
<script src="/tp3.2/Public/Admin/js/menu-validation.js" ></script>
