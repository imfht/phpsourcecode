...
class pt extends PT_Base
{
    ...
    protected function init()
    {
        ...
        // 注册插件
        $this->plugin->register($this->config->get('plugin', []));
    }
    ...
    public static function autoload($class)
    {
        ...
        if (is_file(PT_PATH . '/' . $classfile . '.php')) {
            ...
            if (isset($GLOBALS['_automap']['model'][$classfile])) {
                //存在这个model
                if (defined('MODULE_NAME') && isset($GLOBALS['_automap']['model'][$classfile][MODULE_NAME])) {
            ...
            if (isset($GLOBALS['_automap']['block'][$classfile])) {
                //存在这个block
                if (defined('MODULE_NAME') && isset($GLOBALS['_automap']['block'][$classfile][MODULE_NAME])) {
            ...
            if (!pt::import(PT_PATH . '/library/' . $classfile . '.php') && isset($GLOBALS['_automap']['library'][$classfile])) {
                if (defined('MODULE_NAME') && isset($GLOBALS['_automap']['library'][$classfile][MODULE_NAME])) {
