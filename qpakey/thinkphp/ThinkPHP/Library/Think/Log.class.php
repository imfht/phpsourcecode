...
class Log {
    ...
    static public function init($config=array()){
        ...
        $class  =   strpos($type,'_')? $type: 'Think_Log_Driver_'. ucwords(strtolower($type));           
        unset($config['type']);
    ...
    static public function save($type='',$destination='') {
        ...
        if(!self::$storage){
            ...
            $class  =   'Think_Log_Driver_'. ucwords($type);
