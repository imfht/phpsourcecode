    ...
    o.prototype.load = function (e) {
        ...
        if (f[0]) {
            var m = l(e.scrollElem || document), u = e.mb || 50, s = !("isAuto" in e) || e.isAuto, v = e.end || "没有更多了",
                ...
                h = l('<div class="layui-flow-more layui-row message-content-btn"><a href="javascript:;" class="layui-btn">' + d + "</a></div>");
            f.find(".layui-flow-more layui-row message-content-btn")[0] || f.append(h);
            var p = function (e, t) {
