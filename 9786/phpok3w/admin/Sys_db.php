...
当前数据库大小为：<span class="STYLE1"><?php
=Round(DbSize("../" & SysSiteDbPath) / 1024 / 1024,2)
?></span>M				
<br>
<br>
...
Fname = "backup/#db" & Year(Date()) & Month(Date()) & Day(Date()) & Hour(Time()) & Minute(Time()) & Second(Time()) & ".php"
