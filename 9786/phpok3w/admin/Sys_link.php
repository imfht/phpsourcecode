                        ...
                        <tr bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#EFEFEF';" onMouseOut="this.style.backgroundColor='#FFFFFF';">
                          ...
                          <td><input name="Ctype" type="radio" value="1" checked>
                            新闻
                              ...
                              软件</td>
                          <td><input name="Lorder" type="text" id="Lorder" value="<?php
=Link.GetMaxOrder()+1
?>" size="2" /></td>
...
?>						<form name="form2" method="post" action="">
                        <tr bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#EFEFEF';" onMouseOut="this.style.backgroundColor='#FFFFFF';">
                          <td><input name="Lname" type="text" id="Lname" value="<?php
=Rs("Lname")
?>" size="15" /></td>
                          <td><input name="Lurl" type="text" id="Lurl" value="<?php
=Rs("Lurl")
?>" size="20" /></td>
                          <td><input name="Lpic" type="text" id="Lpic" value="<?php
=Rs("Lpic")
?>" size="20" /></td>
                          <td><input name="Ltype" type="checkbox" id="Ltype" value="1" <?php
If Rs("Ltype")=1 Then
?>checked<?php
End If
?>>启用</td>
                          <td><input name="Ctype" type="radio" value="1" <?php
If Rs("Ctype")=1 Then
?>checked<?php
End If
?>>
新闻
  <input type="radio" name="Ctype" value="2" <?php
If Rs("Ctype")=2 Then
?>checked<?php
End If
?>>
...
=Rs("Lorder")
?>" size="2" /></td>
                          <td><input name="Lnote" type="hidden" id="Lnote" value="<?php
=Rs("Lnote")
?>">
                            <input name="Lid" type="hidden" id="Lid" value="<?php
=Rs("Lid")
?>" />
                            <input name="action" type="hidden" id="action" />
