...
=Rs("logType")
?></td>
                          <td height="25" align="center" bgcolor="#FFFFFF"><input name="logId" type="checkbox" id="logId" value="<?php
=Rs("logId")
?>" /></td>
                        </tr>
                        <?php
...
?>
                        ...
                        <tr>
                          <td height="25" colspan="7" align="right" bgcolor="#FFFFFF"><?php
