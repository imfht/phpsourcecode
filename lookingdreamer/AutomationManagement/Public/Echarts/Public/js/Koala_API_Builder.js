...
//	 */
    ...
    ApiBuilder.prototype = {
        ...
        /*左边建造一颗树*/, buildTree: function ($container, treeData) {
            var dataSourceTree = {
                data: treeData,
                delay: 400
            };
        ...
        /*建造树*/, buildGrid: function ($el, columns, gridDatas) {
            $el.empty();
            ...
            $el.grid({
                ...
                localData: gridDatas, isShowIndexCol: false, isShowPages: false
                //,lockWidth: true
            });

        }

        /*从原始的表格数据里获取到字段列表*/, buildGridColumns: function (gridDatas) {
        ...
        /*把原始的api data转换为树所需要的格式*/, parse: function (apiData) {
            if (!apiData) return;
