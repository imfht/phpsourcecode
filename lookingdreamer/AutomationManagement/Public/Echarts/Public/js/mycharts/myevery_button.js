$(document)
    ...
    function () {
        ...
        function unix_to_datetime(unix) {
            ...
            return now.toLocaleString().replace(/年|月/g, "-")
                .replace(/日/g, " ");
        }
        ...
        $("#btn_loading")
            ...
            function () {
                var depart = document
                    .getElementById("trans_value").value;
                // 定义最小日期
                var startDate = "2014-09-03 00:00:00";
                var getdate = document
                    .getElementById("getdateval").value;
                ...
                if (rex.test(depart) == false) {
                    ...
                    if (unix_end < unix_start) {
                        ...
                        $('#theme-select').remove();
                        document
                            .getElementById("open_close").style.marginLeft = "0px";
