...
(function (e) {
    ...
    (function (e) {
        ...
        var t = e("./config"), n = e("./tool/util"), r = e("./tool/log"), i = e("./tool/matrix"), s = e("./loadingEffect/Base"), o = window.devicePixelRatio || 1;
        o = Math.max(o, 1);
        ...
        i.version = "2.0.2", i.dependencies = {zrender: "2.0.2"}, i.init = function (t, n) {
            var r = e("zrender");
        ...
        return y.prototype = {constructor: y, type: o.CHART_TYPE_FORCE, _init: function () {
            var e = this;
            ...
            var w = b.max();
            if (w === 0)return;
            var E = b.mul(1 / w, b).toArray(), x = new h(i * 2);
            for (var m = 0; m < i; m++) {
                var T, y = t[m];
            ...
            this._layoutWorker ? (this._token = g(), this._layoutWorker.postMessage({cmd: "init", nodesPosition: x, nodesMass: E, nodesSize: v, edges: C, edgesWeight: k, token: this._token}), this._layoutWorker.postMessage({cmd: "updateConfig", config: A})) : (a.merge(this._layout, A, !0), this._layout.initNodes(x, E, v), this._layout.initEdges(C, k))
