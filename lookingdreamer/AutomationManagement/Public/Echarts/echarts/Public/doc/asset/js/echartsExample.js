...
if (developMode) {
    ...
    var next_string = '/doc/example/www/js/echarts';
    var file_base_url = echart_base_url.concat(next_string);
    var fileLocation = needMap() ? './www/js/echarts-map' : file_base_url;
    require.config({
        paths: {
