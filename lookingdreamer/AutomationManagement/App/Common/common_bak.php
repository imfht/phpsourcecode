...
function get_spider_bot($useragent = '') { // 蜘蛛
	$spider = "";
	if (! $useragent) {
...
function  model_trans_cn($modelname){
	$model_string=array();
	switch ($modelname){
		case "ServerDetail":
			$model_string["main_title"]="主机管理";
			$model_string["next_title"]="com & 环境";
			$model_string["main_table_title"]="生产环境服务器信息管理";
            ...
            $model_string["select_array"]=array('status'=>array('1'=>'启用','0'=>'关闭'),'depart_name'=>array('0'=>'『 基础分区 』',
                '1'=>'『 一分区 』', '2'=>'『 二分区 』', '3'=>'『 三分区 』', '4'=>'『 四分区 』', '5'=>'『 五分区 』',
                '6'=>'『 六分区 』','B2C'=>'『 B2C 』'));
            return $model_string;
			exit;
			break;
        case "HostZzb":
			...
			$model_string["main_table_title"]="准生产环境服务器信息管理";
            ...
            $model_string["select_array"]=array('status'=>array('1'=>'启用','0'=>'关闭'),'depart_name'=>array('0'=>'『 基础分区 』','3'=>'『 三区 』');
            return $model_string;
			exit;
			break;
	}
