    ...
    <div class="panel panel-archon">
        ...
        <div class="panel-body" style="padding-top: 1px">
            <table class="table table-hover">
                ...
                <tbody>
                <?php foreach ($list as $vo){ if($vo['id']){ echo "<tr>"; echo "<td class='notallow td_center'>"; echo "<input type='checkbox' value=".$vo['app_key']." class='style checkboxrow'/>"; echo "</td>"; echo "<td class='visible-lg td_center'>".$vo['id']."</td>"; foreach ($table_tr as $trname){ if($trname != "id"){ if ( $trname == "app_key" ){ echo "<td class='visible-lg td_center'><a href='http://192.168.4.50:5000/check/?key=".$vo["$trname"]."' target='_blank'>".$vo["$trname"]." </a></td>"; }else{ echo "<td class='visible-lg td_center'>".$vo["$trname"]."</td>"; } } } $edit_url=C('RexServer')."/service/?"."key=".$vo['app_key']; $start_url=C('RexServer')."/service/?"."key=".$vo['app_key']."&action=start"; $stop_url=C('RexServer')."/service/?"."key=".$vo['app_key']."&action=stop"; $restart_url=C('RexServer')."/service/?"."key=".$vo['app_key']."&action=restart"; $key=$vo['app_key']; echo "<td style=' margin:0 auto;padding:0;clear:both;'>"; echo "<div style='margin:0; padding:0;  display:inline-block; _display:inline; *display:inline;zoom:1;  ''>"; echo "<input  type='button'    server=".$key." cmd='start' class='dialog-service btn btn-small btn-primary' value='启动'>"; echo " "; echo "<input  type='button'    server=".$key." cmd='stop' class='dialog-service btn btn-small btn-primary' value='停止'>"; echo "</div>"; echo " "; echo "<input  type='button'    server=".$key." cmd='restart' class='dialog-service btn btn-small btn-primary' value='重启'>"; echo "</div>"; echo "<div style='margin:0; padding:0;  display:inline-block; _display:inline; *display:inline;zoom:1; '>"; echo "</div>"; echo "</td>"; echo "</tr>"; } }?>
