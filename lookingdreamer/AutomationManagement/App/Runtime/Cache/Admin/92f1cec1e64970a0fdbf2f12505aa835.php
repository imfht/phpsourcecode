...
<div class="col-md-12">
    ...
    <div class="panel panel-archon">
        ...
        <div class="buttons-demo tb_title" style="height: 40px; margin-top: 1px;">
            ...
            <a href="<?php echo U('Admin/AddModule/createtb');?>" class="btn btn-hg btn-info">
                构建数据表
            </a>
        ...
        <div class="panel-body" style="padding-top: 1px">
            <table class="table table-hover">
                ...
                <tbody>
                <?php foreach ($list as $vo){ if($vo['id']){ echo "<tr>"; echo "<td class='notallow td_center'>"; echo "<input type='checkbox' value=".$vo['id']." class='style checkboxrow'/>"; echo "</td>"; echo "<td class='visible-lg td_center'>".$vo['id']."</td>"; foreach ($table_tr as $trname){ if($trname != "id"){ if($trname == "model_name" ){ $Modulename=ucwords($vo["$trname"]); $names="Admin/".$Modulename."/index"; $jumpurl=U($names); echo "<td class='visible-lg td_center'><a href='$jumpurl'  title='打开模块'>".$vo["$trname"]."</a></td>"; }else{ echo "<td class='visible-lg td_center'>".$vo["$trname"]."</td>"; } } } $edit_url=$edit_link."?"."id=".$vo['id']; echo "<td style=' margin:0 auto;padding:0;clear:both;'>"; echo "<div style='margin:0; padding:0;  display:inline-block; _display:inline; *display:inline;zoom:1;  ''>"; $build_url=U('Admin/AddModule/buildmodel',array('id'=>$vo['id']),'','',true); echo "<a href=".$build_url." class='btn btn-small btn-primary'>"; echo "构建模块"; echo "</a>"; echo "</div>"; echo "<div style='margin:0; padding:0;  display:inline-block; _display:inline; *display:inline;zoom:1; '>"; echo "</div>"; echo "</td>"; echo "</tr>"; } }?>
