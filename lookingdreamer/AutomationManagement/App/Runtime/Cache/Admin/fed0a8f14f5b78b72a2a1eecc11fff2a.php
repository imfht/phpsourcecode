...
<div class="col-md-12">
    ...
    <div class="panel panel-archon">
        ...
        <div class="buttons-demo tb_title" style="height: 40px; margin-top: 1px;">
            ...
            <a href="<?php echo U('Admin/Tbmanage/updatetb');?>"
               class="btn btn-hg btn-info ">
                <i class="icon-upload"></i>
                更新数据
            </a>
