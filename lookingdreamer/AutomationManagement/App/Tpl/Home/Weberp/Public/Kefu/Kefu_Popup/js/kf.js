...
if(kfguin)
{
  rightDivHtml = '<div id="rightDiv" style="position:absolute; z-index:10000; top:160px; right:1px;">';
...
{
	window.open('tencent://message/?uin='+kfguin+'&amp;Site=&amp;Menu=yes', '_self', 'height=544, width=644,toolbar=no,scrollbars=no,menubar=no,status=no');
	if(flag==1)
	{
		kf_hidekfpopup();
	}
