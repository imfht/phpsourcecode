...
// 		$end_date = I ( 'end_date', '2014-08-06 21:30:00', 'htmlspecialchars' );
		// $end_date=$this->_param('end_date',date('Y-m-d H:i:s'),'htmlspecialchars');//默认取当前时间
		...
		// 打印图表
		$receive = array (
				'title' => $this->_param ( 'title','htmlspecialchars', $title  .'['. $Getdate . ']' . '  总量: ' . $total ), // 'htmlspecialchars'实体化为字符串,防止攻击等
				'unit' => $this->_param ( 'unit', 'htmlspecialchars',$unit),
				'type' => $this->_param ( 'type', 'htmlspecialchars','line' ),
...
// 		$end_date = I ( 'end_date', '2014-08-10 21:30:00', 'htmlspecialchars' );
	...
	public function show_all_ins_multi_quote() {
		$time = $this->_param( 'end_date', 'htmlspecialchars', '2014-08-06 21:30:00' );
	...
	//日图表 、 动态输出图表模版
	 public  function  echartofday(){
	 	...
	 	$time = $this->_param ( 'end_date', 'htmlspecialchars', date('Y-m-d H:i:s') );
	 	//默认是对五区的初审变量赋值
	 	$tb=$this->_param ('tb', 'htmlspecialchars','yunwei_data_part_five');
	 	$maintitle=$this->_param ('maintitle', 'htmlspecialchars','[生产五区]');
...
// 	 	$receive = $this->show_ins_multi_quote ( $time );
	 	...
	 	//初审--start
	 	$str=$this->_param('str', 'htmlspecialchars','verify');
	 	$title=$this->_param('title', 'htmlspecialchars',$maintitle.' 每天初审表');
	 	$unit=$this->_param('unit', 'htmlspecialchars','已经初审数量');
	 	$receive = R('Show/show_ins_multi_quote',array($time,$tb,$db='DB_COLLECT',$str,$order_str='time',$title,$unit));  //初审
		//报价--start
	 	$str=$this->_param('str', 'htmlspecialchars','quote');
	 	$title=$this->_param('title', 'htmlspecialchars',$maintitle.' 每天报价表');
	 	$unit=$this->_param('unit', 'htmlspecialchars','已经报价数量');
	 	$quote = R('Show/show_ins_multi_quote',array($time,$tb,$db='DB_COLLECT',$str,$order_str='time',$title,$unit));
	 	$this->receive_every=$quote;
	 	//报价--end
	 	//核保-start
	 	$str=$this->_param('str', 'htmlspecialchars','insure');
	 	$title=$this->_param('title', 'htmlspecialchars',$maintitle.' 每天核保表');
	 	$unit=$this->_param('unit', 'htmlspecialchars','已经核保数量');
	 	$insure = R('Show/show_ins_multi_quote',array($time,$tb,$db='DB_COLLECT',$str,$order_str='time',$title,$unit));
	 	$this->receive_month=$insure;
	 	//核保--end
	 	//支付--start
	 	$str=$this->_param('str', 'htmlspecialchars','pay');
	 	$title=$this->_param('title', 'htmlspecialchars',$maintitle.' 每天支付表');
	 	$unit=$this->_param('unit', 'htmlspecialchars','已经支付数量');
...
// 	 	$this->display ( 'show_day_charts' );
	 ...
	 public  function  echartofweek(){
	 	...
	 	$str=$this->_param('str', 'htmlspecialchars','verify');
	 	$maintitle=$this->_param('maintitle', 'htmlspecialchars','[生产五区]');
	 	$title=$this->_param('title', 'htmlspecialchars', $maintitle.' 每周初审表');
	 	$unit=$this->_param('unit', 'htmlspecialchars','已经初审数量');
	 	// 	 	$receive = $this->show_ins_multi_quote ( $time );
	 	$url=U('Admin/Show/echartofday','','','',true);
	 	$weekurl=U('Admin/Show/echartofweek','','','',true);
	 	...
	 	//报价--start
	 	$str=$this->_param('str', 'htmlspecialchars','quote');
	 	$title=$this->_param('title', 'htmlspecialchars',$maintitle.' 每周报价表');
	 	$unit=$this->_param('unit', 'htmlspecialchars','已经报价数量');
	 	...
	 	//核保-start
	 	$str=$this->_param('str', 'htmlspecialchars','insure');
	 	$title=$this->_param('title', 'htmlspecialchars',$maintitle.' 每周核保表');
	 	$unit=$this->_param('unit', 'htmlspecialchars','已经核保数量');
	 	...
	 	//支付--start
	 	$str=$this->_param('str', 'htmlspecialchars','pay');
	 	$title=$this->_param('title', 'htmlspecialchars',$maintitle.' 每周支付表');
	 	$unit=$this->_param('unit', 'htmlspecialchars','已经支付数量');
...
// 	 	$this->display ( 'show_week_charts' );
	 ...
	 public  function  echartofmonth(){
	 	...
	 	$str=$this->_param('str', 'htmlspecialchars','verify');
	 	$maintitle=$this->_param('maintitle', 'htmlspecialchars','[生产五区]');
	 	$title=$this->_param('title', 'htmlspecialchars',$maintitle.' 每月初审表');
	 	// 	 	$receive = $this->show_ins_multi_quote ( $time );
	 	$url=U('Admin/Show/echartofday','','','',true);
	 	$weekurl=U('Admin/Show/echartofweek','','','',true);
	 	$monthurl=U('Admin/Show/echartofmonth','','','',true);
	 	...
	 	//报价--start
	 	$str=$this->_param('str', 'htmlspecialchars','quote');
	 	$title=$this->_param('title', 'htmlspecialchars',$maintitle.' 每月报价表');
	 	$unit=$this->_param('unit', 'htmlspecialchars','已经报价数量');
	 	...
	 	//核保-start
	 	$str=$this->_param('str', 'htmlspecialchars','insure');
	 	$title=$this->_param('title', 'htmlspecialchars',$maintitle.' 每月核保表');
	 	$unit=$this->_param('unit', 'htmlspecialchars','已经核保数量');
	 	...
	 	//支付--start
	 	$str=$this->_param('str', 'htmlspecialchars','pay');
	 	$title=$this->_param('title', 'htmlspecialchars',$maintitle.' 每月支付表');
	 	$unit=$this->_param('unit', 'htmlspecialchars','已经支付数量');
