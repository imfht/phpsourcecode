...
class MysqlManageAction extends CommonAction {
	...
	public function  import(){
		// 查询该表的字段和注释的值
		$tb=$this->_param('importb','htmlspecialchars','mysql_manage');
		$Info = M ( "columns", "", "DB_INFO" );
		$map ['table_name'] = C ( 'DB_PREFIX' ) . $tb;
