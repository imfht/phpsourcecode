...
class Tag_model extends CI_Model {
	...
	*/
	...
	function addtag($tagname,$tagalias,$title,$description,$keywords,$tagimage){
		$data=array('tagfisrtchar'=>$this->getfirstchar($tagalias),'tagimage'=>$tagimage,'tagname'=>$tagname,'tagalias'=>$tagalias,'title'=>$title,'keywords'=>$keywords,'description'=>$description);
		$this->db->insert ( 'tag', $data );
