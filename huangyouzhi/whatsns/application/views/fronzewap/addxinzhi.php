...
<!--{template editor}-->
 ...
 <div class="add-img-box row" style="margin-bottom: 20px">
  ...
  <div class="col-sm-10" style="display:inline-block;">
   ...
   <textarea name="freeconent" id="freeconent" class="form-control" style="padding:5px;margin-top:10px;height:200px;width:97%;" placeholder="请输入试看部分内容,最多500字。"></textarea>
   </div>
     <div class="col-sm-24">
