...
<div class="user-home bg-white" style="margin-bottom: 40px">
 ...
 <form class="form-horizontal mar-t-1" action="{url admin_topic/edit}"  method="post" enctype="multipart/form-data">
    <div class="row main">
                 <div class="col-md-20">
                     <div class="dongtai">
                         <p>
 ...
 <div class="col-sm-24" style="margin-bottom: 20px;">
  <span>文章访问量</span>
    ...
    <div class="add-img-box row">
     ...
     <div class="price_set " >
     <span>阅读需要</span>
      <input type="number" AUTOCOMPLETE="OFF" id="topic_price" name="topic_price" value="{$topic['price']}" disabled size="100" class="txt_price" placeholder="可以留空">
