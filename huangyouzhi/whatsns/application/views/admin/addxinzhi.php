...
<div class="user-home bg-white" style="margin-bottom: 40px">
    ...
    <div class="alert alert-success">
      不支持站内现金充值用户慎用付费阅读模式下的现金阅读功能，否则无法使用现金支付而不能访问文章详情
    </div>
 <form class="form-horizontal mar-t-1" action="{url admin_chajian/addarticle}"  method="post" enctype="multipart/form-data">
    <div class="row main">
                 <div class="col-md-20">
                     <div class="dongtai">
                         <p>
...
<p>封面图:</p>
 ...
 <div class="add-img-box row" style="margin-bottom: 20px">
  ...
  <div class="col-sm-10">
   ...
   <textarea name="freeconent" id="freeconent" class="form-control" style="height:200px;" placeholder="请输入试看部分内容,最多500字。"></textarea>
   </div>
     <div class="col-sm-24">
...
return false;
	...
	var upfv=$("#outimgurl").val();
	 ...
	 var freeconentval=$.trim($("#freeconent").val());//试看内容
