...
<!--用户中心-->
 ...
 <p>您当前的账户钱包：<font color="#FC6603">{eval echo $user['jine']/100}元</font></font></p>
 ...
 <div class="form-group">
        ...
        {if $setting['openwxpay']==1}
         ...
         {/if}
            <div class=" {if $setting['openwxpay']==0} col-md-offset-2  {/if} col-md-6">
    ...
    function check_form(){
        ...
        if('' == _money || !money_reg.test(_money) || _money>20000 ||  _money<1){
		   ...
		   $.ajax({
		        ...
		        //提交的数据
		        data:{submit:'submit', type:'chongzhi',money:_money},
		        //返回数据的格式
