...
doms.anim = ['layer-anim', 'layer-anim-01', 'layer-anim-02', 'layer-anim-03', 'layer-anim-04', 'layer-anim-05', 'layer-anim-06', 'layer-anim-07'];
...
layer.photos = function(options, loop, key){
  ...
  if(!type){ //页面直接获取
    ...
    //此处存bug导致无法显示相册中动态添加的图片,增加解除绑定click事件.off('click')
