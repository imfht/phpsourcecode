...
class SaeTClientV2
{
    ...
    public function __construct($params)
    {
        ...
        //$this->ci->o = new SaeTOAuthV2($params['akey'], $params['skey'], $params['access_token'], $params['refresh_token']);
    }
    ...
    public function public_timeline($page = 1, $count = 50, $base_app = 0)
    {
        ...
        return $this->ci->o->get('statuses/public_timeline', $params); //可能是接口的bug不能补全
    }
    ...
    public function home_timeline($page = 1, $count = 50, $since_id = 0, $max_id = 0, $base_app = 0, $feature = 0)
    {
        ...
        return $this->ci->o->get('statuses/home_timeline', $params);
    }
    ...
    public function user_timeline_by_id($uid = null, $page = 1, $count = 50, $since_id = 0, $max_id = 0, $feature = 0, $trim_user = 0, $base_app = 0)
    {
        ...
        return $this->ci->o->get('statuses/user_timeline', $params);
    }
    ...
    public function timeline_batch_by_name($screen_name, $page = 1, $count = 50, $feature = 0, $base_app = 0)
    {
        ...
        $params['base_app'] = intval($base_app);
        $params['feature'] = intval($feature);
        return $this->ci->o->get('statuses/timeline_batch', $params);
    }
    ...
    public function show_status($id)
    {
        ...
        //memcache_set($mmc, 'show_status_count', 0);
        //echo memcache_get($mmc, 'show_status_count');
        memcache_set($mmc, 'show_status_count', memcache_get($mmc, 'show_status_count') + 1);
        //echo memcache_get($mmc, 'show_status_count');
        }*/

        return $this->ci->o->get('statuses/show', $params);
    }
    ...
    public function show_batch($ids)
    {
        ...
        return $this->ci->o->get('statuses/show_batch', $params);
    }
    ...
    public function querymid($id, $type = 1, $is_batch = 0)
    {
        ...
        return $this->ci->o->get('statuses/querymid', $params);
    }
    ...
    public function queryid($mid, $type = 1, $is_batch = 0, $inbox = 0, $isBase62 = 0)
    {
        ...
        return $this->ci->o->get('statuses/queryid', $params);
    }
    ...
    public function repost_daily($count = 20, $base_app = 0)
    {
        ...
        $params['count'] = intval($count);
        $params['base_app'] = intval($base_app);
        return $this->ci->o->get('statuses/hot/repost_daily', $params);
    }
    ...
    public function repost_weekly($count = 20, $base_app = 0)
    {
        ...
        $params['count'] = intval($count);
        $params['base_app'] = intval($base_app);
        return $this->ci->o->get('statuses/hot/repost_weekly', $params);
    }
    ...
    public function comments_daily($count = 20, $base_app = 0)
    {
        ...
        $params['count'] = intval($count);
        $params['base_app'] = intval($base_app);
        return $this->ci->o->get('statuses/hot/comments_daily', $params);
    }
    ...
    public function comments_weekly($count = 20, $base_app = 0)
    {
        ...
        $params['count'] = intval($count);
        $params['base_app'] = intval($base_app);
        return $this->ci->o->get('statuses/hot/comments_weekly', $params);
    }
    ...
    public function repost($sid, $text = null, $is_comment = 0)
    {
        ...
        return $this->ci->o->post('statuses/repost', $params);
    }
    ...
    public function destroy($id)
    {
        ...
        $params = array();
        $params['id'] = $id;
        return $this->ci->o->post('statuses/destroy', $params);
    }
    ...
    public function update($status, $lat = null, $long = null, $annotations = null)
    {
        ...
        return $this->ci->o->post('statuses/update', $params);
    }
    ...
    public function upload($status, $pic_path, $lat = null, $long = null)
    {
        ...
        return $this->ci->o->post('statuses/upload', $params, true);
    }
    ...
    public function upload_url_text($status, $url)
    {
        ...
        $params['status'] = $status;
        $params['url'] = $url;
        return $this->ci->o->post('statuses/upload_url_text', $params);
    }
    ...
    public function emotions($type = "face", $language = "cnname")
    {
        ...
        return $this->ci->o->get('emotions', $params);
    }
    ...
    public function get_comments_by_sid($sid, $page = 1, $count = 50, $since_id = 0, $max_id = 0, $filter_by_author = 0)
    {
        ...
        $params['page'] = $page;
        $params['filter_by_author'] = $filter_by_author;
        return $this->ci->o->get('comments/show', $params);
    }
    ...
    public function comments_by_me($page = 1, $count = 50, $since_id = 0, $max_id = 0, $filter_by_source = 0)
    {
        ...
        $params['page'] = $page;
        $params['filter_by_source'] = $filter_by_source;
        return $this->ci->o->get('comments/by_me', $params);
    }
    ...
    public function comments_to_me($page = 1, $count = 50, $since_id = 0, $max_id = 0, $filter_by_author = 0, $filter_by_source = 0)
    {
        ...
        $params['filter_by_author'] = $filter_by_author;
        $params['filter_by_source'] = $filter_by_source;
        return $this->ci->o->get('comments/to_me', $params);
    }
    ...
    public function comments_mentions($page = 1, $count = 50, $since_id = 0, $max_id = 0, $filter_by_author = 0, $filter_by_source = 0)
    {
        ...
        $params['filter_by_author'] = $filter_by_author;
        $params['filter_by_source'] = $filter_by_source;
        return $this->ci->o->get('comments/mentions', $params);
    }
    ...
    public function comments_show_batch($cids)
    {
        ...
        return $this->ci->o->get('comments/show_batch', $params);
    }
    ...
    public function send_comment($id, $comment, $comment_ori = 0)
    {
        ...
        return $this->ci->o->post('comments/create', $params);
    }
    ...
    public function comment_destroy($cid)
    {
        $params = array();
        $params['cid'] = $cid;
        return $this->ci->o->post('comments/destroy', $params);
    }
    ...
    public function comment_destroy_batch($ids)
    {
        ...
        return $this->ci->o->post('comments/destroy_batch', $params);
    }
    ...
    public function reply($sid, $text, $cid, $without_mention = 0, $comment_ori = 0)
    {
        ...
        return $this->ci->o->post('comments/reply', $params);
    ...
    public function show_user_by_id($uid)
    {
        ...
        return $this->ci->o->get('users/show', $params);
    }
    ...
    public function domain_show($domain)
    {
        ...
        return $this->ci->o->get('users/domain_show', $params);
    }
    ...
    public function users_show_batch_by_id($uids)
    {
        ...
        return $this->ci->o->get('users/show_batch', $params);
    }
     ...
     * @return array
     */
    public function friends_by_id($uid, $cursor = 0, $count = 50, $trim_status = 1)
    {
        $params = array();
        ...
        return $this->ci->o->get('friendships/friends', $params);
    }
    ...
    public function friends_in_common($uid, $suid = null, $page = 1, $count = 50)
    {
        ...
        $params['count'] = $count;
        $params['page'] = $page;
        return $this->ci->o->get('friendships/friends/in_common', $params);
    }
    ...
    public function bilateral($uid, $page = 1, $count = 50, $sort = 0)
    {
        ...
        $params['page'] = $page;
        $params['sort'] = $sort;
        return $this->ci->o->get('friendships/friends/bilateral', $params);
    }
    ...
    public function bilateral_ids($uid, $page = 1, $count = 50, $sort = 0)
    {
        ...
        $params['page'] = $page;
        $params['sort'] = $sort;
        return $this->ci->o->get('friendships/friends/bilateral/ids', $params);
    }
    ...
    public function friends_ids_by_id($uid, $cursor = 0, $count = 500)
    {
        ...
        $params['cursor'] = $cursor;
        $params['count'] = $count;
        return $this->ci->o->get('friendships/friends/ids', $params);
    }
    ...
    public function friends_remark_batch($uids)
    {
        ...
        return $this->ci->o->get('friendships/friends/remark_batch', $params);
    }
    ...
    public function followers_by_id($uid, $cursor = 0, $count = 50)
    {
        ...
        $params['count'] = $count;
        $params['cursor'] = $cursor;
        return $this->ci->o->get('friendships/followers', $params);
    }
    ...
    public function followers_ids_by_id($uid, $cursor = 0, $count = 50)
    {
        ...
        $params['count'] = $count;
        $params['cursor'] = $cursor;
        return $this->ci->o->get('friendships/followers/ids', $params);
    }
    ...
    public function followers_active($uid, $count = 20)
    {
        ...
        $param['uid'] = $uid;
        $param['count'] = $count;
        return $this->ci->o->get('friendships/followers/active', $param);
    }
    ...
    public function friends_chain_followers($uid, $page = 1, $count = 50)
    {
        ...
        $params['count'] = $count;
        $params['page'] = $page;
        return $this->ci->o->get('friendships/friends_chain/followers', $params);
    }
    ...
    public function is_followed_by_id($target_id, $source_id = null)
    {
        ...
        return $this->ci->o->get('friendships/show', $params);
    }
    ...
    public function follow_by_id($uid)
    {
        ...
        $this->id_format($uid);
        $params['uid'] = $uid;
        return $this->ci->o->post('friendships/create', $params);
    }
    ...
    public function follow_create_batch($uids)
    {
        ...
        return $this->ci->o->post('friendships/create_batch', $params);
    }
    ...
    public function unfollow_by_id($uid)
    {
        ...
        $this->id_format($uid);
        $params['uid'] = $uid;
        return $this->ci->o->post('friendships/destroy', $params);
    }
    ...
    public function update_remark($uid, $remark)
    {
        ...
        return $this->ci->o->post('friendships/remark/update', $params);
    }
    ...
    public function dm_user_list($count = 20, $cursor = 0)
    {
        ...
        $params['count'] = $count;
        $params['cursor'] = $cursor;
        return $this->ci->o->get('direct_messages/user_list', $params);
    }
    ...
    public function dm_conversation($uid, $page = 1, $count = 50, $since_id = 0, $max_id = 0)
    {
        ...
        $params['count'] = $count;
        $params['page'] = $page;
        return $this->ci->o->get('direct_messages/conversation', $params);
    }
    ...
    public function dm_show_batch($dmids)
    {
        ...
        return $this->ci->o->get('direct_messages/show_batch', $params);
    }
    ...
    public function send_dm_by_id($uid, $text, $id = null)
    {
        ...
        return $this->ci->o->post('direct_messages/new', $params);
    }
    ...
    public function delete_dm($did)
    {
        ...
        $params = array();
        $params['id'] = $did;
        return $this->ci->o->post('direct_messages/destroy', $params);
    }
    ...
    public function delete_dms($dids)
    {
        ...
        return $this->ci->o->post('direct_messages/destroy_batch', $params);
    }
    ...
    public function account_profile_basic($uid = null)
    {
        ...
        return $this->ci->o->get('account/profile/basic', $params);
    }
    ...
    public function account_education($uid = null)
    {
        ...
        return $this->ci->o->get('account/profile/education', $params);
    }
    ...
    public function account_education_batch($uids)
    {
        ...
        return $this->ci->o->get('account/profile/education_batch', $params);
    }
    ...
    public function account_career($uid = null)
    {
        ...
        return $this->ci->o->get('account/profile/career', $params);
    }
    ...
    public function account_career_batch($uids)
    {
        ...
        return $this->ci->o->get('account/profile/career_batch', $params);
    }
    ...
    {
        return $this->ci->o->get('account/get_privacy');
    }
    ...
    public function school_list($query)
    {
        ...
        return $this->ci->o->get('account/profile/school_list', $params);
    }
    ...
    {
        return $this->ci->o->get('account/rate_limit_status');
    }
    ...
    {
        return $this->ci->o->get('account/get_uid');
    }
    ...
    {
        return $this->ci->o->post('account/profile/basic_update', $profile);
    }
    ...
    {
        return $this->ci->o->post('account/profile/edu_update', $edu_update);
    }
    ...
    public function edu_destroy($id)
    {
        ...
        $params = array();
        $params['id'] = $id;
        return $this->ci->o->post('account/profile/edu_destroy', $params);
    }
    ...
    {
        return $this->ci->o->post('account/profile/car_update', $car_update);
    }
    ...
    public function car_destroy($id)
    {
        ...
        $params = array();
        $params['id'] = $id;
        return $this->ci->o->post('account/profile/car_destroy', $params);
    }
    ...
    public function update_profile_image($image_path)
    {
        ...
        return $this->ci->o->post('account/avatar/upload', $params);
    }
    ...
    {
        return $this->ci->o->post('account/update_privacy', $privacy_settings);
    }
    ...
    public function get_favorites($page = 1, $count = 50)
    {
        ...
        return $this->ci->o->get('favorites', $params);
    }
    ...
    public function favorites_show($id)
    {
        ...
        $this->id_format($id);
        $params['id'] = $id;
        return $this->ci->o->get('favorites/show', $params);
    }
    ...
    public function favorites_by_tags($tid, $page = 1, $count = 50)
    {
        ...
        $params['count'] = $count;
        $params['page'] = $page;
        return $this->ci->o->get('favorites/by_tags', $params);
    }
    ...
    public function favorites_tags($page = 1, $count = 50)
    {
        ...
        $params['count'] = $count;
        $params['page'] = $page;
        return $this->ci->o->get('favorites/tags', $params);
    }
    ...
    public function add_to_favorites($sid)
    {
        ...
        return $this->ci->o->post('favorites/create', $params);
    }
    ...
    public function remove_from_favorites($id)
    {
        ...
        $params = array();
        $params['id'] = $id;
        return $this->ci->o->post('favorites/destroy', $params);
    }
    ...
    public function remove_from_favorites_batch($fids)
    {
        ...
        return $this->ci->o->post('favorites/destroy_batch', $params);
    }
    ...
    public function favorites_tags_update($id, $tags)
    {
        ...
        return $this->ci->o->post('favorites/tags/update', $params);
    }
    ...
    public function favorites_update_batch($tid, $tag)
    {
        ...
        $params['tid'] = $tid;
        $params['tag'] = $tag;
        return $this->ci->o->post('favorites/tags/update_batch', $params);
    }
    ...
    public function favorites_tags_destroy_batch($tid)
    {
        $params = array();
        $params['tid'] = $tid;
        return $this->ci->o->post('favorites/tags/destroy_batch', $params);
    }
    ...
    public function get_trends($uid = null, $page = 1, $count = 10)
    {
        ...
        $params['page'] = $page;
        $params['count'] = $count;
        return $this->ci->o->get('trends', $params);
    }
    ...
    public function trends_is_follow($trend_name)
    {
        ...
        return $this->ci->o->get('trends/is_follow', $params);
    }
    ...
    public function hourly_trends($base_app = 0)
    {
        ...
        return $this->ci->o->get('trends/hourly', $params);
    }
    ...
    public function daily_trends($base_app = 0)
    {
        ...
        return $this->ci->o->get('trends/daily', $params);
    }
    ...
    public function weekly_trends($base_app = 0)
    {
        ...
        return $this->ci->o->get('trends/weekly', $params);
    }
    ...
    public function follow_trends($trend_name)
    {
        $params = array();
        $params['trend_name'] = $trend_name;
        return $this->ci->o->post('trends/follow', $params);
    }
    ...
    public function unfollow_trends($tid)
    {
        ...
        return $this->ci->o->post('trends/destroy', $params);
    }
    ...
    public function get_tags($uid = null, $page = 1, $count = 20)
    {
        ...
        $params['page'] = $page;
        $params['count'] = $count;
        return $this->ci->o->get('tags', $params);
    }
    ...
    public function get_tags_batch($uids)
    {
        ...
        return $this->ci->o->get('tags/tags_batch', $params);
    }
    ...
    public function get_suggest_tags($count = 10)
    {
        $params = array();
        $params['count'] = intval($count);
        return $this->ci->o->get('tags/suggestions', $params);
    }
    ...
    public function add_tags($tags)
    {
        ...
        return $this->ci->o->post('tags/create', $params);
    }
    ...
    public function delete_tag($tag_id)
    {
        ...
        return $this->ci->o->post('tags/destroy', $params);
    }
    ...
    public function delete_tags($ids)
    {
        ...
        return $this->ci->o->post('tags/destroy_batch', $params);
    }
    ...
    public function verify_nickname($nickname)
    {
        ...
        return $this->ci->o->get('register/verify_nickname', $params);
    }
    ...
    public function search_users($q, $count = 10)
    {
        ...
        $params['q'] = $q;
        $params['count'] = $count;
        return $this->ci->o->get('search/suggestions/users', $params);
    }
    ...
    public function search_statuses($q, $count = 10)
    {
        ...
        $params['q'] = $q;
        $params['count'] = $count;
        return $this->ci->o->get('search/suggestions/statuses', $params);
    }
    ...
    public function search_schools($q, $count = 10, $type = 1)
    {
        ...
        $params['count'] = $count;
        $params['type'] = $type;
        return $this->ci->o->get('search/suggestions/schools', $params);
    }
    ...
    public function search_companies($q, $count = 10)
    {
        ...
        $params['q'] = $q;
        $params['count'] = $count;
        return $this->ci->o->get('search/suggestions/companies', $params);
    }
    ...
    public function search_at_users($q, $count = 10, $type = 0, $range = 2)
    {
        ...
        $params['type'] = $type;
        $params['range'] = $range;
        return $this->ci->o->get('search/suggestions/at_users', $params);
    }
    ...
    {
        return $this->ci->o->get('search/statuses', $query);
    }
    ...
    {
        return $this->ci->o->get('search/users', $query);
    }
    ...
    public function hot_users($category = "default")
    {
        ...
        return $this->ci->o->get('suggestions/users/hot', $params);
    }
    ...
    public function suggestions_may_interested($page = 1, $count = 10)
    {
        ...
        $params['page'] = $page;
        $params['count'] = $count;
        return $this->ci->o->get('suggestions/users/may_interested', $params);
    }
    ...
    public function suggestions_users_by_status($content, $num = 10)
    {
        ...
        $params['num'] = $num;
        return $this->ci->o->get('suggestions/users/by_status', $params);
    }
    ...
    public function hot_favorites($page = 1, $count = 20)
    {
        ...
        $params['count'] = $count;
        $params['page'] = $page;
        return $this->ci->o->get('suggestions/favorites/hot', $params);
    }
    ...
    public function put_users_not_interested($uid)
    {
        $params = array();
        $params['uid'] = $uid;
        return $this->ci->o->post('suggestions/users/not_interested', $params);
    }
    ...
    //获取省份列表
    public function get_province($country = '001', $capital = null, $language = 'zh-cn')
    {
        $params = array();
        $params['country'] = $country;
        $params['capital'] = $capital;
        $params['language'] = $language;
        return $this->ci->o->get('common/get_province', $params);
    }

    //获取城市列表
    public function get_city($province, $capital = null, $language = 'zh-cn')
    {
        $params = array();
        $params['province'] = $province;
        $params['capital'] = $capital;
        $params['language'] = $language;
        return $this->ci->o->get('common/get_city', $params);
    }
    ...
    public function short_url_shorten($url_long)
    {
        ...
        return $this->ci->o->post('short_url/shorten', $params);
    }

    /**
     * 将一个或多个短链接转换成长链接
     *
     * 对应API：{@link http://open.weibo.com/wiki/2/short_url/expand}
     */
    public function short_url_expand($url_short)
    {
        $params = array();
        $params['url_short'] = $url_short;
        return $this->ci->o->post('short_url/expand', $params);
    }

    /**
     * 获取短链接的总点击数
     *
     * 对应API：{@link http://open.weibo.com/wiki/2/short_url/clicks}
     */
    public function short_url_clicks($url_short)
    {
        $params = array();
        $params['url_short'] = $url_short;
        return $this->ci->o->post('short_url/clicks', $params);
    }

    /**
     * 获取一个短链接点击的referer来源和数量
     *
     * 对应API：{@link http://open.weibo.com/wiki/2/short_url/referers}
     */
    public function short_url_referers($url_short)
    {
        $params = array();
        $params['url_short'] = $url_short;
        return $this->ci->o->post('short_url/referers', $params);
    }

    /**
     * 获取一个短链接点击的地区来源和数量
     *
     * 对应API：{@link http://open.weibo.com/wiki/2/short_url/locations}
     */
    public function short_url_locations($url_short)
    {
        $params = array();
        $params['url_short'] = $url_short;
        return $this->ci->o->post('short_url/locations', $params);
    }

    /**
     * 获取短链接在微博上的微博分享数
     *
     * 对应API：{@link http://open.weibo.com/wiki/2/short_url/share/counts}
     */
    public function short_url_share_counts($url_short)
    {
        $params = array();
        $params['url_short'] = $url_short;
        return $this->ci->o->post('short_url/share/counts', $params);
    }

    /**
     * 获取包含指定单个短链接的最新微博内容
     *
     * 对应API：{@link http://open.weibo.com/wiki/2/short_url/share/statuses}
     */
    public function short_url_share_statuses($url_short, $since_id = 0, $max_id = 0, $count = 50, $page = 1)
    {
        $params = array();
        $params['url_short'] = $url_short;
        $params['since_id'] = $since_id;
        ...
        $params['count'] = $count;
        $params['page'] = $page;
        return $this->ci->o->post('short_url/share/statuses', $params);
    }

    /**
     * 获取短链接在微博上的微博评论数
     *
     * 对应API：{@link http://open.weibo.com/wiki/2/short_url/comment/counts}
     */
    public function short_url_comment_counts($url_short)
    {
        $params = array();
        $params['url_short'] = $url_short;
        return $this->ci->o->post('short_url/comment/counts', $params);
    }

    /**
     * 获取包含指定单个短链接的最新微博评论
     *
     * 对应API：{@link http://open.weibo.com/wiki/2/short_url/comment/comments}
     */
    public function short_url_comment_comments($url_short, $since_id = 0, $max_id = 0, $count = 50, $page = 1)
    {
        $params = array();
        $params['url_short'] = $url_short;
        $params['since_id'] = $since_id;
        ...
        $params['count'] = $count;
        $params['page'] = $page;
        return $this->ci->o->post('short_url/comment/comments', $params);
    }

    /**
     * 批量获取短链接的富内容信息
     *
     * 对应API：{@link http://open.weibo.com/wiki/2/short_url/info}
     */
    public function short_url_info($url_short)
    {
        $params = array();
        $params['url_short'] = $url_short;
        return $this->ci->o->post('short_url/info', $params);
    }

    /**
     * 获取一条原创微博的最新转发微博的ID
     *
     * 对应API：{@link http://open.weibo.com/wiki/2/statuses/repost_timeline/ids}
     */
    public function repost_timeline_ids($sid, $page = 1, $count = 50, $since_id = 0, $max_id = 0, $filter_by_author = 0)
    {
        $this->id_format($sid);
        ...
        return $this->request_with_pager('statuses/repost_timeline/ids', $page, $count, $params);
    }

    //获取用户微博ID列表
    public function user_timeline_ids($uid, $page = 1, $count = 50, $since_id = 0, $max_id = 0, $base_app = 0, $feature = 0)
    {
        $this->id_format($uid);
        ...
        return $this->request_with_pager('statuses/user_timeline/ids', $page, $count, $params);
    }
     ...
     *
     */
    public function unfriendships_by_id($uid)
    {
        $params = array();
        $this->id_format($uid);
        $params['uid'] = $uid;
        return $this->ci->o->post('friendships/followers/destroy', $params);
    }
    ...
    public function get_token_info($access_token)
    {
        ...
        return $this->ci->o->post('https://api.weibo.com/oauth2/get_token_info', $params);
    }
     ...
     *
     */
    public function notice_send($uids, $tpl_id, $action_url = null)
    {
        $params = array();
        if (is_array($uids) && !empty($uids)) {
            foreach ($uids as $k => $v) {
        ...
        return $this->ci->o->post('notification/send', $params);
    }

    /*获取地点详情*/
    public function place_pois_show($poiid, $base_app = 0)
    {
        $params = array();
        $params['poiid'] = $poiid;
        $params['base_app'] = $base_app;

        return $this->ci->o->get('place/pois/show', $params);
    }

    /*获取附近发签到的人*/
    public function place_pois_users($poiid, $page = 1, $count = 50, $base_app = 0)
    {
        $params = array();
        $params['poiid'] = $poiid;
        $params['page'] = intval($page);
        ...
        return $this->ci->o->get('place/pois/users', $params);
    }

    /*获取用户签到过的地点列表*/
    public function checkins($uid, $page = 1, $count = 50, $base_app = 0)
    {
        $params = array();
        $this->id_format($uid);
        $params['uid'] = $uid;
        ...
        return $this->ci->o->get('place/users/checkins', $params);
    }
    ...
    public function groups()
    {
        ...
        return $this->ci->o->get('friendships/groups', $params);
    }

    /*获取某一分组的用户ID*/
    public function groups_members_ids($list_id, $cursor = 0, $count = 50)
    {
        $params = array();
        $params['list_id'] = $list_id;
        $params['cursor'] = intval($cursor);
        $params['count'] = intval($count);

        return $this->ci->o->get('friendships/groups/members/ids', $params);
    }
    ...
    protected function request_with_pager($url, $page = false, $count = false, $params = array())
    {
        ...
        return $this->ci->o->get($url, $params);
    }
    ...
    protected function request_with_uid($url, $uid_or_name, $page = false, $count = false, $cursor = false, $post = false, $params = array())
    {
        ...
        return $this->ci->o->$method($url, $params);
