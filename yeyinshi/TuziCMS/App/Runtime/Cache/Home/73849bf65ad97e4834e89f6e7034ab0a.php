...
<div style="clear:both"></div>
		...
		<div class="caseConMiddle" > 	
            <div class="caseConList">
				<?php if(empty($vlist)): ?><tr>
				<td colspan="5"><div align="center">本区域暂无数据显示...</div></td>
				</tr>
				<?php else: ?> 
				<?php if(is_array($vlist)): foreach($vlist as $key=>$v): ?><div class="caseForm">
                	<div class='casePicOuter'>
                    	<div class="casePic">	
                    ...
                    <div class="caseText">
                    	<a hidefocus="true" class="caseCompanyName" title='<?php echo ($v["news_title"]); ?>' href="<?php echo ($v["url"]); ?>" ><?php echo ($v["news_title"]); ?> </a>
                    </div>
