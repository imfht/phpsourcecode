...
<div style="clear:both"></div>
		...
		<!--@end 二级导航 -->	
			<div class="right">
                <div class="intro">
				<?php if(is_array($blist)): $i = 0; $__LIST__ = $blist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; echo ($v["column_content"]); endforeach; endif; else: echo "" ;endif; ?>
				</div>
            </div>	
			<div class="clear"></div>
		</div>
