...
<div style="clear:both"></div>
	...
	<div class="ov">
			...
			<?php if(is_array($vlist)): foreach($vlist as $key=>$v): ?><ul class="txt-list-a lh-56 cor-333 fz-18">
            	<li>
				<a href="<?php echo ($v["url"]); ?>" class="title" title="<?php echo ($v["news_title"]); ?>" ><?php echo ($v["news_title"]); ?></a>
