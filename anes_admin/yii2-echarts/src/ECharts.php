...
class ECharts extends Widget
{
    ...
    public static function registerGl(){
        GlAsset::register(Yii::$app->getView());
    }
    
    public static function registerSelf(){
        EChartsAsset::register(Yii::$app->getView());
    }
