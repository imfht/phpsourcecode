...
class CWebApplication extends CApplication
{
	...
	public function configure($config)
	{
        ...
        */
        ...
        $arr = array('_assets/<path:.*?>'=>'site/assets');
        if(empty($config['components']['urlManager']['rules']))
            $config['components']['urlManager']['rules'] = array();
        $config['components']['urlManager']['rules'] = $arr + $config['components']['urlManager']['rules'];
	...
	public function processRequest()
	{
		...
		#强制解析到_assets
        if($route == 'site/assets')
        {
            $action = new SAEAssetsAction('site','assets');
            $action->run();
        }
