...
//        }
      obj = elem.getAttribute('data-animation');
        ...
        tabStr += "<div id=\"cssanimAddAnimDialogTabOver\" class=\"content\" style=\"height:65px;\">";
        ...
        tabStr += "<label for=\"tab-Click\">" + '' + "<\/label>";
        tabStr += "<div  id=\"cssanimAddAnimDialogTabClick\" class=\"content\" style=\"height:55px;display:none;\">";
        ...
        tabStr += "<div  id=\"cssanimAddAnimDialogTabLoad\" class=\"content\" style=\"height:90px;\">";
