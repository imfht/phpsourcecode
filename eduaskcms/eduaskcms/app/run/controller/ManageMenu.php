...
class ManageMenu extends Run
{
    ...
    public function lists()
    {
        if ($this->args['list'] == 'list') {
            ...
            $this->addAction("新增一级{$this->mdl->cname}", array('ManageMenu/create', ['parent_id' => 1]), 'fa-plus-circle');
            $this->addAction("一级{$this->mdl->cname}排序", array('ManageMenu/sort', ['parent_id' => 1]), 'fa-sort');
