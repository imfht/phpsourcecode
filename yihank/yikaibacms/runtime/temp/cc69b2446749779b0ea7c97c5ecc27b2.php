<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"E:\wamp\www\1kbcms\public/../application/admin\view\index\home.html";i:1496972026;s:76:"E:\wamp\www\1kbcms\public/../application/admin\view\public\base_content.html";i:1496972852;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="container-fluid am-cf">
    <div class="row">
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
            <div class="page-header-heading"><span class="am-icon-home page-header-heading-icon"></span> 首页 <small>Amaze UI</small></div>
            <p class="page-header-description">本后台前端采用amaze ui ，感谢amaze ui提供。以下内容为测试数据。</p>
        </div>
    </div>
</div>
<hr>
...
<script>
        ...
        if (status==1){
            return $('#my_success').modal({
                ...
                onConfirm: function(options) {
                    window.location.href="<?php echo (isset($index_url) && ($index_url !== '')?$index_url:'index'); ?>";
                },
    ...
    $(document).on('change',".file",function(){
        var obj=this;
        var action = "<?php echo url('kbcms/admin_upload/upload'); ?>";
