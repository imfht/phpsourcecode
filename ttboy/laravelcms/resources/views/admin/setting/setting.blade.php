    ...
    <section class="content" >
        ...
        <div class="box box-primary" id="app-content">
          ...
          <div class="box-body">	
              ...
              <div class="form-group">
                <div class="input-group">
                  <span class="input-group-addon minwidth">{{trans('admin.website_setting_sysfullname')}}</span>
                  <input type="text" class="form-control"  v-model="info.sysfullname"   placeholder="例如：LaravelCms" >
                </div>
              </div>
              <div class="form-group">
                <div class="input-group">
                  <span class="input-group-addon minwidth">{{trans('admin.website_setting_sysshortname')}}</span>
                  <input type="text" class="form-control"  v-model="info.sysshortname"   placeholder="例如：LPCMS" >
                </div>
              </div>
              <div class="form-group">
                <div class="input-group">
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control"  v-model="info.sysicp"   placeholder="例如：浙ICP备XXXXXXXX号-1" >
                </div>
              </div>
              <div class="form-group">
                <div class="input-group">
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control"  v-model="info.sysqq"   placeholder="例如：XXXXXXXXX" >
                </div>
              </div>
              <div class="form-group">
                <div class="input-group">
                  <span class="input-group-addon minwidth">{{trans('admin.website_setting_syswechat')}}</span>
                  <input type="text" class="form-control"  v-model="info.syswechat"  placeholder="例如：XXXXXX" >
                </div>
              </div>
              <div class="form-group">
                <div class="input-group">
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control"  v-model="info.sysaddress"   placeholder="例如：浙江省XX市XX市XX街道XX村XX号" >
                </div>
              </div>
              <div class="form-group">
                <div class="input-group">
