...
new Vue({
    el: '#app-content',
    data: {
             apiurl_add:            '{{ route("post.admin.classifyquestion.api_add") }}', 
             apiurl_info:           '{{ route("post.admin.classifyquestion.api_info") }}', 
             apiurl_edit:           '{{ route("post.admin.classifyquestion.api_edit") }}',
