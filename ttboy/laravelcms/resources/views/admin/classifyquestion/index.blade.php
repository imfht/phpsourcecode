...
new Vue({
    ...
    data: {
             apiurl_list          :'{{ route("post.admin.classifyquestion.api_list") }}',
             linkurl_add         :'{{ route("get.admin.classifyquestion.add") }}', 
             linkurl_edit         :'{{ route("get.admin.classifyquestion.edit") }}/', 
