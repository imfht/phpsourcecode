      ...
      <div class="box" id="app-content">
        ...
        <!-- /.box-header -->
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon minwidth">{{trans('admin.fieldname_item_fraction')}}</span>
...
new Vue({
    el: '#app-content',
    data: {
             apiurl_add:            '{{ route("post.admin.question.api_add") }}', 
             apiurl_info:           '{{ route("post.admin.question.api_info") }}', 
             apiurl_edit:           '{{ route("post.admin.question.api_edit") }}',
