          ...
          <div class="box-body">
            ...
            <div class="form-group">
              <div class="input-group">
                ...
                <input type="text" class="form-control" id="birthday" v-model="params_data.birthday" readonly >
              </div>
            </div>
            <div class="form-group">
              <div class="input-group">
...
$("#birthday").datetimepicker({
    ...
    onChangeDateTime:function(currentDateTime,$input){
      app.params_data.birthday = $input.val();
      //console.info('app',app,currentDateTime,$input.val());
    }
});
