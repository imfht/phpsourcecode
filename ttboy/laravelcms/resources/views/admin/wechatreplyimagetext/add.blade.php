...
new Vue({
    ...
    data: {
             ...
             apiurl_add:            '{{ route("post.admin.wechatreplyimagetext.api_add") }}', 
             apiurl_info:           '{{ route("post.admin.wechatreplyimagetext.api_info") }}', 
             apiurl_edit:           '{{ route("post.admin.wechatreplyimagetext.api_edit") }}',
