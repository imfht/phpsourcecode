...
new Vue({
    el: '#app-content',
    data: {
             apiurl_add:            '{{ route("post.admin.classifyproduct.api_add") }}', 
             apiurl_info:           '{{ route("post.admin.classifyproduct.api_info") }}', 
             apiurl_edit:           '{{ route("post.admin.classifyproduct.api_edit") }}',
