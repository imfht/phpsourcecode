...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{ route('get.admin') }}" class="logo">
      ...
      <span class="logo-mini"><b>{{@$website['root']['sysshortname']?@$website['root']['sysshortname']:trans('admin.website_sname')}}</b></span>
      <!-- logo for regular state and mobile devices 项目名称全称-->
      <span class="logo-lg"><b>{{@$website['root']['sysfullname']?@$website['root']['sysfullname']:trans('admin.website_name')}}</b></span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <a href="{{asset('/')}}">{{$website['root']['systitle']?$website['root']['systitle']:trans('admin.website_name')}}</a>.</strong> {{trans('admin.website_version_tip')}}.
  </footer>
