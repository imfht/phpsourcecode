...
@section('content')
	...
	<div class="login-form">
		<!--<div class="close"> </div>-->
			...
			<form class="form-horizontal" role="form" id="do_form" name="do_form" method="POST" autocomplete="off">
				{{ csrf_field() }}
				@if ($website['type'] == 1)
				<input type="hidden" name="type" value="1">
				<input type="text" class="text" onBlur="onBlur_check('email');" id="email" autocomplete="off" name="email" value="" placeholder="：" style="width:60%;padding-left:5em;background:url('{{asset('/module/login')}}/images/email.png') no-repeat left center;">
				@elseif ($website['type'] == 2)
				<input type="hidden" name="type" value="2">
				<input type="text" class="text" onBlur="onBlur_check('username');" id="username" autocomplete="off" name="username" value="" placeholder="：" style="width:60%;padding-left:5em;background:url('{{asset('/module/login')}}/images/username.png') no-repeat left center;">
				<input type="text" class="text" onBlur="onBlur_check('email');" id="email" autocomplete="off" name="email" value="" placeholder="：" style="margin-top:0;width:60%;padding-left:5em;background:url('{{asset('/module/login')}}/images/email.png') no-repeat left center;">
				@elseif ($website['type'] == 3)
				<input type="hidden" name="type" value="3">
				<input type="text" class="text" onBlur="onBlur_check('mobile');" id="mobile" autocomplete="off" name="mobile" value="" placeholder="：" style="width:60%;padding-left:5em;background:url('{{asset('/module/login')}}/images/mobile.png') no-repeat left center;">
				@endif
				<input id="password" type="password" autocomplete="off"  name="userpwd" placeholder="："  style="margin-bottom:0;width:60%;padding-left:5em;background:url('{{asset('/module/login')}}/images/pwd.png') no-repeat left center;">
				<input id="password" type="password" autocomplete="off"  name="reuserpwd" placeholder="：" style="margin-bottom:0;width:60%;padding-left:5em;background:url('{{asset('/module/login')}}/images/repwd.png') no-repeat left center;">
				<input type="text" name="code" maxlength="5" placeholder="验证码" autocomplete="off"  style="margin-top:0;width:60%;padding-left:5em;background:url('{{asset('/module/login')}}/images/code.png') no-repeat left center;">
