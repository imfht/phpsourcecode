...
<table cellspacing="2" cellpadding="2" border="0" align="center" class="flegend">
  <tr> 
...
<table border="0" cellpadding="4" cellspacing="1" width="100%" class="forumline">
	...
	<tr> 
	  ...
	  <td width="90%" class="row2"><span class="genmed">{POST_SUBJECT}</span></td>
	  <td width="10%" nowrap="nowrap" class="row2" align="center"> {QUOTE_PM_IMG} {EDIT_PM_IMG}</td>
	</tr>
	<tr> 
