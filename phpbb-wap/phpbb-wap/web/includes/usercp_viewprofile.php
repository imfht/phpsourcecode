...
if ( !empty($profiledata['user_viewemail']) || $userdata['user_level'] == ADMIN )
{
	...
	$email_img = '<a href="' . $email_uri . '">' . $profiledata['user_email'] . '</a>';
...
$www_img = ( $profiledata['user_website'] ) ? '<a href="' . $profiledata['user_website'] . '" target="_userwww">' . $profiledata['user_website'] . '</a>' : '&nbsp;';
$www = ( $profiledata['user_website'] ) ? '<a href="' . $profiledata['user_website'] . '" target="_userwww">' . $profiledata['user_website'] . '</a>' : '&nbsp;';

if ( !empty($profiledata['user_icq']) )
{
	$icq_status_img = '';
	$icq_img = '<a href="http://wwp.icq.com/scripts/search.dll?to=' . $profiledata['user_icq'] . '">' . $profiledata['user_icq'] . '</a>';
