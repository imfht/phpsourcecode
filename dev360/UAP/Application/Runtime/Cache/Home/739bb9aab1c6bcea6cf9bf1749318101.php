...
<div class="content">
    <div class="box box-info">
        ...
        <form id="form" action="" class="form-horizontal" method="post">
            ...
            <input style="display: none" value="<?php echo ($userids); ?>" name="userids" id="userids">
            ...
            <div class="box-footer">
                <a href="javascript:void(0)" onclick="commonSubmit('form','/uap/home/role/configUserEntity','')"
