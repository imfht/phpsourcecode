    ...
    <div class="box box-info">
        <form id="form" action="" class="form-horizontal" method="post">
            ...
            <input style="display: none"
                   id="menuids" name="menuids" value="<?php echo ($menuids); ?>">
            ...
            <script>
                ...
                var zNodes = [
                <?php if(is_array($menulist)): $i = 0; $__LIST__ = $menulist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>{id: "<?php echo ($vo["id"]); ?>", pId: "<?php echo ($vo["parentid"]); ?>", name: "<?php echo ($vo["name"]); ?>", open: true},<?php endforeach; endif; else: echo "" ;endif; ?>
                ];
                ...
                $(document).ready(function () {
                    ...
                    var cueentMenuids = '<?php echo ($menuids); ?>';
                    if (cueentMenuids != '') {
            ...
            <div class="box-footer">
                <a href="javascript:void(0)" onclick="commonSubmit('form','/uap/home/role/configMenuEntity','')"
