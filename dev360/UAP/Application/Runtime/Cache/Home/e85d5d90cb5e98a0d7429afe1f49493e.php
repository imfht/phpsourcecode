        ...
        <form id="form" action="" class="form-horizontal" method="post">
            ...
            <div class="box-body">
                <div class="form-group" required="required">
                    ...
                    <div class="col-sm-6">
                        <input value="<?php echo ($entity["properties"]); ?>" class="form-control" name="properties" id="properties">
                    </div>
                </div>
                <div class="form-group" required="required">
                    ...
                    <div class="col-sm-6">
                        <input value="<?php echo ($entity["dict"]); ?>" class="form-control" name="dict" id="dict">
                    </div>
                </div>
                <div class="form-group" required="required">
                    ...
                    <div class="col-sm-6">
                        <input value="<?php echo ($entity["bussiness"]); ?>" class="form-control" name="bussiness" id="bussiness">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input value="<?php echo ($entity["notes"]); ?>" class="form-control" name="notes" id="notes">
                    </div>
                </div>
            </div>
            <div class="box-footer">
                <a href="javascript:void(0)" onclick="commonSubmit('form','/uap/home/config/<?php echo ($action); ?>','')"
                   class="btn btn-primary pull-right" style="margin-left: 5px">提交</a>
                <a href="/uap/home/config" class="btn btn-default  pull-right">返回</a>
            </div>
            <!-- /.box-footer -->
        </form>
    </div>
