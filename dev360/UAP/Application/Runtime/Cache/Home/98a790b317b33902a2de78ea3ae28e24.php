    ...
    <div class="box box-info">
        ...
        <form class="form-horizontal">
            <div class="box-body">
                ...
                <div class="col-xs-3">
                    <input value="<?php echo ($_GET['name']); ?>" class="form-control" id="name" name="name">
                </div>
            </div>
            <div class="box-footer">
                <a href="/uap/home/role/add"  class="btn btn-info pull-right" style="margin-left: 5px">新增</a>
        ...
        <div class="box-body table-responsive no-padding">
            <table class="table table-hover">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                            <a href="/uap/home/role/configMenu?id=<?php echo ($vo["id"]); ?>" class="btn btn-primary ">菜单权限</a>
                            <a href="/uap/home/role/configUser?id=<?php echo ($vo["id"]); ?>" class="btn btn-success ">设置用户</a>
                            <a href="/uap/home/role/edit?id=<?php echo ($vo["id"]); ?>" class="btn btn-info ">编辑</a>
                            <a href="javascript:void(0)"
                               onclick="deleteEntity('/uap/home/role/deleteEntity','<?php echo ($vo["id"]); ?>')"
