    ...
    <div class="box box-info">
        ...
        <form id="form" action="" class="form-horizontal" method="post">
            ...
            <div class="box-body">
                ...
                <div class="form-group" required="required">
                    ...
                    <div class="col-sm-6">
                        <select name="parentid" id="parentid" class="form-control">
                            ...
                            <?php if(empty($entity["parentid"])): ?>selected="selected"<?php endif; ?>
                            value="NULL">请选择</option>
                            <?php if(is_array($menus)): $i = 0; $__LIST__ = $menus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option

                                <?php $vid = $entity["parentid"]; ?>
                                <?php $oid = $vo["id"]; ?>
                ...
                <div class="form-group" required="required" required="required">
                ...
                <div class="form-group" required="required" required="required">
                    ...
                    <div class="col-sm-6">
                        <input value="<?php echo ($entity["url"]); ?>" class="form-control" name="url" id="url">
                    </div>
                </div>
                <div class="form-group" >
                    ...
                    <div class="col-sm-6">
                        <input value="<?php echo ($entity["icon"]); ?>" class="form-control" name="icon" id="icon">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input value="<?php echo ($entity["orders"]); ?>" class="form-control" name="orders" id="orders">
                    </div>
                </div>
                <div class="form-group" required="required">
                    ...
                    <div class="col-sm-6">
                        <select name="display" id="display" class="form-control">
                            <option  <?php if($entity["display"] == 1): ?>selected="selected"<?php endif; ?> value="1">是</option>
                            <option <?php if($entity["display"] == 0): ?>selected="selected"<?php endif; ?> value="0">否</option>
                        </select>
                    </div>
                </div>
            </div>
            <div class="box-footer">
                <a href="javascript:void(0)" onclick="commonSubmit('form','/uap/home/menu/<?php echo ($action); ?>','')"
                   class="btn btn-primary pull-right" style="margin-left: 5px">提交</a>
                <a href="/uap/home/menu" class="btn btn-default  pull-right">返回</a>
            </div>
            <!-- /.box-footer -->
        </form>
    </div>
