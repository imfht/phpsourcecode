    ...
    <div class="box box-info">
        ...
        <form class="form-horizontal">
            <div class="box-body">
                ...
                <label for="parentid" class="col-sm-2 control-label">所属应用</label>

                <div class="col-xs-2">
                    <select name="appid" id="appid" class="form-control">
                        <option
                        <?php if(empty($_GET['appid'])): ?>selected="selected"<?php endif; ?>
                        value="">请选择</option>
                ...
                <div class="col-xs-2">
                    <select name="parentid" id="parentid" class="form-control">
                        <option
                        <?php if(empty($_GET['parentid'])): ?>selected="selected"<?php endif; ?>
                        value="">请选择</option>
                        <?php if(is_array($menuslist)): $i = 0; $__LIST__ = $menuslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option
                            <?php $vid = $_GET['parentid']; ?>
                            <?php $oid = $vo["id"]; ?>
                            <?php if($vid == $oid): ?>selected="selected"<?php endif; ?>
                            value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
            ...
            <div class="box-footer">
                <a href="/uap/home/menu/add"  class="btn btn-info pull-right" style="margin-left: 5px">新增</a>
        ...
        <div class="box-body table-responsive no-padding">
            <table class="table table-hover">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php if($vo["display"] == 0): ?>不显示<?php else: ?>显示<?php endif; ?></td>
                        <td>
                            <a href="/uap/home/menu/edit?id=<?php echo ($vo["id"]); ?>" class="btn btn-info ">编辑</a>
                            <a href="javascript:void(0)"
                               onclick="deleteEntity('/uap/home/menu/deleteEntity','<?php echo ($vo["id"]); ?>')"
