        ...
        <form id="form" action="" class="form-horizontal" method="post">
            ...
            <div class="box-body">
                ...
                <div class="form-group" required="required">
                    ...
                    <div class="col-sm-6">
                        <input value="<?php echo ($entity["appkey"]); ?>" type="text" class="form-control" name="appkey" id="appkey">
                    </div>
                </div>
            ...
            <div class="box-footer">
                <a href="javascript:void(0)" onclick="commonSubmit('form','/uap/home/app/<?php echo ($action); ?>','')"
                   class="btn btn-primary pull-right" style="margin-left: 5px">提交</a>
                <a href="/uap/home/app" class="btn btn-default  pull-right">返回</a>
            </div>
            <!-- /.box-footer -->
        </form>
    </div>
