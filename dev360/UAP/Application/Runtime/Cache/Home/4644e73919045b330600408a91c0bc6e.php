    ...
    <div class="box box-info">
        ...
        <form class="form-horizontal">
            ...
            <div class="box-footer">
                <a href="/uap/home/app/add"  class="btn btn-info pull-right" style="margin-left: 5px">新增</a>
        ...
        <div class="box-body table-responsive no-padding">
            <table class="table table-hover">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                            <a href="/uap/home/app/edit?id=<?php echo ($vo["id"]); ?>" class="btn btn-info ">编辑</a>
                            <a href="javascript:void(0)"
                               onclick="deleteEntity('/uap/home/app/deleteEntity','<?php echo ($vo["id"]); ?>')"
