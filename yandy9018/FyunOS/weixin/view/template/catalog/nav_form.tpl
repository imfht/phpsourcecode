          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              <tr>
                ...
                <td><input type="text" name="title" size="100" value="<?php echo $title ?>" /></td>
              </tr>
                <tr>
                <td><span class="required">*</span> 链接</td>
                <td><input type="text" name="url" size="100" value="<?php echo $url ?>" />
               </td>
              </tr>
               <tr>
                <td><span class="required">*</span> 标识</td>
                <td><input type="text" name="tid" size="50" value="<?php echo $tid ?>" /></td>
              </tr>
               <tr>
              <td>首页显示：</td>
