<?php if ($error_warning) { ?>
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><a onclick="$('form').attr('action', '<?php echo $approve; ?>'); $('form').submit();" class="btn"><span><?php echo $button_approve; ?></span></a> <a onclick="location = '<?php echo $insert; ?>'" class="btn  btn-primary"><span><?php echo $button_insert; ?></span></a> <a onclick="$('form').attr('action', '<?php echo $delete; ?>'); $('form').submit();" class="btn"><span><?php echo $button_delete; ?></span></a></div>
    </div>
    <div class="content">
          ...
          <thead>
            <tr>
              ...
              <?php if ($sort == 'c.firstname') { ?>
                <a href="<?php echo $sort_firstname; ?>" class="<?php echo strtolower($order); ?>">昵称</a>
                <?php } else { ?>
                <a href="<?php echo $sort_firstname; ?>">昵称</a>
                <?php } ?></td>
                
                 <td class="left">
              
              <?php if ($sort == 'c.telephone') { ?>
...
function filter() {
	...
	var filter_firstname = $('input[name=\'filter_firstname\']').attr('value');
