        ...
        <div id="tab-option">
          <table class="form">
            ...
            <tr>
             ...
             <tr>
              <td>是否开启微信云提醒<br>
              <span class="help">开启后请到服务配置-用户管理中填写用户的openid</span>
            </td>
              <td><?php if ($config_weixin_notice) { ?>
                <input type="radio" name="config_weixin_notice" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_weixin_notice" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_weixin_notice" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_weixin_notice" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
            </tr>
             <tr>
