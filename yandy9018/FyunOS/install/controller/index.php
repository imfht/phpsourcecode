...
if ($config->get('config_ssl')) {
	define('HTTPS_SERVER', 'https://www.shopliex.com/');
	define('HTTPS_IMAGE', 'https://www.shopliex.com/image/');
} else {
	define('HTTPS_SERVER', 'http://www.shopliex.com/');
	define('HTTPS_IMAGE', 'http://www.shopliex.com/image/');
}
