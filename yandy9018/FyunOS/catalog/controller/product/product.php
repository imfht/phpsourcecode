...
class ControllerProductProduct extends Controller {
	...
	$this->data['storeType'] = $this->config->get('config_store_type');
		...
		if ($product_info) {
			...
			$units = $this->model_localisation_unit->getUnit($product_info['unit']);
			$this->data['unit'] = $units['name'];
			...
			if ($product_info['image']) {
				$this->data['thumb'] = $product_info['image'].'!250list';
			} else {
				$this->data['thumb'] = "http://fyunimage.b0.upaiyun.com/no_image.jpg!250list";
			}
