...
class ControllerCheckoutCart extends Controller {
	public function index() {
		$this->session->data['track_url'] = $this->url->link('checkout/cart');
		//判断用户来自哪里
	...
	if(isset($this->data['zone_id'])){
		...
		if(!$this->cart->getProducts()){
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/nocart.tpl')) {
					$this->template = $this->config->get('config_template') . '/template/checkout/nocart.tpl';
				} else {
					$this->template = 'default/template/checkout/nocart.tpl';
				}
