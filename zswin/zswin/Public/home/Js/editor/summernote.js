...
(function (factory) {
      ...
      if (bKeepRatio) {
        ...
        imageSize = {
          ...
          height: ratio > newRatio ? pos.x * ratio : pos.y
        	//width: newRatio > 1 ? '100%' : 100*newRatio+'%',
        	//height: 'auto'
        };
      } else {
        imageSize = {
  ...
  var Renderer = function () {
    ...
    var tplButtonInfo = {
      ...
      color: function (lang) {
        var colorButtonLabel = '<i class="icon-font" style="color:black;background-color:yellow;"></i>';
      ...
      paragraph: function (lang) {
        ...
        var outdentButton = tplIconButton('icon-indent-right', {
          title: lang.paragraph.outdent,
          event: 'outdent'
        });
        var indentButton = tplIconButton('icon-indent-left', {
    ...
    var tplPopovers = function (lang, options) {
      var tplLinkPopover = function () {
        ...
        var content = '<a href="http://www.zswin.cn" target="_blank">zswin.cn</a>&nbsp;&nbsp;' +
      ...
      var tplImagePopover = function () {
        ...
        var roundedButton = tplIconButton('icon-sign-blank', {
          title: lang.image.shapeRounded,
          event: 'imageShape',
          value: 'img-rounded'
        });
        var circleButton = tplIconButton('icon-circle', {
          title: lang.image.shapeCircle,
          event: 'imageShape',
          value: 'img-circle'
        });
        var thumbnailButton = tplIconButton('icon-picture', {
          title: lang.image.shapeThumbnail,
          event: 'imageShape',
          value: 'img-thumbnail'
        });
        var noneButton = tplIconButton('icon-remove', {
    ...
    var tplDialogInfo = {
      ...
      help: function (lang, options) {
        var body = '<a class="modal-close pull-right" aria-hidden="true" tabindex="-1">' + lang.shortcut.close + '</a>' +
                   ...
                   '<p class="text-center">' +
                     '<a href="http://zswin.cn" target="_blank">zswin 2.5</a> · ' +
                     '<a href="http://zswin.cn" target="_blank">参与编辑器讨论</a> · ' +
