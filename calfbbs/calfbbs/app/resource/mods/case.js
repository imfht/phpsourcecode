      ...
      layer.open({
        ...
        ,content: ['<ul class="layui-form" style="margin: 20px;">'
          ,'<li class="layui-form-item">'
            ...
            ,'<div class="layui-input-block">'
              ,'<input required name="title" lay-verify="required" placeholder="插件名称" value="" class="layui-input">'
            ,'</div>'
          ,'</li>'
          ,'<li class="layui-form-item">'
            ,'<label class="layui-form-label">演示网址</label>'
            ,'<div class="layui-input-block">'
              ,'<input required name="link" lay-verify="url" placeholder="演示网址" value="" class="layui-input">'
            ,'</div>'
          ,'</li>'
          ,'<li class="layui-form-item">'
          ,'<label class="layui-form-label">插件描述</label>'
          ,'<div class="layui-input-block">'
          ,'<input required name="link" lay-verify="url" placeholder="插件描述" value="" class="layui-input">'
          ,'</div>'
          ,'</li>'
        ...
        ,success: function(layero, index){
          ...
          upload.render({
            ...
            ,done: function(res){
              if(res.status == 0){
                image.val('src',"{{_G['ATTACHMENT_ROOT']}}/"+res.data);
