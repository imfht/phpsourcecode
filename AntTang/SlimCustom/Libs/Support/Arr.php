...
namespace SlimCustom\Libs\Support;

use SlimCustom\Libs\Traits\Macroable;
...
class Arr
{
    ...
    /**
     * set an element to an array using "dot" notation if it doesn't exist.
     *
     * @param  array   $array
     * @param  string  $key
     * @param  mixed   $value
     ...
     * @return array
     */
    private static function _set(&$array, $key, $value)
    {
        if (is_null($key)) {
            return $array = $value;
        }
