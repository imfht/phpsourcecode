...
function register_administrator($db, $prefix, $admin, $auth)
{
    ...
    /*插入用户*/
    $sql = <<<sql
REPLACE INTO `[PREFIX]admin` ( `a_uname`, `a_passwd`, `a_email`, `a_create_time`, `a_status`) VALUES
...
sql;
    ...
    $sql = str_replace(
        ...
        array($prefix, $admin['username'], $password, $admin['email'], NOW_TIME),
        $sql);
...
sql;
    ...
    $sql = str_replace(
        ...
        array($prefix,'PWD_KEY', NOW_TIME, $auth),
        $sql);
