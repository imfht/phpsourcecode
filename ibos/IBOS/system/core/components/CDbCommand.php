<?php
/**
 * 这里复制一份 Yii 的 CDbCommand 类的原因是：
 * 需要重写 CDbCommand::prepare 方法，而 prepare 方法又需要修改私有属性 $_statement。
 * 使用继承方式无法修改私有属性，而使用反射的话，无法重新定义 prepare 方法（看起来 PHP runkit 扩展的 runkit_method_redefine 可以做到这个）
 * 
...
class CDbCommand extends CComponent
{
    ...
    // 主要改动就是把下面两个属性的访问属性从 private 改为 protected
