                                    ...
                                    <tr data-id="<?php echo $charge['assignmentid']; ?>">
                                        ...
                                        <td>
                                            ...
                                            <div class="fss">
                                                ...
                                                <?php if(!empty($charge['eventtitle']) && !empty($charge['eventurl'])) :?>
                                                    <a class="om-am-event mls" target="_blank" title="<?php echo $charge['eventtitle']; ?>" href="<?php echo $charge['eventurl']; ?>"></a>
                                                <?php endif; ?>
		...
		<!--												<img src="-->
                                        ...
                                        <td>
                                            ...
                                            <div class="fss">
                                                ...
                                                <?php if(!empty($designee['eventtitle']) && !empty($designee['eventurl'])) :?>
                                                    <a class="om-am-event mls" target="_blank" title="<?php echo $designee['eventtitle']; ?>" href="<?php echo $designee['eventurl']; ?>"></a>
                                                <?php endif; ?>
                                    ...
                                    <tr data-id="<?php echo $participant['assignmentid']; ?>">
                                        ...
                                        <td>
                                            ...
                                            <div class="fss">
                                                ...
                                                <?php if(!empty($participant['eventtitle']) && !empty($participant['eventurl'])) :?>
                                                    <a class="om-am-event mls" target="_blank" title="<?php echo $participant['eventtitle']; ?>" href="<?php echo $participant['eventurl']; ?>"></a>
                                                <?php endif; ?>
