    ...
    <div class="am-details-hd">
        ...
        <div class="am-details-hd-ct">
            ...
            <div class="am-details-prop clearfix">
                ...
                <?php if (!empty($assignment['eventurl']) || !empty($assignment['eventtitle'])) : ?>
                    <span class="ilsep fss">
                        <a href="<?php echo $assignment['eventurl']; ?>" class="opp-sub-ellipsis mlm" target="_blank" >
                        <i class="om-am-event-show mls"
                           title=""></i>
                        <?php echo $assignment['eventtitle']; ?></a>
                    </span>
                <?php endif; ?>
                <?php if ($isDesigneeuid || $isChargeuid): ?>
                    <span class="posr">
						...
						<ul class="dropdown-menu" id="task_op_menu">
                            ...
                            <li data-node="remind">
                                <a href="javascript:;" data-action="openRemindDialog"
                                   data-param='{"id": <?php echo $assignment['assignmentid'] ?>, "title": "<?php echo $assignment['subject']; ?>"}'><i
