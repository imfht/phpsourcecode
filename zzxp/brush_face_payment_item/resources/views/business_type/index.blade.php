...
<script type="text/javascript">
    ...
    function edit_func(id){
        ...
        sendData('{{url('admin/business-type/edit')}}','id='+id,function(obj){
    ...
    function sure_add(id){
        ...
        send_request('{{url('admin/business-type/add')}}',get_form_data(id),function(msg){
            if(msg != 1){
    ...
    function sure_edit(id){
        send_request('{{url('admin/business-type/update')}}',get_form_data(id),function(msg){
            if(msg != 1){
                show_message.alert(msg);
            }else{
                location.reload();
    ...
    function del_sub(){
        ...
        show_message.confirm('您确定要删除吗？',function(){
            send_request('{{url('admin/business-type/del')}}',query.join('&'),function(msg){
                if(msg != 1){
                    show_message.alert(msg);
                }else{
                    location.reload();
...
<section >
    ...
    <div class="text-c mt-20">
        <form>
            ...
            <input type="text" name="id" style="width:126px" class="input-text" value="{{isset($search['id']) ? $search['id'] :'' }}" placeholder="行业配置编号" />
    ...
    <form name="delform" action="{{ url('admin/business_type/del')}}" method="post">
    <div class="panel-body">
      <table class="table table-border table-bordered table-striped mt-20">
        ...
        <tbody>
            ...
            <?php
            $index = 1;
            foreach($business_type as $line){ $index ++; ?>
            <tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content radius">
      <div class="modal-header">
        <h3 class="modal-title">行业配置修改</h3>
      ...
      <div class="modal-body">
		...
		<div class="row cl">
                          ...
                          <div class="formControls col-xs-8">
                            <input type="text" class="input-text" name="name" placeholder="名称" name="username" id="username">
                          </div>
                        </div>
          </form>
      </div>
