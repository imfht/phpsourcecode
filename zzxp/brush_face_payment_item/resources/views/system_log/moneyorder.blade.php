...
@section('content')
    ...
    <section >
        <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i>日志管理<span class="c-999 en">&gt;</span>支付记录</nav>
        <div class="text-c mt-20">
            <form>
                <input type="text" name="member_id" style="width:150px" class="input-text" value="{{$member_id}}" placeholder="会员ID" />

                充值方式： <span class="select-box inline">
                ...
                充值状态： <span class="select-box inline">
                    <select name="operation_status" class="select">
                        <option value="" selected>全部</option>
                        <option value=1 @if($operation_status==1) selected @endif >成功</option>
                        <option value=2 @if($operation_status==2) selected @endif >失败</option>
                        {{--<option value=3 @if($operation_status==3) selected @endif >其它</option>--}}
                    </select>
                </span>
                日期范围：
                ...
                <div class="panel-body">
                    <table class="table table-border table-bordered table-striped mt-20">
                        ...
                        <tr>
                            ...
                            <td>{{date('Y-m-d H:i:s',$line['pay_time'])}}</td>
