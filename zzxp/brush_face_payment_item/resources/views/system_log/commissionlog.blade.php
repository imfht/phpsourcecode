...
@section('content')
    ...
    <section >
        <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i>日志管理<span class="c-999 en">&gt;</span>佣金记录</nav>
                ...
                <div class="panel-body">
                    <table class="table table-border table-bordered table-striped mt-20">
                        ...
                        <tr>
                            ...
                            <td>{{$line['type'] == 1 ? '消费订单':($line['type'] == 2 ? '充值订单': ($line['type'] == 3 ? '运营商订单':'代理商订单'))}}</td>
                            <td>{{$line['member_type'] == 1 ? '运营商' : ($line['member_type'] == 2 ? '二级代理商' : '省级代理商')}}</td>
                            <td>{{$line['money']}}</td>
