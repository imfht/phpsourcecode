...
@section('content')
    ...
    <section >
        <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i>日志管理<span class="c-999 en">&gt;</span>故障记录</nav>
        <div class="text-c mt-20">
            <form>
                <input type="text" name="pile_id" style="width:150px" class="input-text" value="{{$pile_id}}" placeholder="桩ID" />
                日期范围：
                ...
                <div class="panel-body">
                    <table class="table table-border table-bordered table-striped mt-20">
                        ...
                        <tr>
                            <td>{{$line['id']}}</td>
                            <td>{{$line['pile_id']}}</td>
                            <td>{{$line['warn_temperature']}}</td>
                            <td>{{$line['warn_number']}}</td>
                            <td>{{$line['warn_quality']}}</td>
                            <td>{{$line['remark']}}</td>
