...
@section('content')
    ...
    <section >
        <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i>日志管理<span class="c-999 en">&gt;</span>售后记录</nav>
        <div class="text-c mt-20">
            <form>
                <input type="text" name="member_id" style="width:150px" class="input-text" value="{{$member_id}}" placeholder="会员ID" />
                <input type="text" name="pile_id" style="width:150px" class="input-text" value="{{$pile_id}}" placeholder="水站ID" />
                日期范围：
                ...
                <div class="panel-body">
                    <table class="table table-border table-bordered table-striped mt-20">
                        ...
                        <tr>
                            ...
                            <td>
                                水站编号:{{$line['pile_id']}}<br />
                                水站名称:{{$line['title']}}<br />
                                水站地址:{{$line['address']}}<br />
                            </td>                            
                            <td>{{$line['partner_id']}}</td>
