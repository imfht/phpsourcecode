myFocus.pattern.extend({//*********************kiki******************
	'mF_kiki':function(settings,$){
		...
		var $navBox=$focus.addHtml('<div class="__nav"><a class="__prev">PREV</a><span>|</span><a class="__next">NEXT</a></div>');
		var $prevBtn=$navBox.find('.__prev');
		var $nextBtn=$navBox.find('.__next');
		//CSS
