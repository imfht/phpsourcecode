myFocus.pattern.extend({//*********************mF_slide3D******************
	'mF_slide3D':function(settings,$){
		...
		var $m11=$focus.addHtml('<div class="__mask11"></div>');
		var $m12=$focus.addHtml('<div class="__mask12"></div>');
		var $m21=$focus.addHtml('<div class="__mask21"></div>');
		var $m22=$focus.addHtml('<div class="__mask22"></div>');
		var $nextBtn=$focus.addHtml('<div class="__next"><a href="javascript:;">NEXT</a></div>');
		//PLAY
