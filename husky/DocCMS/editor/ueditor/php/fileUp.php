 ...
 */
session_start();
require_once dirname(__FILE__).'/../../../config/doc-config.php';
...
$url = ROOTPATH.'/'.strrchr( $fileName , 'upload' );
//向浏览器返回数据json数据
echo '{"state":"' . $state . '","url":"' . $url . '","fileType":"' . $current_type . '","original":"'.$clientFile["name"] .'"}';
?>
