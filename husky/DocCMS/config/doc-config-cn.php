...
define('WEBURL','www.doccms.cn');    //PC 域名
define('MOBILEURL','m.doccms.cn');  //移动域名
...
define('STYLENAME','web');      //PC 模板
define('MOBILENAME','wap');      //移动模板
...
//系统开始运行时间
define('doccmsbirthday','2012-12-27');//此处如无需要请不要随意更改，否则将无法正常运行
//编辑器
...
define('smtpPort','');
define('smtpServer','');
define('smtpId','grysoft');
define('smtpPwd','123456');
define('smtpSender','');
define('smtpReceiver','');
//支付宝设置
define('PAY_ISPAY','0');
