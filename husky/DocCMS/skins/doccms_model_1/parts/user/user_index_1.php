...
<div class="admin_index">
  ...
  <div class="admin_menu">
    <ul>
      <li class="hover"><a href="<?php echo sys_href($params['id'],'user')?>">中心首页</a></li>
  ...
  <div class="admin_main">
    ...
    <div class="inad">
      <ul>
        <li><span></span><a href="<?php echo sys_href($params['id'],'user','guestbook')?>">留言管理</a>
          <p>您收到了<b>(<?php echo info_num('replay')?>)</b>条回复</p>
        </li>
        <li><span class="in2"></span><a href="<?php echo sys_href($params['id'],'user','comment')?>">查看评论</a>
          <p>您一共发表了<b>(<?php echo info_num('comment')?>)</b>条评论。</p>
        </li>
        <li><span class="in3"></span><a href="<?php echo sys_href($params['id'],'user','edit')?>">基本资料</a>
          <p>修改和更新您的个人资料。</p>
        </li>
      </ul>
    </div>
