...
#piclist ul li{ list-style:none; float:left; background:url(<?php echo $tag['path.skin']; ?>res/images/picli_bg.png) 10px 6px no-repeat; width:210px; padding:10px 0 0 15px;}
