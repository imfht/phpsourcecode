...
#lmnx li{ padding:5px 10px; border:1px solid #ccc; display:block; margin:0 15px 0 0; font-size:12px; cursor:pointer;}
...
<form name="form1" id="form1" method="post"  enctype="multipart/form-data" action="?m=system&s=managechannel&a=create&pid=<?php echo $request['pid'] ?>&cid=<?php echo $request['cid'] ?>&deep=<?php echo $request['deep'] ?>">
  <input type="hidden" name="isExternalLinks" id="isExternalLinks" value="0">
  <input type="hidden" name="related_common" id="related_common" value="common.php">
  <input type="hidden" name="level" id="level" value="0">
  <input type="hidden" name="isTarget" id="isTarget" value="0">
    ...
    <div class="menu_main" id="menu_main1">
      <div class="dex block">
        ...
        <div class="one relist">
          <h4>外链URL地址：</h4>
          <input type="text" class="textinput hdbt" name="redirectUrl" id="redirectUrl" value="" style="width:89%">
        ...
        <div class="hidd relist">
          <h4>栏目样式：</h4>
          <div class="select"> <span onclick="showSelect(this,'sub_list')" id="sel1">默认样式</span>
        ...
        <div class="hidd relist">
          <h4>权限：</h4>
          <div class="select"> <span onclick="showSelect(this,'sub_list2')" id="sel2">匿名</span>
        ...
        <div class="hidd relist">
          ...
          <div id="showtips3" style="display:none;" class="tip-bubble tip-bubble-left">[温馨提示:如果您创建的频道是留言、招聘、订单、网站地图模块请不要开启评论]</div>
        </div>
        <div class="relist">
          <h4>排序：</h4>
          <input type="text" class="textinput" name="ordering" id="ordering" value="0" style="width:24px">
