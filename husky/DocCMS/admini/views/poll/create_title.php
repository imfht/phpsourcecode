...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="admintb">
 <form name="form1" method="post" action="./index.php?a=create_title&p=<?php echo $request['p'] ?>">
  <tr class="adtbtitle">
    <td width="892"><h3>添加投票主题：</h3><a href="javascript:history.back(1)" class="creatbt">返回</a> </td>
