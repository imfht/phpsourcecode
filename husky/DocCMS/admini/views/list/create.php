...
.tcolor{width:22px;height:20px;display:block; float:left; margin:0 10px;}
        ...
        <input type="hidden" name="sytle_color" id="sytle_color" value="">
        <input type="hidden" name="sytle_font_b"  id="sytle_font_b"  value="">
        <input type="hidden" name="sytle_font_i"  id="sytle_font_i"  value="">
        <table width="96%" border="0" align="center" cellpadding="0" cellspacing="4">
          <tr>
            <td width="77"><span id="titleColor" style="font-size:16px;">标题样式</span></td>
          ...
          <tr>
            <td width="57">标题</td>
            <td width="90%"><input type="text" class="txt" name="title" id="title" style="width:96%">
          ...
          <tr>
            <td width="57">来源名称</td>
            <td><input type="text" name="source" class="txt" id="source" style="width:96%"></td>
          </tr>
		  <tr>
            <td width="57">来源链接</td>
            <td><input type="text" name="sourceUrl" class="txt" id="sourceUrl" style="width:96%"></td>
          </tr>
          <tr>
		  ...
		  echo ewebeditor(EDITORSTYLE,'content',$list_item->content);
		  ?></td>
          </tr>
          <tr>
            <td width="57">点击次数</td>
            <td width="175"><input type="text" name="counts" class="txt" id="counts" value="0" style="width:80%">
              次</td>
          </tr>
          <tr>
            <td width="57">添加日期</td>
            <td width="200"><input type="text" name="dtTime" class="txt" id="dtTime" value="<?php echo date("Y-m-d H:i:s");?>" style="font-size:9pt;width:152px; border:#6CF 2px solid;" onClick="WdatePicker()"></td>
          </tr>
          <tr>
