  ...
  <table width="100%" border="0" cellpadding="2" cellspacing="1" class="admintb">
    ...
    <tr>
      <td colspan="2" bgcolor="#FFFFFF"><table width="96%" border="0" align="center" cellpadding="0" cellspacing="4">
          <tr>
            <td width="57">链接类型</td>
            <td colspan="2" valign="top"><input type="radio" checked="checked" value="0" id="links" onclick="javascript:pictureLinks();" name="links" />
              图片链接
          ...
          <tr>
            ...
            <td width="861"><input type="text" class="txt" name="title" id="title" style="width:30%"></td>
          </tr>
          <tr>
            <td width="57">链接地址</td>
          ...
          <tr id="logo_pics">
            ...
            <td><input name="originalPic" class="txt" type="text"  style="width:50%">
          ...
          <tr>
            ...
            <td><?php echo ewebeditor(EDITORSTYLE,'description',$oFCKeditor->description); ?></td>
          </tr>
        </table></td>
    </tr>
  </table>
