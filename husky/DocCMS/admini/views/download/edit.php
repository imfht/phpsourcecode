  ...
  <table width="100%" border="0" cellpadding="2" cellspacing="1" class="admintb">
    ...
    <tr>
      <td colspan="2" bgcolor="#FFFFFF"><table width="96%" border="0" align="center" cellpadding="0" cellspacing="4">
          <tr>
            <td width="57">软件名称</td>
            <td width="861"><input type="text" class="txt" value="<?php echo $download_item->title ?>" name="title" id="title" style="width:96%"></td>
          </tr>
          <tr>
            <td width="57">软件 更新</td>
            <td><input name="filePath" id="filePath" type="text"  value="<?php echo $download_item->filePath ?>" style="width:50%">
              ...
              <span id="picTips">[可直接贴入在线链接，例：http://www.doccms.com/doccms.rar]</span> <span class="picture">当您重新从本地上传软件时，原来的软件将被删除。</span></td>
          </tr>
          <tr>
              ...
              <div id="field_pane_on_2" style="display: none; padding:0; margin:0;">
                <table width="100%" border="0" align="center" cellpadding="0">
                  <tr>
                    ...
                    <td width="861"><textarea style='width:400px;' name='keywords' id='keywords' cols='90' rows='3'><?php echo $download_item->keywords ?></textarea></td>
                  </tr>
                  <tr>
                    <td> 页面摘要：</td>
                    <td><textarea style='width:400px;' name='description' id='description' cols='90' rows='3'><?php echo $download_item->description ?></textarea></td>
                  </tr>
                </table>
              </div></td>
          </tr>
