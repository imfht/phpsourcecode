...
class Encrypt
{
    ...
    private $_key = 'tomandjerry';

    public function encode ($str)
    {
        return $this->encryptCode($str, "E", $this->_key);
    }

    public function decode ($str)
    {
        return $this->encryptCode($str, "D", $this->_key);
    }

    private function encryptCode ($string, $operation, $key = '')
    {
        $key = md5($key);
