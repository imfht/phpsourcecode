require.config({
    ...
    paths: {
        ...
        'bootstrap.typeahead': '../lib/bootstrap3-typeahead.min',
        ...
        'editor': '../../components/editor/summernote-zh-CN',
        'css': '../lib/css.min'
    },
    shim:{
        'jquery.ui': {
        ...
        'editor': {
            deps: ['../../components/editor/summernote', 'css!../../components/editor/summernote.css']
        },
        '../../components/editor/summernote' : {
            deps: ['bootstrap']
        },
        'map': {
            exports: 'BMap'
