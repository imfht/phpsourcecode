...
<div class="container">
  ...
  <div class="modules">
    ...
    <div class="row">
      <div class="col-sm-12 text-center">
        <a class="btn btn-default" href="http://opencart.cn/app" target="_BLANK"><?php echo $text_store; ?></a>
      </div>
    </div>
  </div>
  ...
  <div class="support text-center">
    <div class="row">
      ...
      <div class="col-sm-4">
        <a href="http://opencart.cn/forum.php" class="icon transition">
          <i class="fa fa-comments fa-4x"></i>
        </a>
        <h3><?php echo $text_forum; ?></h3>
        <p><?php echo $text_forum_info; ?></p>
        <a href="http://opencart.cn/forum.php"><?php echo $text_forum_link; ?></a>
      </div>
      <div class="col-sm-4">
        <a href="http://opencart.cn/app/information/contact" class="icon transition">
          <i class="fa fa-user fa-4x"></i>
        </a>
        <h3><?php echo $text_commercial; ?></h3>
        <p><?php echo $text_commercial_info; ?></p>
        <a href="http://opencart.cn/app/information/contact" target="_BLANK"><?php echo $text_commercial_link; ?></a>
      </div>
    </div>
  </div>
</div>
