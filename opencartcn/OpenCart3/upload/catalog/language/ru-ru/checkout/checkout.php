...
$_['text_shipping_not_required'] = 'Для этого заказа доставка не требуется.';
$_['text_more'] = 'Все адреса';
$_['text_step_1'] = '1. Корзина';
$_['text_step_2'] = '2. Отправить заказ';
$_['text_step_3'] = '3. Оплата';
$_['text_order_id'] = 'Номер заказа:';
$_['text_checkout_pickup'] = 'Выберите пункт приема';
$_['text_no_pickup'] = 'Станция без пикапа';
$_['text_checkout_if_pickup'] = 'Самовывоз / доставка';
$_['text_pickup'] = 'Подобрать';
$_['text_shipping'] = 'Перевозка';
$_['column_image'] = 'Образ';
$_['entry_fax'] = 'факс';
$_['entry_location'] = 'Место нахождения';
$_['entry_county'] = 'округ';
$_['entry_default'] = 'По умолчанию';
$_['error_address_not_exist'] = 'Внимание: адрес доставки не найден, используйте другой адрес.';
$_['error_payment_unavailable'] = 'Внимание: выбранный способ оплаты недоступен!';
$_['error_shipping_unavailable'] = 'Внимание! Выбранный способ доставки недоступен!';
$_['error_recharge_cannot_checkout_with_product'] = 'Ошибка: пополнение и обычные товары не могут оформить заказ в одном заказе.';
$_['error_nework'] = 'Сеть отключена, попробуйте позже.';
$_['warning_login'] = 'Пожалуйста, войдите, чтобы продолжить';
$_['error_county'] = 'Пожалуйста, выберите район и округ!';
$_['error_pickup'] = 'Пожалуйста, выберите свою точку зрения!';
$_['text_coupon'] = 'Купон';
$_['text_coupon_list'] = 'Выберите купон';
$_['text_coupon_input'] = 'Используйте код';
$_['text_coupon_empty'] = 'Купон недоступен';
$_['text_coupon_free_shipping'] = '(бесплатная доставка)';
$_['button_coupon'] = 'использование';
$_['entry_coupon'] = 'Введите код купона';
$_['entry_coupon_valid'] = 'Действительно:';
$_['entry_coupon_total'] = 'Подтвердить для общего числа более% s';
$_['error_coupon_unavailable'] = 'Внимание: код купона недоступен!';