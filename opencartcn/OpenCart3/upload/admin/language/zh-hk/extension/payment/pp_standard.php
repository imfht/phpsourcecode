...
$_['help_notice']                    = '請注意：當前台使用貨幣不是以下幾種時，PayPal Payments Standard 支付方式無效。 (AUD、CAD、EUR、GBP、JPY、USD、NZD、CHF、HKD、SGD、SEK、DKK、PLN、NOK、HUF、CZK、ILS、MXN、MYR、BRL、PHP、TWD、THB、TRY、RUB)';
