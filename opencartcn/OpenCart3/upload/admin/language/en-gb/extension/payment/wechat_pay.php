...
$_['text_edit']                      = 'Edit Wechat QR Code Pay';
$_['text_wechat_pay']                = '<a target="_BLANK" href="https://pay.weixin.qq.com"><img src="view/image/payment/wechat.png" alt="Wechat QR Code Pay Website" title="Wechat QR Code Pay Website" style="border: 1px solid #EEEEEE;" /></a>';
...
$_['help_wechat_pay_setup']          = '<a target="_blank" href="http://www.opencart.cn/docs/wechat-pay">Click here</a> to learn how to set up Wechat QR Code Pay account.';
