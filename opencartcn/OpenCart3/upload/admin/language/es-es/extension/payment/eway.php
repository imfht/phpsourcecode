<?php
// Heading
$_['heading_title']					= 'Pago con eWAY';

// Text
$_['text_extension']	            = 'Extensiones';
$_['text_success']					= 'Correcto: Ha modificado los detalles de eWAY.';
...
$_['text_authorisation']			= 'Autorizacion';
$_['text_sale']						= 'Venta';
$_['text_transparent']				= 'Redireccionamiento transparente (formulario de pago en el sitio)';
$_['text_iframe']					= 'IFrame (forma de pago en ventana)';
...
$_['entry_order_status_fraud']		= 'Sospecho estado de orden de fraude';
$_['entry_status']					= 'Estado';
$_['entry_username']				= 'Clave eWAY API';
$_['entry_password']				= 'eWAY password';
$_['entry_payment_type']			= 'Tipo de pago';
$_['entry_geo_zone']				= 'Geo Zona';
$_['entry_sort_order']				= 'Posicion';
$_['entry_transaction_method']		= 'Metodo Transaccion';

// Error
$_['error_permission']				= 'Importante: No dispone de permisos para modificar pago eWAY.';
$_['error_username']				= 'Clave eWAY API requerida.';
$_['error_password']				= 'eWAY password requerido.';
$_['error_payment_type']			= 'Al menos un tipo de pago es requerido.';
