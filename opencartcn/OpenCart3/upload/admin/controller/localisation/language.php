...
class ControllerLocalisationLanguage extends Controller {
    ...
    public function install()
    {
        ...
        if ($languageCode && $this->validateInstall()) {
    ...
    protected function getList() {
        ...
        foreach ($results as $result) {
            $result['name'] = $result['name'] ? $result['name'] : $result['code'];
            $data['languages'][] = array(
                ...
                'lang_name'   => $result['name'] . (($result['code'] == $this->config->get('config_language')) ? $this->language->get('text_default') : null),
                'code'        => $result['code'],
