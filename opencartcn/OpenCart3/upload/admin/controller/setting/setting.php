...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
        ...
        $data['calling_codes'] = $this->model_localisation_calling_code->getCallingCodes();

        if (isset($this->request->post['config_calling_code'])) {
            $data['config_calling_code'] = $this->request->post['config_calling_code'];
        } else {
            $data['config_calling_code'] = $this->config->get('config_calling_code');
        }
