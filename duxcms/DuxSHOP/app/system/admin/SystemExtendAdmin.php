    ...
    public function pageData($sumLimit, $pageLimit) {
        ...
        $html = '
            <div class="foot-pages">
                ...
                <div class="pages-num">
                    <a class="uk-button uk-button-primary uk-button-small" href="{prevUrl}"><i class="fa fa-chevron-left"></i></a>
                    <a class="uk-button uk-button-primary uk-button-small" href="{nextUrl}"><i class="fa fa-chevron-right"></i></a>
                </div>
                <form class="page-jump dux-form uk-form  uk-form-inline" data-pages>
                    跳转到
                    <input type="text" class="uk-form-small" name="page" value="{current}">
                    <button class="uk-button uk-button-primary uk-button-small" type="submit">GO</button>
                </form>
            </div>
        ';
