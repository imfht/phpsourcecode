...
class SearchMobile extends \app\base\mobile\SiteMobile {
    ...
    public function index() {
        target($this->_middle, 'middle')->setParams($this->urlParams)->meta(urldecode($this->urlParams['keyword']) .' - 商品搜索', '商品搜索', url('index', ['keyword' => urldecode($this->urlParams['keyword'])]))->data()->filter()->export(function ($data) {
            $this->assign($data);
