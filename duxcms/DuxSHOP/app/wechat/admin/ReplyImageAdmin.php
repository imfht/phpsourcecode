...
class ReplyImageAdmin extends \app\system\admin\SystemExtendAdmin {
    ...
    public function _editAssign($info) {
        ...
        $materialInfo = target('wechat/WechatMaterialImage')->getWhereInfo($where);
