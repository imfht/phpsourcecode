...
class IndexController extends \dux\kernel\Controller {
    ...
    public function install() {
        ...
        if($data['demo']) {
            $this->msg('开始读取演示数据...');
            $class = json_decode(file_get_contents(ROOT_PATH . '/app/install/data/class.json'), true);
            $content = json_decode(file_get_contents(ROOT_PATH . '/app/install/data/content.json'), true);
