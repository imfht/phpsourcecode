...
class AlipayController extends \app\base\controller\SiteController {
    ...
    public function index() {
        ...
        //扫码支付
        $notifyUrl = url('api/member/AlipayWeb/index', [], true);

        $config = target('member/AlipayWeb', 'pay')->getConfig($notifyUrl);
        ...
        try {
            \Yansongda\Pay\Pay::alipay($config)->web($payData)->send();
        } catch (\Exception $e) {
