                    ...
                    <div class="col-lg-12">
                        <table class="table table-hover syc-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    {eq name="$vo.pshoudj" value="1"}
									<a href="{:Url('schedule/view',['pid'=>$vo.pnumber])}" target="_blank">查看</a>
                                    <span class="text-explode">|</span>
                                    <code>待付余款</code>
                                    {/eq}
                                    {eq name="$vo.pshoudj" value="2"}
									<a href="{:Url('schedule/delivery',['pid'=>$vo.pnumber])}" target="_blank">查看</a>
                                    <span class="text-explode">|</span>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#product-finance-fahuo").addClass("active"); // 小分类
        ...
        $("#searchprojectName").on('click keyup', function () {
            ...
            if (NameInput.length < '2' || NameInput.length > '16') {
                ...
                window.location.href="{:Url('finance/fahuo',['m'=>'pnumber'])}?k="+NameInput;
            }
        });
    });
</script>
