                        ...
                        <form action="" id="addOrdersForm" name="addOrdersForm" method="post">
                            ...
                            <table class="table syc-table border order">
                                ...
                                <tr>
                                    ...
                                    <td>￥{$vo.st_lid.lprice}</td>
                                    <td><input type="text" class="form-control" name="st_quantity[{$vo.stid}]" id="RowsSpid-{$vo.stid}" placeholder="{$vo.st_quantity}"></td>
                                </tr>
                                {/volist}
