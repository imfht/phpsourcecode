                        ...
                        <div class="portlet margin-top-3">
                            <form class="form-horizontal" method="post" id="form1">
                                <div class="form-group">
                                    <label for="blname" class="col-sm-2 control-label"><span class="text-danger">*</span>编号</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control w300" name="blname" id="blname" placeholder="输入编号">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="bguige" class="col-sm-2 control-label"><span class="text-danger">*</span>规格</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control w300" name="bguige" id="bguige" placeholder="输入如：860*2050">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">图形</label>
                                    <div class="col-sm-8">
                                        <input id="input-4" name="blimg" type="file" multiple class="file-loading form-control input-circle-right">
                                    </div>
                                </div>
    ...
    $(document).ready(function() {
        ...
        $("#form1").validate({
            ...
            rules: {
                ...
                bguige: {required: true},
            },
            messages: {
                blname: {remote:'已存在板材名称'},
            },
            focusInvalid: true,
            onkeyup: false,
            errorElement: 'label',
