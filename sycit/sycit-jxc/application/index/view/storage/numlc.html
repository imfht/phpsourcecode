                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <table class="table syc-table border order">
                            <thead>
                            <tr>
                                <th width="60" rowspan="2">型号</th>
                                <th width="80" rowspan="2">铝材名称</th>
                                <th width="80" rowspan="2">当前总数</th>
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control" name="sp_quantity[{$sun.sp_id}]" id="RowsSpid-{$sun.sp_id}" placeholder="{$sun.sp_quantity}"></td>
                                {/volist}
                            </tr>
                            {/volist}
