                    ...
                    <div class="col-lg-12">
                        <table class="table syc-table border">
                            ...
                            <tr>
                                ...
                                <td>
                                    {if condition="$sun.bquantity gt 20"}
                                    <b style="color: #5cb85c;">{$sun.bquantity}</b>
                                    {else/}
                                    {between name="$sun.bquantity" value="11,20"}
                                    <b style="color: #fca103;">{$sun.bquantity}</b>
                                    {else/}
                                    <b style="color: #fc0303;">{$sun.bquantity}</b>
                                    {/between}
                                    {/if}
                                </td>
                                {/volist}
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#storage-nav-bancainum").addClass("active"); // 小分类
