                    ...
                    <div class="col-lg-12">
                        <div class="portlet margin-top-3">
                            <form class="form-horizontal" method="post" id="form1">
                                <input type="hidden" name="pid" value="{$data.blid}">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">编号</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control w300" value="{$data.blname}" disabled>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="bguige" class="col-sm-2 control-label"><span class="text-danger">*</span>规格</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control w300" name="bguige" id="bguige" placeholder="输入如：860*2050" value="{$data.bguige}">
                                    </div>
                                </div>
                                <div class="form-group">
