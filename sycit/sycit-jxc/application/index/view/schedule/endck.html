                    ...
                    <div class="col-lg-12">
                        <div class="console-title console-title-border clearfix">
                            ...
                            <div class="pull-right">
                                <a href="{:Url('schedule/endck')}" class="btn btn-default">
                    ...
                    <div class="col-lg-12">
                        <table class="table table-hover syc-table">
                            ...
                            <tr>
                                ...
                                <td>{$vo.pend_date}</td>
                                <td>{:Shengchanzq($vo.pstart_date,$vo.pend_date)}</td>
                                <td><a href="{:Url('schedule/delivery',['pid'=>$vo.pnumber])}" target="_blank">查看</a>
                                </td>
                            </tr>
                            {/volist}
                            </tbody>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#schedule-chuku").addClass("active"); // 小分类
        ...
        $("#searchprojectName").on('click keyup', function () {
            ...
            if (NameInput.length < '2' || NameInput.length > '16') {
                ...
                window.location.href="{:Url('schedule/endck',['m'=>'pnumber'])}?k="+NameInput;
            }
        });
    });
</script>
