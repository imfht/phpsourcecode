                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="portlet margin-top-3">
                            <form class="form-horizontal" method="post" id="form1" method="post">
                                <input type="hidden" name="pid" value="{$data.msid}">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control w300 fleft" name="ms_pnid" id="ms_pnid">
                                            ...
                                            <option value="{$vo.pn_name}" {eq name="$vo.pn_name" value="$data.ms_pnid"} selected{/eq}>{$vo.pn_name}</option>
                                            {/volist}
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control w300 fleft" name="ms_blname" id="ms_blname">
                                            ...
                                            <option value="{$vo.blname}" {eq name="$vo.blname" value="$data.ms_blname"} selected{/eq}>{$vo.blname}</option>
                                            {/volist}
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control w300 fleft" name="ms_maname" id="ms_maname">
                                            ...
                                            <option value="{$vo.ma_name}" {eq name="$vo.ma_name" value="$data.ms_maname"} selected{/eq}>{$vo.ma_name}</option>
                                            {/volist}
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control w300 fleft" name="ms_baobian" id="ms_baobian">
                                            ...
                                            <option value="单包边" {eq name="$data.ms_baobian" value="单包边"} selected{/eq}>单包边</option>
                                            <option value="双包边" {eq name="$data.ms_baobian" value="双包边"} selected{/eq}>双包边</option>
                                        </select>
                                        <span class="form-span">单包或双包</span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">料型</label>
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            <div class="icheck-list">
                                                {volist name="$liaox" id="vo" empty="<label>暂无数据</label>"}
                                                <div class="list"><label><input type="checkbox" name="liaox[{$vo.lxid}]" class="icheck" {eq name="$vo.on" value="$vo.lxid"} checked{/eq}> {$vo.lxname}</label> <span> 数量 </span><input type="text" name="name[{$vo.lxid}]" value="{$vo.val}"></div>
                                                {/volist}
                                            </div>
                                        </div>
                                    </div>
