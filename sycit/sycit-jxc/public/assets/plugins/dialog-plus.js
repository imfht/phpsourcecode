    ...
    return function(t) {
        ...
        function(t, e, o) {
            ...
            (function(t) {
                ...
                function l(t, e) {
                    if (u(e), t = n(t, e < 0 ? 0 : 0 | g(e)), !a.TYPED_ARRAY_SUPPORT)
                ...
                function q(t, e) {
                    ...
                    for (var o, r = t.length, i = null, n = [], a = 0; a < r; ++a) {
                        ...
                        } else i && (e -= 3) > -1 && n.push(239, 191, 189); if (i = null, o < 128) {
                            if ((e -= 1) < 0) break;
                            n.push(o)
                        } else if (o < 2048) {
                            if ((e -= 2) < 0) break;
                ...
                e.Buffer = a, e.SlowBuffer = b, e.INSPECT_MAX_BYTES = 50, a.TYPED_ARRAY_SUPPORT = void 0 !== t.TYPED_ARRAY_SUPPORT ? t.TYPED_ARRAY_SUPPORT : r(), e.kMaxLength = i(), a.poolSize = 8192, a._augment = function(t) {
                    ...
                    for (var n = i - r, s = o - e, u = Math.min(n, s), f = this.slice(r, i), l = t.slice(e, o), p = 0; p < u; ++p)
                        if (f[p] !== l[p]) {
                            n = f[p], s = l[p];
                            break
                        }
                ...
                a.prototype.slice = function(t, e) {
                    ...
                    } else "number" == typeof t && (t &= 255); if (e < 0 || this.length < e || this.length < o) throw new RangeError("Out of range index");
                    if (o <= e) return this;
        ...
        function(t, e, o) {
            var r = o(0),
                i = r(window),
                n = r(document),
                a = "createTouch" in document,
                s = document.documentElement,
                u = !("minWidth" in s.style),
                f = !u && "onlosecapture" in s,
                l = "setCapture" in s,
                p = {
            ...
            c.types = p, c.prototype = {
                ...
                var o, a, s, u, f = r(t),
                    l = new c,
                    p = c.types.start,
                    h = function() {}, d = t.className.replace(/^\s|\s.*/g, "") + "-drag-start",
                    g = {
                        onstart: h,
                        onover: h,
                        onend: h,
                ...
                return l.onstart = function(e) {
                    ...
                    var b = f.offset(),
                        w = this.startLeft = r ? b.left - l : b.left,
                        v = this.startTop = r ? b.top - p : b.top;
                    this.clientX = e.clientX, this.clientY = e.clientY, f.addClass(d), g.onstart.call(t, e, w, v)
                }, l.onover = function(e) {
                    var r = e.clientX - this.clientX + this.startLeft,
                        i = e.clientY - this.clientY + this.startTop,
                        n = f[0].style;
        ...
        function(t, e, o) {
            ...
            i.oncreate = function(t) {
                ...
                }, !1), t.content(e[0]), t.iframeNode = e[0]), !(i instanceof Object))
                    for (var u = function() {
                        t.close().remove()
                ...
                if (t && t.frameElement) {
                    var e, o = t.frameElement,
                        r = i.list;
                    for (var n in r)
                        if (e = r[n], e.node.getElementsByTagName("iframe")[0] === o) return e
