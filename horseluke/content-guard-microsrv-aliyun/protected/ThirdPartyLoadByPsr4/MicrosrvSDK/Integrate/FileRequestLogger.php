<?php
namespace MicrosrvSDK\Integrate;

use MicrosrvSDK\Base\CurlRequestLoggerInterface;
use MicrosrvSDK\Base\Response;
...
class FileRequestLogger implements CurlRequestLoggerInterface{
    ...
    protected $cfg_logFilePrefix = 'defaultMicrosrvSDK_';
