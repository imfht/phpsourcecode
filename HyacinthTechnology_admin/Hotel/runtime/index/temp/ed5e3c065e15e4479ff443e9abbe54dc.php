<?php /*a:3:{s:51:"D:\phpstudy_pro\WWW\tp\view\index\admins\index.html";i:1601007759;s:52:"D:\phpstudy_pro\WWW\tp\view\index\common\static.html";i:1591060588;s:55:"D:\phpstudy_pro\WWW\tp\view\index\common\resources.html";i:1591061599;}*/ ?>
<!DOCTYPE html>
                            ...
                            <table class="layui-table layui-form">
                                ...
                                <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        ...
                                        <td><?php echo htmlentities($vo['surname']); ?></td>
                                        ...
                                        <td class="td-manage">
                                            <a title="查看" onclick="xadmin.open('编辑','/index/admins/edits/id/'+<?php echo htmlentities($vo['id']); ?>,460,400)" href="javascript:;">
...
function member_del(obj, id) {
    layer.confirm('确认要删除吗？',
            function(index) {
                $.ajax({
                    type:"post",
                    url: "<?php echo url('index/admins/deletes'); ?>",
                    data: {
                        id:id
                    },
