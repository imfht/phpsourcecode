<?php /*a:2:{s:49:"D:\phpstudy_pro\WWW\tp\view\index\goods\adds.html";i:1601018055;s:52:"D:\phpstudy_pro\WWW\tp\view\index\common\static.html";i:1591060588;}*/ ?>
<!DOCTYPE html>
...
<script>
    function adds(){
        $.ajax({
            type:"post",
            url: "<?php echo url('index/goods/adds'); ?>",
            data: {
                name:$('#name').val(),
                price:$('#price').val(),
            },
