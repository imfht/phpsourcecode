<?php /*a:2:{s:52:"D:\phpstudy_pro\WWW\tp\view\index\purchase\adds.html";i:1601024228;s:52:"D:\phpstudy_pro\WWW\tp\view\index\common\static.html";i:1591060588;}*/ ?>
<!DOCTYPE html>
...
<script>
    ...
    function adds(){
        $.ajax({
            type:"post",
            url: "<?php echo url('index/purchase/adds'); ?>",
            data: {
/*                name:$('#name').val(),
                price:$('#price').val(),*/
                id:$('#goods_id').val(),
