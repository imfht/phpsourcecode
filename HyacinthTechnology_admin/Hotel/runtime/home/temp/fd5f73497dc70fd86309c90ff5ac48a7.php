<?php /*a:2:{s:53:"D:\phpstudy_pro\WWW\tp\view\home\member\recharge.html";i:1601711342;s:51:"D:\phpstudy_pro\WWW\tp\view\home\common\static.html";i:1601423018;}*/ ?>
<!DOCTYPE html>
...
<script>
    ...
    function adds(){
        $.ajax({
            type:"post",
            url: "<?php echo url('home/member/recharge'); ?>",
            data: {
                money:$('#money').val(),
                id:$('#id').val(),
            },
