<?php /*a:3:{s:50:"D:\phpstudy_pro\WWW\tp\view\home\member\index.html";i:1601710717;s:51:"D:\phpstudy_pro\WWW\tp\view\home\common\static.html";i:1601423018;s:54:"D:\phpstudy_pro\WWW\tp\view\home\common\resources.html";i:1601423784;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            ...
                            <button class="layui-btn" onclick="xadmin.open('添加用户','/home/member/vip',450,500)">
                            ...
                            <table class="layui-table layui-form">
                                ...
                                <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        ...
                                        <td><?php echo htmlentities($vo['vipname']); ?></td>
                                        ...
                                        <td class="td-manage">
                                            <a title="删除" onclick="xadmin.open('编辑','/home/member/recharge/id/'+<?php echo htmlentities($vo['id']); ?>,500,400)" href="javascript:;">
                                                充值
                                            </a>
                                            <a title="查看" onclick="xadmin.open('编辑','/home/member/edits/id/'+<?php echo htmlentities($vo['id']); ?>,500,400)" href="javascript:;">
...
function member_del(obj, id) {
    layer.confirm('确认要删除吗？',
            function(index) {
                $.ajax({
                    type:"post",
                    url: "<?php echo url('/home/member/delete'); ?>",
                    data: {
                        id:id
                    },
