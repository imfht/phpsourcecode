<?php /*a:2:{s:49:"D:\phpstudy_pro\WWW\tp\view\home\index\index.html";i:1601856977;s:51:"D:\phpstudy_pro\WWW\tp\view\home\common\static.html";i:1601423018;}*/ ?>
<!doctype html>
    ...
    <body class="index">
        ...
        <div class="container">
            ...
            <ul class="layui-nav right" lay-filter="">
                ...
                <li class="layui-nav-item to-index">
                    <a href="/"><?php echo htmlentities($list['building']); ?></a></li>
            </ul>
        </div>
        <!-- 顶部结束 -->
        <!-- 中部开始 -->
        ...
        <div class="left-nav">
            <div id="side-nav">
                <ul id="nav">
                    <li>
                        <a onclick="xadmin.add_tab('房间动态','/home/index/welcome')">
                    ...
                    <li>
                        <a onclick="xadmin.add_tab('登记入住','welcome1.html')">
                            <i class="iconfont left-nav-li" lay-tips="登记入住">&#xe6b8;</i>
                            <cite>预定信息</cite>
                            <i class="iconfont nav_right">&#xe697;</i></a>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li>
                                <a onclick="xadmin.add_tab('查看商品','/home/goods/select_goods')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>查看商品</cite></a>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('收入明细','/home/income/index')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>收入明细</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('押金记录','/home/member/index')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>押金记录</cite></a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a onclick="xadmin.add_tab('入住统计','/home/blacklist/index')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>入住统计</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('会员消费记录','/home/blacklist/index')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>会员充值记录</cite></a>
                            </li>
                            <li>
...
<!--                    <li>
                    ...
                    <li>
                        <a onclick="xadmin.add_tab('登记入住','/home/houseprice/index')">
                            <i class="iconfont left-nav-li" lay-tips="登记入住">&#xe6b8;</i>
                            <cite>查看房价</cite>
                            <i class="iconfont nav_right">&#xe697;</i></a>
                    </li>
            ...
            <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
                ...
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show">
                        <iframe src="<?php echo url('home/index/welcome'); ?>" frameborder="0" scrolling="yes" class="x-iframe"></iframe>
                    </div>
                </div>
                <div id="tab_show"></div>
            </div>
