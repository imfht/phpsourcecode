<?php /*a:2:{s:48:"D:\phpstudy_pro\WWW\tp\view\home\goods\adds.html";i:1601601897;s:51:"D:\phpstudy_pro\WWW\tp\view\home\common\static.html";i:1601423018;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="layui-row">
                <form class="layui-form">
                  <div class="layui-form-item">
                    ...
                    <input type="text" id="building_id" value="<?php echo session('building_id');; ?>">
...
<script>
    function adds(){
        $.ajax({
            type:"post",
            url: "<?php echo url('home/goods/adds'); ?>",
            data: {
                name:$('#name').val(),
                price:$('#price').val(),
