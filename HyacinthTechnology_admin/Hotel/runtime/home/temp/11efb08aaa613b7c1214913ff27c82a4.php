<?php /*a:1:{s:49:"D:\phpstudy_pro\WWW\tp\view\home\login\index.html";i:1601285898;}*/ ?>
<!doctype html>
...
<div class="login layui-anim layui-anim-up">
    ...
    <form method="post" class="layui-form" >
        ...
        <hr class="hr15">
        <select name="city" lay-verify="" id="classes">
            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <option value="<?php echo htmlentities($vo['classe']); ?>"><?php echo htmlentities($vo['classe']); ?></option>
...
<script>
    function login() {
        $.ajax({
            type:"post",
            url: "<?php echo url('home/login/index'); ?>",
            data: {
