<?php /*a:3:{s:52:"D:\phpstudy_pro\WWW\tp\view\home\atrial\consume.html";i:1601516455;s:51:"D:\phpstudy_pro\WWW\tp\view\home\common\static.html";i:1601423018;s:54:"D:\phpstudy_pro\WWW\tp\view\home\common\resources.html";i:1601423784;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            ...
                            <button class="layui-btn" onclick="xadmin.open('添加用户','/home/atrial/goods/room_id/<?php echo htmlentities($list['id']); ?>',600,800)">
                                <i class="layui-icon"></i>添加</button>
                            房间号：<?php echo htmlentities($list['room_num']); ?>
                        </div>
                        <div class="layui-card-body ">
                            <table class="layui-table layui-form">
                                ...
                                <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo date('Y-m-d H:m:s',$v['create_time']);; ?></td>
                                        <td class="td-manage">
    ...
    function member_del(obj, id) {
        layer.confirm('确认要删除吗？',
                function(index) {
                    $.ajax({
                        type:"post",
                        url: "<?php echo url('home/atrial/delgoods'); ?>",
                        data: {
                            id:id
                        },
