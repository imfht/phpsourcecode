<?php /*a:3:{s:50:"D:\phpstudy_pro\WWW\tp\view\home\atrial\goods.html";i:1601604910;s:51:"D:\phpstudy_pro\WWW\tp\view\home\common\static.html";i:1601423018;s:54:"D:\phpstudy_pro\WWW\tp\view\home\common\resources.html";i:1601423784;}*/ ?>
<!DOCTYPE html>
                            ...
                            <table class="layui-table layui-form">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-manage">
                                            <input type="hidden" value="<?php echo htmlentities($room_id); ?>" id="room_id">
                                            <button title="查看" onclick="adds(<?php echo htmlentities($vo['id']); ?>)">
                                                <i class="layui-icon">&#xe63c;</i></button>
                                        </td>
                                    </tr>
...
function adds(id){
    $.ajax({
        type:"post",
        url: "<?php echo url('home/atrial/goods'); ?>",
        data: {
            goods_id:id,
            room_id:$('#room_id').val(),
            num:$('#num').val()
