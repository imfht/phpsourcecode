...
<style type="text/css">
    ...
    #mzphp_trace_size, #mzphp_trace_close {
        float: right;
        display: inline;
    ...
    #mzphp_trace_cont ol.ktun {
        display: none
    }

    #mzphp_trace_cont ol li {
        padding: 0 3px;
        clear: both;
        border-radius: 5px;
        font-size: 12px;
    ...
    #mzphp_trace_cont ol li span {
        float: left;
        display: inline;
        width: 100px
    }

    #mzphp_trace_cont ol li.even {
        background: #ddd
    }

    #mzphp_trace_cont ol li.tit {
        background: #333;
        color: #FFF;
    }
    ...
    .tclass table td, .tclass2 table td {
        border-bottom: 0;
        border-right: 0;
        border-color: #ADADAD;
    }

    .tclass th, .tclass2 th {
...
<script type="text/javascript">
    (function () {
        ...
        var set_cookie = function () {
            document.cookie = 'mzphp_trace_page_show=' + history.join('|');
        }
