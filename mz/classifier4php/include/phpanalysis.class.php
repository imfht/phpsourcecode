...
class PhpAnalysis
{
    ...
    public $addonDicFile = 'word_dict/words_addons.dic';
    ...
    public $mainDicFile = 'word_dict/base_dic_full.dic';
    ...
    */
    ...
    public function LoadDict( $maindic='' )
    {
		...
		$root = defined('ROOT_PATH')? ROOT_PATH.'data/' : dirname(__FILE__).'/';
        //正常读取文件
        $dicAddon = $root.$this->addonDicFile;
        ...
        //加载主词典（只打开）
        $this->mainDicHand = fopen($root.$dicWords, 'r');
