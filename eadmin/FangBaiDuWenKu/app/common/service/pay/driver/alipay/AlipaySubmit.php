...
class AlipaySubmit {
	 ...
	 * @return 提交表单HTML文本
	 */
 	function buildRequestForm($para_temp, $method='post', $button_name= 'OK') {
		//待请求参数数组
		
		$para = $this->buildRequestPara($para_temp);
		$jump_url = isset($_SERVER['HTTP_REFERER'])?$_SERVER['HTTP_REFERER']:'';
