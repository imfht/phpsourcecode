...
class Editor extends AddonBase implements AddonInterface
{
    ...
    public function ArticleEditor($param = [])
    {
        ...
        if (!$param['items']) {
            $param['items'] = json_encode(['bold', 'italic', 'underline', '|', 'justifyleft', 'justifycenter', 'justifyright', 'justifyfull', '|', 'fontname', 'fontsize', 'forecolor', 'hilitecolor', '|', 'image', 'multiimage', 'emoticons', 'link', 'unlink', '|', 'code']);
        }
