...
class Request
{
    ...
    protected function __construct($options = [])
    {
        ...
        if (is_null($this->filter)) {
            $this->filter = config('config.default_filter');
        }
    ...
    public function __call($method, $args)
    {
        ...
        if (array_key_exists($method, self::$hook)) {
            ...
            throw new EsException('method not exists:' . __CLASS__ . '->' . $method);
        }
    }
    ...
    public function method($method = false)
    {
        if (true === $method) {
            ...
            if (isset($_POST[config('config.var_method')])) {
                $this->method = strtoupper($_POST[config('', 'var_method')]);
    ...
    public function isSsl()
    {
        ...
        if (isset($server['HTTPS']) && ('1' == $server['HTTPS'] || 'on' == strtolower($server['HTTPS']))) {
            ...
            return true;
        } elseif (config('config.https_agent_name') && isset($server[config('config.https_agent_name')])) {
            return true;
        }
        return false;
    }
    ...
    public function isAjax($ajax = false)
    {
        ...
        if (true === $ajax) {
            ...
            return $this->param(config('', 'var_ajax')) ? true : $result;
        }
    }
    ...
    public function isPjax($pjax = false)
    {
        ...
        if (true === $pjax) {
            ...
            return $this->param(config('', 'var_pjax')) ? true : $result;
        }
    }
