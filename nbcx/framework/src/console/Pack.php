...
class Pack {
     ...
     */
    public function setConsole(Driver $console = null) {
    ...
    protected function execute(Input $input, Output $output) {
        return $this->cmd->execute($input,$output,$this);
    }
    ...
    protected function interact(Input $input, Output $output) {
        return $this->cmd->interact($input,$output);
    }
    ...
    protected function initialize(Input $input, Output $output) {
        return $this->cmd->initialize($input,$output);
    }
    ...
    public function run(Input $input, Output $output) {
        ...
        $this->initialize($input, $output, $this);

        if ($input->isInteractive()) {
            $this->interact($input, $output, $this);
        }
        ...
        if ($this->code) {
            ...
            $statusCode = $this->execute($input, $output, $this);
        }
    ...
    public function mergeConsoleDefinition($mergeArgs = true) {
        ...
        if ($mergeArgs) {
            ...
            $this->definition->setArguments($this->console->definition->getArguments());
            $this->definition->addArguments($currentArguments);
        }

        $this->definition->addOptions($this->console->definition->getOptions());
