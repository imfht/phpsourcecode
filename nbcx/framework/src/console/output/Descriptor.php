...
use nb\console\input\Argument as InputArgument;
use nb\console\input\Definition as InputDefinition;
use nb\console\input\Option as InputOption;
use nb\console\output\descriptor\Console as ConsoleDescription;
use nb\console\Pack;
...
class Descriptor {
    ...
    public function describe(Output $output, $object, array $options = []) {
        ...
        switch (true) {
            ...
            case $object instanceof InputDefinition:
                ...
                break;
            case $object instanceof Pack:
                $this->describeCommand($object, $options);
                break;
            case $object instanceof Driver:
     ...
     * @return string|mixed
     */
    protected function describeCommand(Pack $command, array $options = []) {
     ...
     * @return string|mixed
     */
    protected function describeConsole(Driver $console, array $options = []) {
        ...
        if (isset($options['raw_text']) && $options['raw_text']) {
            ...
            $this->describeInputDefinition(new InputDefinition($console->definition->getOptions()), $options);
