...
function formatsize($size) {
	...
	for($j = $len-1; $j >=0; $j--) {
		...
		if($strlen==1)
			$allsize[$j] = "<span style='color: #FFFFFF'>0</span>".$allsize[$j];
		elseif($strlen==2)
			$allsize[$j] = "<span style='color: #FFFFFF'>00</span>".$allsize[$j];
		elseif($strlen==3)
			$allsize[$j] = "<span style='color: #FFFFFF'>000</span>".$allsize[$j];
...
function isfun($funName = '') {
	...
	return (false !== function_exists($funName)) ? '<span style="color:green;">√</span>' : '<span style="color:red;">×</span>';
}
...
<div id="page">
    <div id="header">
        <h1>PHP探针</h1>
        <div id="lnmplink">for <a href="http://nb.cx" target="_blank">CxMvc</a> </div>
    </div>
...
<?php
if (is_file("/proc/net/dev")&&false !== ($strs = @file("/proc/net/dev"))) :
	?>
<table width="100%" cellpadding="3" cellspacing="0" align="center">
...
<div id="footer">
&copy; 2016 <a href="http://nb.cx" target="_blank">Newbie</a><br />This Prober was based on Yahei Prober.<br />
