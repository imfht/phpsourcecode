  ...
  <div  class="right">
    <div  class="article_mod">
      ...
      <div  class="author_mod clear  hidden ">
        <div  class="face"> <a  href="<?php echo esc_url( get_author_posts_url( $authordata->ID, $authordata->user_nicename ) ); ?>"  ><span><?php if (function_exists('get_avatar')) { echo get_avatar( get_the_author_email(), '102',"",get_the_author());  }?></span></a> </div>
        ...
        <div  class="text tj"> <?php $des=get_usermeta($authordata->ID);echo '个性签名：'.$des[3];?> </div>
      </div>
