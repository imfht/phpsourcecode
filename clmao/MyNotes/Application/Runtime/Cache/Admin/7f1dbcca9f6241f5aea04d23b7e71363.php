...
<html lang="zh-CN">
 ...
 <body>
     <div class='panel'>
        ...
        <form class="form-horizontal" role="form" method='post' action="<?php echo U('Admin/Admin/editCategoryProcess');?>">
           <div class="form-group">
            <label class="col-md-2 control-label required">分类名称</label>
            <div class="col-md-10">
                <input type='hidden' name='id' value='<?php echo ($category["id"]); ?>'/>
               <input type='text' name='title' value="<?php echo ($category["title"]); ?>"id='title' required='required' class='form-control' placeholder=''/>
            </div>
          </div>
           <div class="form-group">
