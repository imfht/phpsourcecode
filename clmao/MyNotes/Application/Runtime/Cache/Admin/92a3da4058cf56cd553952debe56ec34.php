...
<body>
 ...
 <table class="table table-bordered table-hover table-striped">
        <thead>
            <tr><th colspan="3" class="space"><?php echo ($title); ?></th></tr>
          <tr>
            <th>编号</th>
            <th>标题</th>
            <th>操作</th>
        ...
        <tbody>
            ...
            <td>
                <div class="btn-group">
                <a href="<?php echo U('Home/Index/category',array('cid' =>$list['id'] ));?>"><button type="button" class="btn">浏览</button></a>
                <a href="<?php echo U('Admin/Admin/editCategory',array('id' =>$list['id']));?>"><button type="button" class="btn btn-success">编辑</button></a>
                <a href="<?php echo U('Admin/Admin/delCategoryProcess',array('id' =>$list['id']));?>" onclick="if (!confirm('确定要删除吗')) {
                                    return false;
