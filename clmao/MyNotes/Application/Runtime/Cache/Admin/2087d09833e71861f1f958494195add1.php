...
<html lang="zh-CN">
 ...
 <body>
     <div class='panel'>
        ...
        <form class="form-horizontal" role="form" method='post'  action="<?php echo U('Admin/Admin/addContentProcess');?>">
           <div class="form-group">
            <label class="col-md-2 control-label required">标题</label>
            <div class="col-md-10">
               <input type='text' name='title' id='title' value='<?php echo (cookie('addcontent_title')); ?>' class='form-control' placeholder=''/>
            </div>
          </div>
           ...
           <div class="form-group">
            ...
            <div class="col-md-4">
                <input type='text' name='author' id='author' value='<?php $addcontent_author = cookie('addcontent_author'); if(empty($addcontent_author)){ echo getSiteOption('defaultAuthor'); }else{ echo $addcontent_author; } ?>' class='form-control' />
            </div>
          </div>  
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
                ...
                <?php if(is_array($category)): foreach($category as $key=>$category): ?><option value ="<?php echo ($category["id"]); ?>"<?php if($_COOKIE['addcontent_c_id']== $category["id"] ): ?>selected='selected'<?php else: endif; ?> ><?php echo ($category["title"]); ?></option><?php endforeach; endif; ?>
                </select>
          ...
          <div class="form-group">
            ...
            <div class="col-md-10">
              <script id="container" name="content" type="text/plain"><?php echo (cookie('addcontent_content')); ?></script>
            </div>
          </div>
