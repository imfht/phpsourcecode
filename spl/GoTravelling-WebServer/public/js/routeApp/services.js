...
define(['routeApp/module', 'library/classHelper'], function(module, classHelper){
  ...
  module.factory('ResourceService', ['$http', function($http){
    ...
    resourceFactory.prototype = {
      ...
      store: function(resourceData, postOps){
        return $http.post( this.getBaseUrl(), resourceData, postOps);
      },
   ...
   */
  module.factory('NestedResourceService', ['$http', '$stateParams', 'ResourceService',
    function($http, $stateParams, ResourceService){
      ...
      classHelper.inherit(nestResourceFactory, ResourceService.getFactoryFunction());

      classHelper.extendOrOverloadMethod(nestResourceFactory, 'setParentResourceId', function(stateParams, parentResourceIdDesces){
        var self = this;
      ...
      classHelper.extendOrOverloadMethod(nestResourceFactory, 'getBaseUrl', function(){
        var self = this;
