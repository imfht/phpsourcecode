...
if ( !defined( '_MB_VERSION_' ) )
  exit;
class Ems extends CarrierModule
{
	public function __construct()
	{
		...
		$this->displayName = $this->l('Ems Express');
		$this->description = $this->l('Domestic Ems Express shipping');
	...
	*/
	...
	public function getOrderShippingCost($params, $shipping_cost)
	{
		...
		if($result){
			...
			if($params->getTotalWeight() > 0.5){
			    $fee += (ceil(($params->getTotalWeight() - 0.5) / 0.5)) * $result[0]['step_fee'];
			}
            return $fee;
		}
