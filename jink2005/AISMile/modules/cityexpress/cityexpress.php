...
if ( !defined( '_MB_VERSION_' ) )
  exit;
class Cityexpress extends CarrierModule
{
	public function __construct()
	{
		$this->name = 'cityexpress';
		...
		$this->displayName = $this->l('City Express');
		$this->description = $this->l('Domestic City Express shipping');
	...
	*/
	...
	public function getOrderShippingCost($params, $shipping_cost)
	{
		...
		if($result){
			return (float)$result[0]['base_fee'];
		}
