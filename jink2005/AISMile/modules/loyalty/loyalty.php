...
class Loyalty extends Module
{
	...
	public function install()
	{
		...
		$defaultTranslations = array('en' => 'Loyalty reward', 'fr' => 'RÃ©compense fidÃ©litÃ©');
...
//            redirect($this->context->link);
	...
	public function getContent()
	{
		...
		$languageIds = 'voucher_detailsÂ¤default_loyalty_stateÂ¤none_award_loyalty_stateÂ¤convert_loyalty_stateÂ¤validation_loyalty_stateÂ¤cancel_loyalty_state';
