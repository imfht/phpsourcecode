...
- MySQL 4 o superiore
Si raccomanda di far girare 2-plan su un server LAMP (Linux, Apache, MySQL, PHP).
...
### Istruzioni di installazione ###
    ...
    3. Rendere scrivibili le seguenti cartelle e files:
	 ...
	 4. Creare un nuovo database MySQL per 2-plan;
...
### Istruzione per l'Update  ###
	 ...
	 4. Caricare tutto sul server, rimpiazzando tutti i vecchi files di 2-plan;
