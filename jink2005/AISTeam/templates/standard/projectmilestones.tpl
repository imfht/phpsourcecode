...
{*Milestones*}
			<div class="headline">
				<a href="javascript:void(0);" id="milestones_toggle" class="win_block" onclick = "toggleBlock('milestones');"></a>
			...
			<div class="block" id="milestones"{if $smarty.cookies.milestones!=""} style="display:{$smarty.cookies.milestones}"{/if}>
