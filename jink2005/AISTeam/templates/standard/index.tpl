	...
	<div class="projects">
			...
			<div class="block" id="projecthead" style = "{$projectstyle}">
				...
				<table id = "desktopprojects" cellpadding="0" cellspacing="0" border="0">
					...
					<tbody class="color-a" id="proj_{$myprojects[project].ID}" rel = "{$myprojects[project].ID},{$myprojects[project].name|htmlentities},{$myprojects[project].daysleft}">
					{else}
					<tbody class="color-b" id="proj_{$myprojects[project].ID}" rel = "{$myprojects[project].ID},{$myprojects[project].name|htmlentities},{$myprojects[project].daysleft}">
					{/if}
						<tr {if $myprojects[project].daysleft < 0} class="marker-late"{elseif $myprojects[project].daysleft == 0} class="marker-today"{/if}>
							...
							<td>
								...
								<span id = "desktopprojectstoggle{$myprojects[project].ID}" class="acc-toggle" onclick="javascript:accord_projects.activate($$('#projecthead .accordion_toggle')[{$smarty.section.project.index}]);toggleAccordeon('projecthead',this);"></span>
									<a href="manageproject.php?action=showproject&amp;id={$myprojects[project].ID}" title="{$myprojects[project].name|htmlentities}">{$myprojects[project].name|truncate_name}</a>
								</div>
							</td>
				...
				<div class="wintools">
					<div class="export-main">
						...
						<div class="export-in"  style="width:46px;left: -46px;"> {*at two items*}
							<a class="rss" href="managerss.php?action=rss-tasks&{$userhash}"><span>{#rssfeed#}</span></a>
							<!--
...
<div class="miles">
			<div class="headline">
				<a href="javascript:void(0);" id="mileshead_toggle" class="{$milebar}" onclick = "toggleBlock('calendarhead');"></a>
			...
			<div class="block" id="calendarhead"{if $smarty.cookies.calendarhead!=""} style="display:{$smarty.cookies.calendarhead}"{/if}>
				...
				<div class="wintools">
					<div class="export-main">
						...
						<div class="export-in"  style="width:46px;left: -46px;"> {*at one item*}
							<a class="rss" href="managerss.php?action=mymsgs-rss&amp;{$userhash}"><span>{#rssfeed#}</span></a>
								...
								<div class="accordion_content">
									<div class="acc-in">
										...
										{if $messages[message].avatar != ""}
											<div class="avatar"><img src = "thumb.php?width=80&amp;height=80&amp;pic=files/{$cl_config}{$messages[message].client_path}/avatar/{$messages[message].avatar}" alt="" /></div>
										{else}
