<div class="block_in_wrapper">
	...
	<div class="row"><label for="end{$myprojects[project].ID}">{#end#}:</label><input type="text" class="text" name="end" realname="{#finishdate#}"  id="end{$myprojects[project].ID}" required = "1" /></div>
