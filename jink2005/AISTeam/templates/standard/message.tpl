...
<h1 class="second"><img src="./templates/standard/images/symbols/msgs.png" alt="" />{$message.title|truncate:40:"...":true}</h1>
	...
	<div id="message" class="descript">
		...
		{if $message.avatar != ""}
			<div class="avatar"><img src = "thumb.php?width=80&amp;height=80&amp;pic=files/{$cl_config}{$message.client_path}/avatar/{$message.avatar}" alt="" /></div>
		{else}
			{if $message.gender == "f"}
								...
								<div class="accordion_content">
									<div class="acc-in">
											...
											{if $replies[reply].avatar != ""}
												<div class="avatar"><img src = "thumb.php?width=80&amp;height=80&amp;pic=files/{$cl_config}{$replies[reply].client_path}/avatar/{$replies[reply].avatar}" alt="" /></div>
											{else}
