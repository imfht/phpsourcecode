...
.menu ul{
	...
	.menu li a{
		...
		.menu li a:hover, .menu ul li:hover a{
			background: #0A5299 url("images/hover.gif") bottom center no-repeat;
			color:#FFFFFF;
			text-decoration:none;
			}
	.menu li ul{
	...
	.menu li ul a{
		...
		.menu li ul a:hover, .menu li ul li:hover a{
			background:#0A5299 url('images/hover_sub.gif') center left no-repeat;
			border:0px;
			color:#ffffff;
			text-decoration:none;
			}
...
.login-in, .login-alert, .login-message {
	width: 100%;
	text-align: center;
...
ul.tabs li.gantt a {
	background-image: url(../images/symbols/tab-gantt.png);
}
...
.timetrack .headline, .timetrack a.butn_link, .timetrack button, .timetrack a.butn_link_active:hover, #mbox button {
...
.timetrack a.butn_link:hover, .timetrack button:hover, .timetrack form .fileinput:hover button, .timetrack a.butn_link_active, .timetrack .datepick .picker, #mbox button:hover {
