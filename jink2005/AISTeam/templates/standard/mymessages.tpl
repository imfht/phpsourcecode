...
<h1>{#mymessages#}</h1>
	...
	{section name= project loop=$myprojects}
			...
			<div class="headline">
				<a href="javascript:void(0);" id="block-{$myprojects[project].ID}_toggle" class="win_block" onclick = "toggleBlock('mesblock-{$myprojects[project].ID}');"></a>
...
{assign var=style value=mesblock-`$myprojects[project].ID`}
{assign var=style value=$smarty.cookies.$style}
			<div id="mesblock-{$myprojects[project].ID}" class="block"{if $style!=""} style="display:{$style}"{/if}>
								...
								<div class="accordion_content">
									<div class="acc-in">
										...
										{if $myprojects[project].messages[message].avatar != ""}
											<div class="avatar"><img src = "thumb.php?width=80&amp;height=80&amp;pic=files/{$cl_config}{$myprojects[project].messages[message].client_path}/avatar/{$myprojects[project].messages[message].avatar}" alt="" /></div>
										{else}
