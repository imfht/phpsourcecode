...
<h2>{#addrole#}</h2>
	...
	<fieldset>
        ...
        <div class = "row"><label>{#permissions#}:</label>
            ...
            <div class = "row">
            <label></label><input type = "checkbox" class = "checkbox" value = "1" name = "permissions_user[add]" />{#add#}
            </div>
            <div class = "row">
            <label></label><input type = "checkbox" class = "checkbox" value = "1" name = "permissions_user[edit]" />{#edit#}
            </div>
            <div class = "row">
            <label></label><input type = "checkbox" class = "checkbox" value = "1" name = "permissions_user[del]" />{#delete#}
            </div>
...
{if $userpermissions.admin.root}
            <div class = "row">
            <label></label><input type = "checkbox" class = "checkbox" value = "1" name = "permissions_admin[root]" />{#rootadmin#}
            </div>
{/if}
            <div class = "row">
            ...
            <div class = "row">
            <label></label><input type = "checkbox" class = "checkbox" value = "1" name = "permissions_api[read]" />{#read#}
            </div>
            <div class = "row">
            <label></label><input type = "checkbox" class = "checkbox" value = "1" name = "permissions_api[write]" />{#write#}
            </div>
        </div>
