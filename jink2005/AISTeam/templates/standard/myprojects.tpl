...
{*Projects*}
			...
			<div class="headline">
				<a href="javascript:void(0);" id="accprojects_toggle" class="win_none" onclick = "toggleBlock('accprojects');"></a>
			...
			<div class="block" id="accprojects"{if $smarty.cookies.accprojects!=""} style="display:{$smarty.cookies.accprojects}"{/if}>
