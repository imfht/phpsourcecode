...
// 2-plan doesn't seem to be installed properly , redirect to installer
...
$accesskey = md5( time().'2p1@n$3cr37'. rand(0, 999999) );
$_SESSION['genaccesskey'] = $accesskey; // store in session to prevent user from manipulating it
$template->assign("accesskey", $accesskey);
