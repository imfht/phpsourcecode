 ...
 *
 * Version:	$Id: status_doedit.php,v 1.6 2013/07/05 21:28:00 alex Exp $
 *
 */
...
$check_sql = "select * from ".$GLOBALS['BR_status_table']." 
				where status_name=".$GLOBALS['connection']->QMagic($_POST['status_name'])." and
				status_id !=".$GLOBALS['connection']->QMagic($_POST['status_id']);
...
$sql = "update ".$GLOBALS['BR_status_table']." set status_name=".$GLOBALS['connection']->QMagic($_POST['status_name']).", 
		status_color = ".$GLOBALS['connection']->QMagic($_POST['status_color']).",
		status_type = ".$GLOBALS['connection']->QMagic($_POST['status_type'])." where
		status_id=".$GLOBALS['connection']->QMagic($_POST['status_id']);
