 ...
 *
 * Version:	$Id: misc.php,v 1.12 2010/07/27 09:24:17 alex Exp $
 *
 */
...
function PrintTip($title, $mesg, $method = "")
{
	...
	$value = '<img src="images/tooltip.gif" border="0" onmouseover="return ALEXWANG.Tooltip.Show({title:\''.$title.'\', msg:\''.$mesg.'\', width:250});" onmouseout="ALEXWANG.Tooltip.Hide();">';
...
GotoTop = function() {
	...
	var DivGenerate = function() {
		...
		div.innerHTML = '<a href="#top"><IMG src="images/top.gif" title="<?php echo $STRING['top']?>" border="1"></a>';
		div.style.width = W;
		div.style.height = H;
...
function LoadingTimerShow()
{
	...
	echo '<center>'."\n";
	echo '<p>&nbsp</p>'; 
	echo '<img src="images/loading.gif" width="16" height="16" border="0">';
	echo $STRING['loading']."\n";
	echo '</center>'."\n";
	echo '</div>'."\n";
