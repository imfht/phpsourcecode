...
### تعليمات التنصيب ###
	...
	4. إنشيء قاعدة ييانات MySQL جديدة لـ 2-plan.
...
### تعليمات التحديث ###
    ...
    4. ارفع كل شيء للخادم, إاستدبدالا لكل كلفات 2-plan القديمة
    5. وجه متصفحك لـ update.php.
	6. اذا نجح التنصيب , إحذف install.php و update.php ــ


### شروط الرخصة ###
2-plan هو برنامج مجاني تحت شروط و بنود رخصة جنو العامة(GPL) (الأصدار 3).
