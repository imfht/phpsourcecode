...
class search
{
    ...
    function searchProjects($query)
    {
        ...
        $sel = mysql_query("SELECT `ID`,`name`,`desc`,`status` FROM ".TableBase::getTablePrefix()."projekte WHERE `name` LIKE '%$query%' OR `desc` LIKE '%$query%' OR ID = '$query' HAVING status=1");
    ...
    function searchMilestones($query, $project = 0)
    {
        ...
        if ($project > 0)
        {
            $sel = mysql_query("SELECT `ID`,`name`,`desc`,`status`,`project` FROM ".TableBase::getTablePrefix()."milestones WHERE `name` LIKE '%$query%' OR `desc` LIKE '%$query%' HAVING project = $project AND status=1 ");
        }
        else
        {
            $sel = mysql_query("SELECT `ID`,`name`,`desc`,`status`,`project` FROM ".TableBase::getTablePrefix()."milestones WHERE `name` LIKE '%$query%' OR `desc` LIKE '%$query%' HAVING status=1");
        }
        ...
        while ($result = mysql_fetch_array($sel))
        {
            if (!empty($result))
            {
                $project = mysql_query("SELECT name FROM ".TableBase::getTablePrefix()."projekte WHERE ID = $result[project]");
    ...
    function searchMessage($query, $project = 0)
    {
        ...
        if ($project > 0)
        {
            $sel = mysql_query("SELECT `ID`,`title`,`text`,`posted`,`user`,`username`,`project` FROM ".TableBase::getTablePrefix()."messages WHERE `title` LIKE '%$query%' OR `text` LIKE '%$query%' HAVING project = $project ");
        }
        else
        {
            $sel = mysql_query("SELECT `ID`,`title`,`text`,`posted`,`user`,`username`,`project` FROM ".TableBase::getTablePrefix()."messages WHERE `title` LIKE '%$query%' OR `text` LIKE '%$query%'");
        }
    ...
    function searchTasks($query, $project = 0)
    {
        ...
        if ($project > 0)
        {
            $sel = mysql_query("SELECT `ID`,`title`,`text`,`status`,`project` FROM ".TableBase::getTablePrefix()."tasks WHERE `title` LIKE '%$query%' OR `text` LIKE '%$query%' HAVING project = $project AND status=1");
        }
        else
        {
            $sel = mysql_query("SELECT `ID`,`title`,`text`,`status`,`project` FROM ".TableBase::getTablePrefix()."tasks WHERE `title` LIKE '%$query%' OR `text` LIKE '%$query%' HAVING status=1");
        }
    ...
    function searchFiles($query, $project = 0)
    {
        ...
        if ($project > 0)
        {
            $sel = mysql_query("SELECT `ID`,`name`,`desc`,`type`,`datei`,`title`,`project` FROM `".TableBase::getTablePrefix()."files` WHERE `name` LIKE '%$query%' OR `desc` LIKE '%$query%' OR `title` LIKE '%$query%' HAVING project = $project");
        }
        else
        {
            $sel = mysql_query("SELECT `ID`,`name`,`desc`,`type`,`datei`,`title`,`project` FROM `".TableBase::getTablePrefix()."files` WHERE `name` LIKE '%$query%' OR `desc` LIKE '%$query%' OR `title` LIKE '%$query%'");
        }
    ...
    function searchUser($query)
    {
        ...
        $sel = mysql_query("SELECT `ID`,`email`,`name`,`avatar`,`lastlogin` FROM ".TableBase::getTablePrefix()."user WHERE name LIKE '%$query%'");
