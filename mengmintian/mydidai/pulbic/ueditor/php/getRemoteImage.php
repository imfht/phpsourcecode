<?php
     ...
     */
    require '../../includes/init.php';//与mydidai整合，引入初始化文件
    header("Content-Type: text/html; charset=utf-8");
    error_reporting(E_ERROR|E_WARNING);
    //远程抓取图片配置
    $config = array(
        "savePath" => ROOT_PATH."uploads/" ,            //保存路径
    ...
    function getRemoteImage( $uri,$config)
    {
         ...
         * }
         */
        echo "{'url':'" . str_replace(ROOT_PATH,'',implode( "ue_separate_ue" , $tmpNames ) ). "','tip':'远程图片抓取成功！','srcUrl':'" . $uri . "'}";
    }