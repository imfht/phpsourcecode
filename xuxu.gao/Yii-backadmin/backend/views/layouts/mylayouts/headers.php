...
<header id="header">
    <ul class="header-inner">
        ...
        <li class="logo hidden-xs">
            <a href="index.html"><?=Yii::$app->params['theme']?></a>
        </li>
                        ...
                        <div class="listview">
                            ...
                            <div class="lv-body c-overflow">
                                <a class="lv-item" href="">
                                    <div class="media">
                                        <div class="pull-left">
                                            <img class="lv-img-sm" src="<?php echo Url::to('@web/public/img/profile-pics/1.jpg') ?>" alt="">
                                        </div>
                                ...
                                <a class="lv-item" href="">
                                    <div class="media">
                                        <div class="pull-left">
                                            <img class="lv-img-sm" src="<?php echo Url::to('@web/public/img/profile-pics/2.jpg') ?>" alt="">
                                        </div>
                                        <div class="media-body">
                                ...
                                <a class="lv-item" href="">
                                    <div class="media">
                                        <div class="pull-left">
                                            <img class="lv-img-sm" src="<?php echo Url::to('@web/public/img/profile-pics/3.jpg') ?>" alt="">
                                        </div>
                                        <div class="media-body">
                                ...
                                <a class="lv-item" href="">
                                    <div class="media">
                                        <div class="pull-left">
                                            <img class="lv-img-sm" src="<?php echo Url::to('@web/public/img/profile-pics/4.jpg') ?>" alt="">
                                        </div>
                                        <div class="media-body">
