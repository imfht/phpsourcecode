    ...
    $("#data-table-command").bootgrid({
        ...
        formatters: {
            "commands": function(column, row) {
                ...
                var str = "";
                if(row.is_edit) {
                    str += "<a  class='btn btn-xs btn-primary' href='/role/roleupdate/" + row.name + "'><i class='md-create'>更新</i></a>";
                }
                if(row.is_delete) {
                ...
                if(row.is_edit) {
                    ...
                    str += "&nbsp;&nbsp;&nbsp;&nbsp;<a class='btn btn-xs bgm-purple' href='/role/rolepermission/" + row.name + "'><i class='md-verified-user'>更新权限</i></a>";
                }
               return str;
            }
        }
