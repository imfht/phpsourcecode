...
$languages = array(
	...
	'setting_register_mdoublee' => '是否允许同一 手机号 地址注册多个用户',
    ...
    'settings_sms_settings_smstype' => '短信渠道平台',
    'settings_sms_settings_smstype_1' => '阿里大鱼平台 => 申请地址：<a href="http://www.alidayu.com/" target="_blank">http://www.alidayu.com/</a>',
    'settings_sms_settings_smstype_1_comment' => '请在下方用户名处填入阿里开发者平台应用App Key，在下文通信密码处填入阿里开发者平台应用App Secret，获取地址：<a href="http://my.open.taobao.com/app/app_list.htm" target="_blank">http://my.open.taobao.com/app/app_list.htm</a>',
    'settings_sms_settings_smsauth_username' => '用户名',
    'settings_sms_settings_smsauth_username_comment' => '短信平台分配的用户名，具体请查看所选短信平台下方的介绍',
    'settings_sms_settings_smsauth_passwd' => '密码',
    'settings_sms_settings_smsauth_passwd_comment' => '与短信平台通信的密码，具体请查看所选短信平台下方的介绍',
    'settings_sms_settings_silent' => '屏蔽短信发送中的全部错误提示',

    'settings_sms_settings_template' => '短信模板',
    'settings_sms_settings_template_comment' => '模板格式如下(一行一个参数)：<br />短信签名<br />短信内容(不能有换行，变量格式：{变量名}，如{code }，不含空格)<br />模板ID',
    'settings_sms_settings_template_get_passwd' => '取回密码模板',
    'settings_sms_settings_template_get_passwd_comment' => '系统变量：{username }，{newpass }，{bbname }，{sitename }，{siteurl }(不含空格)',
    'settings_sms_settings_template_sms_verify' => '身份验证模板',
    'settings_sms_settings_template_sms_verify_comment' => '系统变量：{username }，{bbname }，{sitename }，{siteurl }，{code }(不含空格)',
    'settings_sms_settings_template_add_member' => '被添加为会员通知模板',
    'settings_sms_settings_template_add_member_comment' => '系统变量：{username }，{bbname }，{sitename }，{siteurl }，{password }(不含空格)',
    'settings_sms_settings_template_notice' => '消息通知模板',
    'settings_sms_settings_template_notice_comment' => '系统变量：{username }，{bbname }，{sitename }，{siteurl }，{smstype }(不含空格)',
    'settings_sms_settings_template_moderate_member' => '用户审核结果通知模板',
    'settings_sms_settings_template_moderate_member_comment' => '系统变量：{username }，{regdate }，{modresult }，{bbname }，{sitename }，{siteurl }(不含空格)',
    'settings_sms_settings_template_adv_expiration' => '广告到期通知模板',
    'settings_sms_settings_template_adv_expiration_comment' => '系统变量：{bbname }，{sitename }，{siteurl }，{day }，{advs }(不含空格)',
    'settings_sms_settings_template_send_invite' => '邀请码赠送通知模板',
    'settings_sms_settings_template_send_invite_comment' => '系统变量：{username }，{sitename }，{bbname }，{siteurl }，{code }(不含空格)',
    'settings_sms_settings_template_invite_payment' => '邀请码购买通知模板',
    'settings_sms_settings_template_invite_payment_comment' => '系统变量：{bbname }，{sitename }，{siteurl }，{orderid }，{codetext }(不含空格)',
	...
	'user_add_sms_formatinvalid' => '手机号不合法',
	'user_add_sms_exists' => '该手机号已经被注册',
