...
$lang = array
	...
	'founder_patch_autoupdate_sms' => '有安全补丁时通过短信及时通知',
	'founder_patch_autoupdate_sms_comment' => '请您填写接收安全补丁通知的手机号码',
	...
	'home_notes' => '管理团队留言',
	'home_notes_add' => '留言',
	'home_news' => 'Discuz! Fans 动态',
	'home_news_none' => '暂未获取到动态，请登录 Discuz! Fans 查看。',
	'home_mods' => '待处理事项',
	...
	'home_dev_Fans' => 'Discuz! Fans 开发团队',
	...
	'setting_basic_adminsms' => '管理员手机',
	'setting_basic_adminsms_comment' => '管理员手机号，将用来接受系统异常报警',
	...
	'setting_access_register_verify_comment' => '选择“无”用户可直接注册成功；选择“Email 验证”将向用户注册 Email 发送一封验证邮件以确认邮箱的有效性（<strong>开启“通过邮件发送注册链接”该设置自动通过验证</strong>）；选择“短信验证”将向用户注册手机发送一封验证短信以确认手机的有效性；选择“人工审核”将由管理员人工逐个确定是否允许新用户注册',
	'setting_access_register_verify_email' => 'Email 验证',
	'setting_access_register_verify_sms' => '短信验证',
	...
	'setting_access_register_welcomemsg_sms' => '发送欢迎短信',
	...
	'setting_access_register_welcomesmstitle' => '欢迎短信内容',
	'setting_access_register_welcomesmstitle_comment' => '系统发送的欢迎短信的内容，不支持 HTML，不超过 69 个字。 ',
	...
	'setting_access_register_send_register_verify' => '注册验证',
	'setting_access_register_send_register_verify_comment' => '开启后用户注册时必须先通过邮箱或手机验证<br />邮箱验证：系统会发一条注册的地址到用户的邮箱，从该地址链接过来的允许注册，同时建议UCenter中开启一个邮箱只允许注册一个帐户<br/>短信验证：系统会发一条含有验证码的短信到用户的手机，同时建议UCenter中开启一个手机号只允许注册一个帐户<br/>注意：只有在<a href="?action=setting&operation=mail">站长 - 邮件设置</a>或<a href="?action=setting&operation=sms">站长 - 短信设置</a>中完成相应设置才可以开启该功能',
	'setting_access_register_send_register_verify_email' => '邮箱验证',
	'setting_access_register_send_register_verify_sms' => '短信验证',
	'setting_access_register_send_register_verify_choose' => '用户自行选择',
	...
	'setting_access_register_invite_buy_sms_comment' => '允许游客通过在线充值购买注册邀请码。仅限于关闭普通注册时有效。开启前请确认您的<a href="' . ADMINSCRIPT . '?frames=yes&action=setting&operation=ec" target="_blank"><strong>电子商务</strong></a>及<a href="' . ADMINSCRIPT . '?frames=yes&action=setting&operation=sms" target="_blank"><strong>发送短信</strong></a>功能可正常使用',
	...
	'setting_home_base_sendsmsday' => '短信通知更新天数',
	'setting_home_base_sendsmsday_comment' => '(默认 0) 单位：天，当用户多少天没有登录站点的时候才会给其发送短信通知；<br>设置为0，则不启用短信通知功能；<br>启用本功能将会轻微增加服务器负载',
...
',
	...
	'setting_functions_other_autoidselect_comment' => '选择“是”，站点登录时的将自动按 UID、手机号、E-mail、用户名的顺序逐一去匹配，其中UID验证只有UID登录方式被启用后才有效',
	...
	'setting_sms' => '短信设置',
	'setting_sms_setting' => '设置',
	'setting_sms_smscode_type' => '短信验证码类型',
	'setting_sms_smscode_type_comment' => '请设置身份验证的验证码类型',
	'setting_sms_smscode_type_letter' => '纯字母',
	'setting_sms_smscode_type_number' => '纯数字',
	'setting_sms_smscode_type_all' => '字母数字混合',
	'setting_sms_smscode_length' => '短信验证码长度',
	'setting_sms_smscode_length_comment' => '请设置身份验证的验证码长度',
	'setting_sms_setting_type' => '短信渠道平台',
	'setting_sms_setting_type_1' => '阿里大鱼平台',
	'setting_sms_setting_type_1_comment' => '申请地址：<a href="http://www.alidayu.com/" target="_blank">http://www.alidayu.com/</a><br />请在下方用户名处填入阿里开发者平台应用App Key，在下文通信密码处填入阿里开发者平台应用App Secret，获取地址：<a href="http://my.open.taobao.com/app/app_list.htm" target="_blank">http://my.open.taobao.com/app/app_list.htm</a>',
	'setting_sms_setting_smsauth_username' => '用户名',
	'setting_sms_setting_smsauth_username_comment' => '短信平台分配的用户名，具体请查看所选短信平台下方的介绍',
    'setting_sms_setting_smsauth_passwd' => '密码',
    'setting_sms_setting_smsauth_passwd_comment' => '与短信平台通信的密码，具体请查看所选短信平台下方的介绍',
    'setting_sms_setting_silent' => '屏蔽短信发送中的全部错误提示',
    'setting_sms_setting_template' => '短信模板',
    'setting_sms_setting_template_comment' => '模板格式如下(一行一个参数)：<br />短信签名<br />短信内容(不能有换行，变量格式：{变量名}，如{code }，不含空格)<br />模板ID',
    'setting_sms_setting_template_get_passwd' => '取回密码模板',
    'setting_sms_setting_template_get_passwd_comment' => '系统变量：{username }，{newpass }，{bbname }，{sitename }，{siteurl }(不含空格)',
    'setting_sms_setting_template_sms_verify' => '身份验证模板',
    'setting_sms_setting_template_sms_verify_comment' => '系统变量：{username }，{bbname }，{sitename }，{siteurl }，{code }(不含空格)',
    'setting_sms_setting_template_add_member' => '被添加为会员通知模板',
    'setting_sms_setting_template_add_member_comment' => '系统变量：{username }，{bbname }，{sitename }，{siteurl }，{password }(不含空格)',
	'setting_sms_setting_template_notice' => '消息通知模板',
	'setting_sms_setting_template_notice_comment' => '系统变量：{username }，{bbname }，{sitename }，{siteurl }，{smstype }(不含空格)',
    'setting_sms_setting_template_moderate_member' => '用户审核结果通知模板',
    'setting_sms_setting_template_moderate_member_comment' => '系统变量：{username }，{regdate }，{modresult }，{bbname }，{sitename }，{siteurl }(不含空格)',
    'setting_sms_setting_template_adv_expiration' => '广告到期通知模板',
    'setting_sms_setting_template_adv_expiration_comment' => '系统变量：{bbname }，{sitename }，{siteurl }，{day }，{advs }(不含空格)',
    'setting_sms_setting_template_send_invite' => '邀请码赠送通知模板',
    'setting_sms_setting_template_send_invite_comment' => '系统变量：{username }，{sitename }，{bbname }，{siteurl }，{code }(不含空格)',
    'setting_sms_setting_template_invite_payment' => '邀请码购买通知模板',
    'setting_sms_setting_template_invite_payment_comment' => '系统变量：{bbname }，{sitename }，{siteurl }，{orderid }，{codetext }(不含空格)',
	'setting_sms_check' => '检测',
    'setting_sms_check_template' => '短信模板',
    'setting_sms_check_template_comment' => '请选择您要测试的短信模板<br /><span id="sms_check_template" style="display:none;"></span>',
    'setting_sms_check_template_sign' => '短信签名',
    'setting_sms_check_template_sign_comment' => '与选择的短信模板对应有签名文字',
    'setting_sms_check_template_msg' => '短信内容',
    'setting_sms_check_template_msg_comment' => '请将短信内容中的变量用实际文字替换',
	'setting_sms_check_submit' => '检测短信发送设置',
	'setting_sms_check_test_to' => '测试收件人',
	'setting_sms_check_test_to_comment' => '请填写需要测试的短信接收手机号，多个手机号用半角逗号隔开',
	'setting_sms_check_success' => '测试短信发送成功:\n内容为：\n',
	'setting_sms_check_error' => '短信发送返回错误信息:\n',
	'setting_sec' => '基本设置',
	...
	'setting_sec_base_need_sms' => '强制用户验证激活手机',
	'setting_sec_base_need_email_comment' => '选择是的话，用户必须验证激活自己的邮箱后，才可以进行发布操作。 ',
	'setting_sec_base_need_sms_comment' => '选择是的话，用户必须验证激活自己的手机后，才可以进行发布操作。 ',
	'setting_sec_base_uniqueemail' => '验证激活邮箱唯一性',
	'setting_sec_base_uniquesms' => '验证激活手机唯一性',
	'setting_sec_base_uniqueemail_comment' => '选择是的话，验证激活的邮箱将唯一性，不允许重复',
	'setting_sec_base_uniquesms_comment' => '选择是的话，验证激活的手机将唯一性，不允许重复',
	...
	'setting_sec_reginput_sms' => '手机表单设置',
	'setting_sec_reginput_sms_comment' => '默认为 sms ，只能是字母和数字的组合，必须以字母开头。 修改后的表单名会使得注册机更难发挥作用',
	'setting_sec_reginput_smscode' => '手机验证码表单设置',
	'setting_sec_reginput_smscode_comment' => '默认为 smscode ，只能是字母和数字的组合，必须以字母开头。 修改后的表单名会使得注册机更难发挥作用',
...
<br />(3)SPH_RANK_NONE，禁用评分的模式，这是最快的模式。实际上这种模式与布尔搜索相同。所有的匹配项都被赋予权重1',
	...
	'members' => '用户',
	'members_add' => '添加新用户',
	'members_add_email_notify' => '发送邮件通知到上述地址',
	'members_add_sms_notify' => '发送短信通知到上述手机',
	...
	'members_edit_loginname_comment' => '登录名将代替“UID、E-mail、手机号、用户名”的方式登录',
	...
	'members_edit_sms_smsstatus' => '手机激活状态',
	...
	'members_edit_showsms' => '手机号码可见',
	'members_edit_newsletter' => '同意接收站点通知 (Email、短信或短消息)',
	...
	'members_search_smsstatus' => '是否通过手机认证',
	...
	'usergroups_edit_basic_forcelogin_sms' => '手机登录',
	...
	'usergroups_edit_invite_sendmail_permission' => '允许发送邀请注册邮件',
	'usergroups_edit_invite_sendmail_permission_comment' => '是否允许通过站点邮件系统发送邀请码',
	'usergroups_edit_invite_sendsms_permission' => '允许发送邀请注册短信',
	'usergroups_edit_invite_sendsms_permission_comment' => '是否允许通过站点短信系统发送邀请码',
	...
	'moderate_members_sms' => '发短信通知被审核用户',
...
<li><b>由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用财付通积分交易功能(不包含财付通按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。</b></li><li>您可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买帖子内容、购买用户组权限、积分转账或用户组升级等功能。财付通积分交易功能，需在“积分设置”中启用交易积分，并同时设置相应的积分策略以满足不同场合的需要。请务必正确设置您的收款财付通账号，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。</li><li>除 Discuz! 官方网站或官方论坛另行通知以外，Discuz! 提供的财付通支付服务每笔交易收取 1% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以 Discuz! 官方网站或官方论坛提供的信息为准。</li><li>您使用财付通服务是建立在完全自愿的基础上，除 Discuz! 因主观恶意的因素造成的资金损失以外，北京康盛新创科技有限责任公司不对因使用此功能造成的任何损失承担责任。</li><li>财付通服务热线：0755-83762288-2(全天24小时服务热线)</li>',
	...
	'optimizer_check_unit_optimizer_smsregister' => '检测通过短信发送注册连接项',
