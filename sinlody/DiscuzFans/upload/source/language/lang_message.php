...
$lang = array (
  ...
  'sms_credit_inadequate' => '抱歉，您没有足够的积分来完成此次邀请',
  'send_result_succeed' => '邀请已送出，您的好友可能需要几分钟后才能收到邀请信息',
  'send_result_resend_error' => '抱歉，尚未找到相应的邀请记录, 邀请重发失败',
  ...
  'profile_sms_illegal' => '手机号码无效',
  'profile_sms_duplicate' => '该手机号码已被注册',
  ...
  'no_privilege_sms' => '抱歉，您需要验证激活自己的手机后才能进行本操作，<a href="home.php?mod=spacecp&ac=profile&op=password">点击这里激活手机</a>',
  ...
  'register_sms_send_fail' => '短信验证码发送失败',
  'register_sms_send_success' => '短信验证码发送成功',
  'register_sms_check_fail' => '短信验证码校验失败',
  ...
  'profile_smscode_notmatch' => '抱歉，手机短信验证码不正确',
  ...
  'sms_verify_invalid' => '抱歉，您在 24 小时内只能提交一次验证手机号码请求',
  'sms_verify_succeed' => '验证短信已发送，请将收到的验证码填写到页面的文本框内',
  ...
  'lostpasswd_sms_not_exist' => '抱歉，使用此手机号码的用户不存在，不能使用取回密码功能',
  'lostpasswd_emall_sms_all_not_exist' => '抱歉，Email 和手机号至少要填写一项才能使用取回密码功能',
  'lostpasswd_many_users_use_email' => '抱歉，存在多个使用此 Email 的用户，请填写您需要找回密码的用户名',
  'lostpasswd_many_users_use_sms' => '抱歉，存在多个使用此手机号码的用户，请填写您需要找回密码的用户名',
  ...
  'getpasswd_send_newpass' => '您的新密码已通过短信发送到您的手机中，<br />请立即登录并修改您的密码',

  'submit_verify_succeed' => '审核请求提交成功，现在将返回个人中心',

  'buyinvitecode_no_count' => '未填写购买邀请码数量，请返回',
  'buyinvitecode_email_error' => '邮件地址未填或格式错误',
  'buyinvitecode_sms_error' => '手机号码未填或格式错误',
  'buyinvitecode_input_empty' => '邮件地址和手机号码至少填写其中一项',
  ...
  'sms_check_sucess' => '您的手机号({email})验证激活成功 ',
  'sms_check_account_invalid' => '抱歉，受保护用户或创始人不能使用短信验证，直接修改用户信息。',
  'sms_check_error' => '抱歉，您输入的验证码不正确。您可以在个人资料页面，重新接收新的短信验证码',
  ...
  'sms_invite_not_allow' => '抱歉，您没有权限使用短信邀请',
  'sms_can_not_be_empty' => '抱歉，短信列表不能为空',
  ...
  'profile_passwd_wrong' => '原密码不正确，您不能修改密码或Email、手机号或安全提问',
  'profile_email_verify' => '确认 Email 已发送，请用邮件中提供的方法激活您的帐号。如果您尚未收到我们发送的系统邮件，请点击密码安全中的“重新接收验证邮件”，或尝试更换另外一个地址',
  'profile_sms_verify' => '验证码已发送，请将收到的验证码填写到当前页面激活您的帐号。如果您尚未收到我们发送的系统短信，请点击密码安全中的“重新接收验证短信”，或尝试更换另外一个号码',
  ...
  'send_activate_sms_succeed' => '短信已发送，可能需要几分钟后才能收到短信',
  'send_activate_sms_error' => '抱歉，短信发送失败，请过5分钟后重试发送验证短信',
  ...
  'no_privilege_sendsmsday' => '抱歉，本站尚未开启短信提醒功能',
  'sms_input' => '抱歉，您尚未设置手机，请在<a href="home.php?mod=spacecp&ac=profile&op=password">联系方式</a>中准确填写您的手机',
  ...
  'location_login_force_sms' => '您所在的用户组必须使用手机登录',
  ...
  'register_sms_send_succeed' => '感谢您注册 {bbname}，<br />系统给您发送了一封带有注册地址的短信，快去查看手机获取注册链接进行下一步注册吧',
  ...
  'register_sms_verify' => '感谢您注册 {bbname}，<br />快去验证手机激活账号吧',
  'register_sms_verify_location' => '<a href="home.php?mod=spacecp&ac=profile&op=password">获取验证短信</a> <a href="home.php?mod=space&do=home">先去逛逛</a>',
