...
$lang = array (
  ...
  'no_invite_friend_sms' => '尚未邀请成功的好友手机',
  'no_right_invite_friend' => '抱歉，您目前还没有权限来邀请好友 ',
  'preview_invitation' => '预览邀请函',
  'resend' => '重发',
  'send_invitation_email' => '给好友发送Email邀请',
  'send_invitation_sms' => '给好友发送短信邀请',
  'send_invitation_email_message' => '通过发送邮件的方式，邀请您的好友。多个Email使用 "," 分割',
  'send_invitation_sms_message' => '通过发送短信的方式，邀请您的好友。多个号码使用 "," 分割',
  'send_mail_again' => '重发邮件',
  'send_sms_again' => '重发短信',
  'sure_resend' => '确定重新发送邀请邮件吗？',
  'sure_resend_sms' => '确定重新发送邀请短信吗？',
  'you_get' => '您自己可获得',
  'you_have' => '您现在拥有',
  ...
  'sms_been_active' => '<img src="{IMGDIR}/sms_active.png" alt="已验证" class="vm" /> <span class="xi1">当前手机号已经验证激活</span>',
  'loginname' => '登录名',
  'memcp_profile_loginname_comment' => '设置单独的登录名，设置后将无法使用“UID、E-mail、手机号、用户名”的方式登录，使帐号更安全',
  'memcp_profile_email_comment' => '!如更改邮箱，系统将修改您的密码并重新验证其有效性，请慎用 ',
  'memcp_profile_sms_comment' => '!如更改号码，系统将修改您的密码并重新验证其有效性，请慎用 ',
  ...
  'activate_smsbox_first' => '您首先需要激活您的手机号',
  'activate_mailbox_message' => '填写您常用的邮箱，系统会给您的邮箱发送一封含有激活链接的邮件，把激活链接复制到浏览器进行访问就可以激活您的邮箱,然后您就能可以设置邮件提醒 ',
  'activate_smsbox_message' => '填写您常用的手机号，系统会给您的手机号发送一条含有验证码的短信，把收到的验证码填入下方文本杠就可以激活您的手机号,然后您就能可以设置短信提醒 ',
  'click_activate_mailbox' => '点这里发送验证激活邮件',
  'click_activate_smsbox' => '点这里发送激活验证码短信',
  ...
  'modify_sms' => '修改手机号码',
  'modify_mailbox' => '修改邮箱',
  'modify_smsbox' => '修改手机号码',
  'reminder_mail_message_1' => '系统会在您超过',
  'reminder_mail_message_2' => '天没有登录站点时，自动给您发送提醒邮件，您可以选择只接受某些类别的提醒',
  'reminder_sms_message_1' => '系统会在您超过',
  'reminder_sms_message_2' => '天没有登录站点时，自动给您发送提醒短信，您可以选择只接受某些类别的提醒',
  ...
  'freeze_email_tips' => '您当前的帐号已经太长时间未登录网站已经被冻结，必须验证邮箱后才能解除冻结状态 <a href="home.php?mod=spacecp&ac=profile&op=password&findtype=email&resend=1" class="xi2">重新接收验证邮件</a>',
  'freeze_sms_tips' => '您当前的帐号已经太长时间未登录网站已经被冻结，必须验证手机后才能解除冻结状态 <a href="home.php?mod=spacecp&ac=profile&op=password&findtype=sms&resend=1" class="xi2">重新接收验证短信</a>',
  'freeze_reason' => '申诉理由',
  'freeze_reason_comment' => '如果您无法通过邮箱验证，请填写申诉理由',
  'freeze_reason_comment_sms' => '如果您无法通过短信验证，请填写申诉理由',
);
?>