...
$lang = array (
  'ning' => '您',
  'getpassword' => '找回密码',
  'getpassword_email' => '将密码重置链接发送至邮箱并按步骤设置新密码',
  'getpassword_sms' => '将直接重置为随机密码并发送到用户手机上',
  'getpassword_username' => '当多个用户使用同一个手机或邮箱时需要填写用户名',
  'getpassword_notice' => '邮箱和手机号至少填写一项，邮箱优先级高于手机号',
  ...
  'register_sms_tips' => '请输入正确的手机号码',
  'register_smscode_tips' => '请输入正确的短信验证码',
  ...
  'register_validate_sms_tips' => '注册需要验证手机号，请务必填写正确的手机号，提交后请及时查收短信。<br />您可能需要等待几分钟才能收到短信，如果收件箱没有，请检查一下是否被安全软件拦截。',
  'rulemessage' => '网站服务条款',
);
