...
$lang = array(
	...
	'sms_acitve_message' => '<img src="{imgdir}/sms_inactive.png" alt="未验证" class="vm" /> <span class="xi1">新手机({newsms})等待验证中...</span><br />
								系统已经向该手机发送了一条验证激活短信，请查收短信，输入验证码进行验证激活。<br>
	                            短信验证码：<input type="text" name="smscode" id="smscode" class="px" style="width: 60px;" /> <br>
								如果没有收到验证短信，您可以更换一个手机号，或者<a href="home.php?mod=spacecp&ac=profile&op=password&resend=2" class="xi2">重新接收验证短信</a>',
