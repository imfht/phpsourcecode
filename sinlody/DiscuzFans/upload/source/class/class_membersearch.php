...
class membersearch {
	...
	function getfield($fieldid='') {
		static $fields = array(
			...
			'email'=>'member','sms'=>'member', 'credits'=>'member', 'regdate'=>'member',
			'status'=>'member', 'freeze'=>'member', 'emailstatus'=>'member', 'smsstatus'=>'member', 'avatarstatus'=>'member','videophotostatus'=>'member',
	...
	function gettype($fieldid) {
		static $types = array(
			...
			'status'=>'int', 'freeze'=>'int', 'emailstatus'=>'int', 'smsstatus'=>'int', 'avatarstatus'=>'int','videophotostatus'=>'int',
