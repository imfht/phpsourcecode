...
class table_forum_order extends discuz_table
{
	...
	public function count_by_search($uid = null, $status = null, $orderid = null, $email = null, $username = null, $buyer = null, $admin = null, $submit_starttime = null, $submit_endtime = null, $confirm_starttime = null, $confirm_endtime = null) {
		return $this->count_by_search_new($uid, $status, $orderid, $email, null, $username, $buyer, $admin, $submit_starttime, $submit_endtime, $confirm_starttime, $confirm_endtime);
	}
	public function count_by_search_new($uid = null, $status = null, $orderid = null, $email = null, $sms = null, $username = null, $buyer = null, $admin = null, $submit_starttime = null, $submit_endtime = null, $confirm_starttime = null, $confirm_endtime = null) {
		$sql = '';
