...
class table_common_member extends discuz_table_archive
{
	...
	public function insert($uid, $username, $password, $email, $ip, $groupid, $extdata, $adminid = 0) {
		$this->insert($uid, $username, $password, $email, null, $ip, $groupid, $extdata, $adminid = 0);
	}
	public function insert_new($uid, $username, $password, $email, $sms, $ip, $groupid, $extdata, $adminid = 0) {
		if(($uid = dintval($uid))) {
