...
<meta property="wb:webmaster" content="31550d97eacf438e" />
    <?php wp_head(); ?>
  ...
  <body <?php body_class(); ?>>
    ...
    <div class="jumbotron" style="background-image: url(<?php bloginfo('template_url'); ?>/style/images/title-bg.png);">
      <div class="jumbotron-content">
        ...
        <div class="row">
          <div class="col-md-6"><a href="http://git.oschina.net/yuesong/" class="btn btn-primary btn-lg pull-right" role="button"><span class="glyphicon glyphicon-star"></span> Git 仓库</a></div>
          <div class="col-md-6"><a href="/about" class="btn btn-primary btn-lg pull-left" role="button">关于我</a></div>
