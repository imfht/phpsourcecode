...
class TypeEvent {
	...
	public function qq($token) {
		...
		$qq = \Common\Lib\Api\ThinkOauth::getInstance('qq', $token);
	...
	public function tencent($token) {
		//import("ORG.ThinkSDK.ThinkOauth");
		$tencent = \Common\Lib\Util\ThinkOauth::getInstance('tencent', $token);
	...
	public function sina($token) {
		$sina = \Common\Lib\Util\ThinkOauth::getInstance('sina', $token);
	...
	public function t163($token) {
		$t163 = \Common\Lib\Util\ThinkOauth::getInstance('t163', $token);
	...
	public function renren($token) {
		$renren = \Common\Lib\Util\ThinkOauth::getInstance('renren', $token);
	...
	public function douban($token) {
		$douban = \Common\Lib\Util\ThinkOauth::getInstance('douban', $token);
	...
	public function github($token) {
		$github = \Common\Lib\Util\ThinkOauth::getInstance('github', $token);
	...
	public function google($token) {
		$google = \Common\Lib\Util\ThinkOauth::getInstance('google', $token);
	...
	public function msn($token) {
		$msn = \Common\Lib\Util\ThinkOauth::getInstance('msn', $token);
		$data = $msn->call('me');
	...
	public function diandian($token) {
		$diandian = \Common\Lib\Util\ThinkOauth::getInstance('diandian', $token);
	...
	public function taobao($token) {
		$taobao = \Common\Lib\Util\ThinkOauth::getInstance('taobao', $token);
	...
	public function baidu($token) {
		$baidu = \Common\Lib\Util\ThinkOauth::getInstance('baidu', $token);
	...
	public function kaixin($token) {
		$kaixin = \Common\Lib\Util\ThinkOauth::getInstance('kaixin', $token);
	...
	public function sohu($token) {
		$sohu = \Common\Lib\Util\ThinkOauth::getInstance('sohu', $token);
