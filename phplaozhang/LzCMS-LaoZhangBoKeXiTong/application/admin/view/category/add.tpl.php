      ...
      <div class="layui-tab-item layui-show">
        <form class="layui-form">
          <div class="layui-tab layui-tab-card">
            ...
            <div class="layui-tab-content">
              <div class="layui-tab-item layui-show">
                <?php echo Form::select('model_id','','选择模型','',$model_select,'required');?>
                ...
                <?php echo Form::radio('is_cover',1,'是否显示封面','无封面责进入下级第一个栏目列表页',array(1=>'是',0=>'否'));?>
              </div>
              <div class="layui-tab-item">
                <?php echo Form::input('text','index_template',$category['index_template'],'封面页模版','','请输入封面页模版');?>
                <?php echo Form::input('text','list_template',$category['list_template'],'列表页模版','','请输入列表页模版');?>
                <?php echo Form::input('text','show_template',$category['show_template'],'详情页模版','','请输入详情页模版');?>
              </div>
              <div class="layui-tab-item">
