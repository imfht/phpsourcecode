...
cd ..
rm -rf mongo-1.4.3
if [ -f "/server/php5.4/lib/php/extensions/no-debug-non-zts-20100525/mongo.so" ];then
    echo "[mongo]">/server/php5.4/etc/conf.d/mongo.ini
    echo "extension=mongo.so">>/server/php5.4/etc/conf.d/mongo.ini
