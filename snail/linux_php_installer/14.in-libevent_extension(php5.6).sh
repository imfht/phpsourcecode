...
if [ -f "/server/php5.6/lib/php/extensions/no-debug-non-zts-20131226/libevent.so" ];then
    echo "[libevent]">/server/php5.6/etc/conf.d/libevent.ini
    echo "extension=libevent.so">>/server/php5.6/etc/conf.d/libevent.ini
