...
<body>
	...
	<table class="table table-bordered table-hover table-condensed table-responsive">
		<tr>
			<td colspan="3" class="bg text-center padding-little-top padding-little-bottom">配置组编辑</td>
		</tr>
		<tr>
			<td align="right">组名称(中文)</td>
			<td><input type="text" name="ctitle" value="<?php echo $field['ctitle'];?>" /></td>
			<td>请输入配置组中文名称！</td>
		</tr>
		<tr>
			<td align="right">组标识(英文)</td>
			<td><input type="text" name="cname" value="<?php echo $field['cname'];?>" /></td>
			<td>请输入英文配置组标识！</td>
		</tr>
		<tr>
			<td align="right">排序</td>
			<td><input type="text" name="csort" value="<?php echo $field['csort'];?>" /></td>
			<td>请输入排序数值！</td>
		</tr>
		<tr>
			<td>
				<input type="hidden" name="cid" value="<?php echo $field['cid'];?>"/>
				<input type="hidden" name="isshow" value="<?php echo $field['isshow'];?>" />
				<input type="hidden" name="system" value="<?php echo $field['system'];?>" />
			</td>
			<td colspan="2">
