	...
	<table class="table table-bordered table-hover table-condensed table-responsive">
        ...
        if (empty($data)) {
			...
			<tr>
				...
				<td>
					<a href="<?php echo U('edit',array('uid'=> $vo['uid']));?>">修改</a> |
					<a href="javascript:;" class="dialogs" data-toggle="click" data-target="#mydialog<?php echo $vo['uid'];?>" data-mask="1" data-width="20%">删除</a>
					<!-- 删除确认框 Start -->
					<div id="mydialog<?php echo $vo['uid'];?>">
						<div class="dialog fadein-top">
							...
							<div class="dialog-foot">
								...
								<button class="button bg-green" onClick="location.href='<?php echo U('del',array('uid'=>$vo['uid']));?>'">确 认</button>
							</div>
						</div>
					</div>
					<!-- 删除确认框 End -->
