	 ...
	 <?php if($backFlag == 3): ?><div class="alert alert-warning alert-dismissable">
		...
		<div class="col-md-12">
			<div class="page-header">
				<h1>修改文章封面 <small> </small></h1>
			</div>
			<div class="">
			<div class="col-md-12 ">
			    <li class="list-group-item"><?php echo ($articleRow[0]['articlename']); ?></li>
			    <h4>当前封面：</h4>
				<img src="/hellomarkertest/Public/images/article/<?php echo ($articleRow[0]['articleimg']); ?>" class="center-block"alt="hellomarker">
			</div>
			
               <form action="/hellomarkertest/hellomarkeradmin.php/Home/Index/changeArticleImageWork" method="post" accept-charset="utf-8" class="form" enctype="multipart/form-data">
                    <div class="form-group">
                    <label>上传封面图片：</label><br><br>
