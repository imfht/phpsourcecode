 ...
 <div class="ui-content" data-role="main">
    <?php if($userHomeFlag == 1): ?><div class="panel panel-default panel-share">
        <div class="panel-heading panel-share-heading">
            <span>我收藏的</span><font color="#888">  •   <?php echo ($myNoteCount); ?> 条</font>
        </div>
        <?php if($myNoteFlag == 1): ?><div class=" list-group  share-list">
                <?php if(is_array($myNoteRows)): $i = 0; $__LIST__ = $myNoteRows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li id="#<?php echo ($vo["noteid"]); ?>" class="list-group-item <?php echo ($vo["noteid"]); ?>" onmouseover="shareListHover('.<?php echo ($vo["noteid"]); ?>');" onmouseout="shareListHoverOut('.<?php echo ($vo["noteid"]); ?>');">
                                <a href="/hellomarkertest/mobile.php/Home/Index/noteShareInfo/id/<?php echo ($vo["noteid"]); ?>/">
                                    <img src="/hellomarkertest/Public/uploads/markerimage/src/<?php echo ($vo["imgsrc"]); ?>" class="img-rounded" alt="<?php echo ($vo["notename"]); ?>" width="50px;">
                                </a>
                                ...
                                <hr>
                                  <h4><small><i class="fa fa-clock-o"></i>;收藏时间：<?php echo ($vo["collecttime"]); ?> </small></h4>
                                  <h4><small><i class="fa fa-comment-o"></i>参与讨论：<?php echo ($vo["notediscusscount"]); ?>
                                  <h4><small><i class="fa fa-heart-o"></i>共同喜欢：<?php echo ($vo["notecollectcount"]); ?>
                            <div class="media-right media-middle ">
                                <a href="/hellomarkertest/mobile.php/Home/Index/myNoteCollectDelete/id/<?php echo ($vo["noteid"]); ?>" onclick="javascript:return myNoteShareConfirm();"><i  class="fa fa-trash"></i></a>
                                <a href="javascript:">&nbsp;</a>
                            </div>
