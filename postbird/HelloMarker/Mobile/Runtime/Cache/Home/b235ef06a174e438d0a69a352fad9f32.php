...
<div data-role="page" >
    <div data-role="header" data-position="fixed" data-tap-toggle="false"data-theme="l">
      <h1><?php echo ($articleRows[0]['articlename']); ?></h1>
    </div>
    <div>
      <img src="/hellomarkertest/Public/images/article/banner/<?php echo ($articleRows[0]['articlebanner']); ?>" width="100%">
    </div>
    <div class="page-header">
      <h4><?php echo ($articleRows[0]['articlename']); ?> </h4>
    </div>
    <div class="page-header">
      <h5>&nbsp;<small>时间 ：<?php echo ($articleRows[0]['articletime']); ?></small></h5>
      <h5>&nbsp;<small>来源 ：<?php echo ($articleRows[0]['articlefrom']); ?></small></h5>
    </div>
  <div data-role="main" class="content">
    <h5><small>摘要 ：</small></h5>
     <div class="list-group-item article-content">
       <?php echo ($articleRows[0]['articleabout']); ?>
     </div>
