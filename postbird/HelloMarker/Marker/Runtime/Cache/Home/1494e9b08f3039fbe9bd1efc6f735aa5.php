...
<div class="container ">
    ...
    <?php if($userHomeFlag == 1): ?><div class="col-md-3">
        ...
        <div class="panel-heading panel-share-heading">
            <span>我记录的</span><font color="#888">  •   <?php echo ($myNoteCount); ?> 条</font>
            <a href="/hellomarkertest/marker.php/Home/Index/newNote/" class="btn btn-warning pull-right">添加新的</a>
        </div>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <div class="media-meta">
                                  <i class="fa fa-clock-o"></i>&nbsp;&nbsp;时间  •   <?php echo ($vo["notetime"]); ?> 
                                  ...
                                  <?php if($vo["isshare"] == 1): ?>&nbsp;&nbsp;<i class="fa fa-share"></i>&nbsp;&nbsp;已分享
                                    <?php else: ?>
                                      &nbsp;&nbsp;<a href="/hellomarkertest/marker.php/Home/Index/myNoteShareAdd/id/<?php echo ($vo["noteid"]); ?>"><i class="fa fa-share-alt"></i>  点击分享</a><?php endif; ?>
                                </div>
                            </div>
                            <div class="media-right media-middle ">
                                <a href="/hellomarkertest/marker.php/Home/Index/myNoteDelete/id/<?php echo ($vo["noteid"]); ?>" onclick="javascript:return myNoteDeleteConfirm();"><i title="删除"class="fa fa-trash"></i></a>
                                <a href="javascript:">&nbsp;</a>
                                <a href="/hellomarkertest/marker.php/Home/Index/editNote/id/<?php echo ($vo["noteid"]); ?>" ><i title="修改"class="fa fa-edit"></i> </a>
                            </div>
                        </div>
