...
<div class="container ">
    ...
    <div class="panel panel-default panel-share">
        <div class="panel-heading panel-share-heading">
            ...
            <a href="/hellomarkertest/marker.php/Home/Index/newNote/" class="btn btn-warning pull-right">添加新记录</a>
        </div>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <div class="media-meta">
                                  <i class="fa fa-file-o"></i>&nbsp;&nbsp;记录时间  •   <?php echo ($vo["notetime"]); ?> 
                                  ...
                                  <?php if($vo["isshare"] == 1): ?>&nbsp;&nbsp<i class="fa fa-share"></i>&nbsp;&nbsp;已分享<?php endif; ?>
                                </div>
                            </div>
