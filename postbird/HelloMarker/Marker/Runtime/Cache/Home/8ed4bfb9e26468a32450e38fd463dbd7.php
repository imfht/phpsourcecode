...
<div class="container ">
    <div class="row">
    <?php if($myWorkFlag == 1): ?><div class="col-md-3">
            <div class="panel panel-default user-home">
                <div class="list-group">
                    <a class="list-group-item" href="/hellomarkertest/marker.php/Home/Work/Index/">我的记事本
        ...
        <div class="panel-heading panel-share-heading">
            <span>目录</span><font color="#888">  •   <?php echo ($myWorkCount); ?> 条</font>
            <a href="/hellomarkertest/marker.php/Home/Work/newWork/" class="btn btn-info pull-right">新记事</a>
        </div>
        <?php if($myWorkFlag == 1): ?><div class=" list-group  share-list">
                <?php if(is_array($myWorkRows)): $i = 0; $__LIST__ = $myWorkRows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li id="#<?php echo ($vo["workid"]); ?>" class="list-group-item <?php echo ($vo["workid"]); ?>" onmouseover="shareListHover('.<?php echo ($vo["workid"]); ?>');" onmouseout="shareListHoverOut('.<?php echo ($vo["workid"]); ?>');">
                        <div class="media">
                            <div class="media-left media-middle">
                            </div>
                            <div class="media-body">
                               <font size="5"><?php echo ($vo["workname"]); ?></font>
                                <div class="media-meta">
                                    <p><font color="#ccc"><i class="fa fa-bell-o"></i> &nbsp; <?php echo ($vo["worktime"]); ?> &nbsp; <i class="fa fa-terminal"></i></font><font color="#D9534F">&nbsp;<?php if($vo["worklevel"] == 3): ?>！！！<?php elseif($vo["worklevel"] == 2): ?>！！<?php else: ?>！<?php endif; ?></font></p>
                                  <p><font color="#888"><?php echo ($vo["workother"]); ?></font></p>
                                </div>
                            </div>
                            <div class="media-right media-middle ">
                                <a href="/hellomarkertest/marker.php/Home/Work/myWorkDelete/id/<?php echo ($vo["workid"]); ?>" onclick="javascript:return myNoteDeleteConfirm();"><i title="删除"class="fa fa-trash"></i></a>
                            </div>
                        </div>
