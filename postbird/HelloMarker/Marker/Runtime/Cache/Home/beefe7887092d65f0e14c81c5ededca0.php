...
<div class="container">
    <div class="row">
        ...
        <form action="/hellomarkertest/marker.php/Home/Index/newNoteAdd/" method="post" accept-charset="utf-8" class="form" enctype="multipart/form-data">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <label for="notetitle" title="必填项"><i class="fa fa-info-circle"></i> 标题</label>
                        <input type="text" name="notetitle" id="notetitle" class="form-control" value="<?php echo ($noteArray['notetitle']); ?>">
                    </div>
                    <div class="form-group">
                        <label for="noteaddress" title="必填项"><i class="fa fa-info-circle"></i> 地址</label>
                        <input type="text" name="noteaddress" id="noteaddress" class="form-control" value="<?php echo ($noteArray['noteaddress']); ?>">
                    </div>
                    <div class="form-group">
                        <label for="noteother" title="可以为空"><i class="fa fa-info-circle"></i> 其他描述</label>
                        <textarea id="noteother" name="noteother" placeholder="其他描述...(可以为空)" class="form-control" rows="3" wrap="hard"><?php echo ($noteArray['noteother']); ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="noteimage" title="可以为空"><i class="fa fa-info-circle"></i> 图片上传</label>
                    ...
                    <div class="form-group">
                        <label for="noteshare">
                           <input id="noteshare" type="checkbox" name="noteshare" value="1" >   随手分享</label>
                    </div>    
                </div>
                <div class="panel-footer">
                    <div class="form-group">
                        <button type="submit" id="userloginbutton" class="btn btn-primary">添加新记录</button>
                    </div>
                </div>
            </div>
        </div>
