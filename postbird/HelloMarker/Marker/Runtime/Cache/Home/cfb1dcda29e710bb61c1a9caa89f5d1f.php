                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <div class="media-meta">
                                  <i class="fa fa-clock-o"></i>&nbsp;&nbsp;收藏时间  •   <?php echo ($vo["collecttime"]); ?> 
                                  &nbsp;&nbsp<i class="fa fa-comment-o"></i>  •   <?php echo ($vo["notediscusscount"]); ?> 讨论
                                  &nbsp;&nbsp<i class="fa fa-heart-o"></i>  •   <?php echo ($vo["notecollectcount"]); ?> 人共同喜欢
                                </div>
                            </div>
                            <div class="media-right media-middle ">
                                <a href="/hellomarkertest/marker.php/Home/Index/myNoteCollectDelete/id/<?php echo ($vo["noteid"]); ?>" onclick="javascript:return myNoteShareConfirm();"><i  class="fa fa-trash"></i></a>
                                <a href="javascript:">&nbsp;</a>
                            </div>
                        </div>
