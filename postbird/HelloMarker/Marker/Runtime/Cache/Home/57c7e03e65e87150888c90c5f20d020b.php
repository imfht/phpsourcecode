...
<div class="container">
    <div class="row">
        ...
        <form action="/hellomarkertest/marker.php/Home/User/userLogin/" method="post" accept-charset="utf-8" class="form">
            <div class="panel panel-default">
                ...
                <div class="panel-footer">
                    <div class="form-group">
                        ...
                        <a href="/hellomarkertest/marker.php/Home/User/userFindPassword/" class="btn btn-default pull-right" ><i class="fa fa-question-circle"></i> 忘记密码</a>
                    </div>
                </div>
            </div>
        </div>
