...
<div class="col col-md-12 col-sm-12 col-xs-12 col-lg-12">
                    <div class="block">
                        ...
                        <div class="caption">菜单管理</div></div><div id="modelObj-action" class="block-controls"><a grid-btn grid-btn class="btn disabled btn-danger btn-sm" href="<?php echo ($delUrl); ?>">删除</a>
...
<div class="table-responsive">
    <table id="modelObj" class="table table-bordered table-striped table-hover">
        <thead>
            <th w_index="id">id</th>
            <th w_index="name">菜单名称</th>
            <th w_index="controller">控制器</th>
            <th w_index="idx">idx</th>
            <th w_index="pid">pid</th>
        </thead>
    </table>
</div>
...
$(function(){
    ...
    $('.btn-search').on('click',function(){
        window.location.href = "<?php echo U('Web/Sendxiru/index');?>";
    })
})    
</script>