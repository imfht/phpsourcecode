   ...
   /**
    ...
    private function dispatchJump($message,$status=1,$jumpUrl='',$ajax=false) {
        ...
        if($status) { //发送成功信息
            ...
            // 成功操作后默认停留1秒
            if(!isset($this->waitSecond))    $this->assign('waitSecond','30');
            // 默认操作成功自动返回操作前页面
	...
	public function doRequest($name='',$param=array())
	{
		$array = count($param) > 0 ? $param : $_REQUEST;
