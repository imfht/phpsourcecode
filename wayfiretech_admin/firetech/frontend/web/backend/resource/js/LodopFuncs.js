 ...
 * @Date:   2020-06-20 23:21:20
 * @Last Modified by:   Wang chunsheng  email:2192138785@qq.com
 * @Last Modified time: 2020-06-20 23:46:07
 */
...
if (needCLodop()) {
    console.log('456789101010')
 
};

export function loadCLodop(ip){
    //==加载引用CLodop的主JS,用双端口8000和18000(以防其中一个被占):==
    var head = document.head || document.getElementsByTagName("head")[0] || document.documentElement;
    var oscript = document.createElement("script");
    oscript.src ="http://"+ip+":8000/CLodopfuncs.js?priority=1";
    head.insertBefore( oscript,head.firstChild );
  
    //引用双端口(8000和18000）避免其中某个被占用：
    oscript = document.createElement("script");
    oscript.src ="http://"+ip+":18000/CLodopfuncs.js?priority=0";
    head.insertBefore( oscript,head.firstChild );
}
