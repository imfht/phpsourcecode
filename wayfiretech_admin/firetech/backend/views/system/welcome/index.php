 ...
 * @Date:   2020-04-14 00:20:05
 * @Last Modified by:   Wang Chunsheng 2192138785@qq.com
 * @Last Modified time: 2020-04-14 00:21:23
 */
        ...
        <div class="box">
            ...
            <div class="box-body table-responsive">
                <table class="table table-hover">
                    ...
                    <tr>
                        <td>附件目录</td>
                        <td><?= $prefix . Yii::getAlias('@attachment'); ?>/</td>
                    </tr>
                    <tr>
                        <td>附件目录大小</td>
        ...
        <div class="box">
            ...
            <div class="box-body table-responsive">
                <table class="table table-hover">
                    ...
                    <tr>
                        <td>官网</td>
                        <td>http://www.wayfirer.com/</td>
                    </tr>
                    <tr>
                        <td>官方QQ群</td>
                        <td><a target="_blank">823429313</a></td>
                    </tr>
                    <tr>
                        <td>GitHub</td>
                        <td>https://gitee.com/wayfiretech_admin/firetech</td>
                    </tr>
                    <tr>
                        <td>开发者</td>
                        <td>王春生</td>
